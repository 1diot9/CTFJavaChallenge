...
/* loaded from: agent.jar:BOOT-INF/lib/hutool-all-5.8.16.jar:cn/hutool/extra/servlet/ServletUtil.class */
        ...
        return (T) BeanUtil.fillBean(t, new ValueProvider<String>() { // from class: cn.hutool.extra.servlet.ServletUtil.1
            ...
            public Object value(String key, Type valueType) {
                ...
                if (ArrayUtil.isEmpty((Object[]) values)) {
                    values = servletRequest.getParameterValues(lowerFirst + "." + key);
                    if (ArrayUtil.isEmpty((Object[]) values)) {
                        return null;
                    }
                }
            ...
            public boolean containsKey(String key) {
                return (null == servletRequest.getParameter(key) && null == servletRequest.getParameter(new StringBuilder().append(lowerFirst).append(".").append(key).toString())) ? false : true;
            }
        }, copyOptions);
    }
    ...
    public static void write(HttpServletResponse response, InputStream in, int bufferSize) {
        ...
        try {
            try {
                ...
                IoUtil.copy(in, outputStream, bufferSize);
