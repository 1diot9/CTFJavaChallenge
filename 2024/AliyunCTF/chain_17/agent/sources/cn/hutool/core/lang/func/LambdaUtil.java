...
/* loaded from: agent.jar:BOOT-INF/lib/hutool-all-5.8.16.jar:cn/hutool/core/lang/func/LambdaUtil.class */
public class LambdaUtil {
    ...
    private static SerializedLambda _resolve(Serializable func) {
        return cache.computeIfAbsent((WeakConcurrentMap<String, SerializedLambda>) func.getClass().getName(), (Function<? super WeakConcurrentMap<String, SerializedLambda>, ? extends SerializedLambda>) key -> {
