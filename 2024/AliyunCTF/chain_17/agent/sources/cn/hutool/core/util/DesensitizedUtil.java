...
/* loaded from: agent.jar:BOOT-INF/lib/hutool-all-5.8.16.jar:cn/hutool/core/util/DesensitizedUtil.class */
public class DesensitizedUtil {

    /* loaded from: agent.jar:BOOT-INF/lib/hutool-all-5.8.16.jar:cn/hutool/core/util/DesensitizedUtil$DesensitizedType.class */
    ...
    public static String idCardNum(String idCardNum, int front, int end) {
        if (StrUtil.isBlank(idCardNum) || front + end > idCardNum.length() || front < 0 || end < 0) {
            return "";
        }
    ...
    public static String bankCard(String bankCardNo) {
        ...
        buf.append(' ').append((CharSequence) bankCardNo2, length - 4, length);
        return buf.toString();
    }
