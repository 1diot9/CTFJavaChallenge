...
/* loaded from: agent.jar:BOOT-INF/lib/hutool-all-5.8.16.jar:cn/hutool/core/util/CharUtil.class */
public class CharUtil implements CharPool {
    ...
    public static boolean equals(char c1, char c2, boolean caseInsensitive) {
        return caseInsensitive ? Character.toLowerCase(c1) == Character.toLowerCase(c2) : c1 == c2;
    }
