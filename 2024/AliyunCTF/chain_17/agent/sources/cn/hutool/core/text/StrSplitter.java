...
/* loaded from: agent.jar:BOOT-INF/lib/hutool-all-5.8.16.jar:cn/hutool/core/text/StrSplitter.class */
public class StrSplitter {
    ...
    public static <R> List<R> split(CharSequence str, char separator, int limit, boolean ignoreEmpty, Function<String, R> mapping) {
        return split(str, separator, limit, ignoreEmpty, false, (Function) mapping);
    }
    ...
    public static List<String> split(CharSequence text, int limit) {
        ...
        SplitIter splitIter = new SplitIter(text, new CharMatcherFinder((v0) -> {
