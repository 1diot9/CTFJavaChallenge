...
/* loaded from: agent.jar:BOOT-INF/lib/hutool-all-5.8.16.jar:cn/hutool/core/comparator/CompareUtil.class */
public class CompareUtil {
    ...
    public static <T> Comparator<T> comparingPinyin(Function<T, String> keyExtractor, boolean reverse) {
        ...
        return (o12, o22) -> {
            return pinyinComparator.compare((String) keyExtractor.apply(o12), (String) keyExtractor.apply(o22));
        };
    }
