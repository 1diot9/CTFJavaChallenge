...
/* loaded from: agent.jar:BOOT-INF/lib/hutool-all-5.8.16.jar:cn/hutool/socket/aio/AioClient.class */
public class AioClient implements Closeable {
    ...
    public <T> AioClient setOption(SocketOption<T> name, T value) throws IOException {
        this.session.getChannel().setOption((SocketOption<SocketOption<T>>) name, (SocketOption<T>) value);
        return this;
    }
