...
/* loaded from: agent.jar:BOOT-INF/lib/hutool-all-5.8.16.jar:cn/hutool/http/HttpDownloader.class */
public class HttpDownloader {
    ...
    private static HttpResponse requestDownload(String url, int timeout) {
        ...
        throw new HttpException("Server response error with status code: [{}]", Integer.valueOf(response.getStatus()));
    }
}
