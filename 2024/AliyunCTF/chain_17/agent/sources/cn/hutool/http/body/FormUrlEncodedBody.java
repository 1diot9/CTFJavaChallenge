...
/* loaded from: agent.jar:BOOT-INF/lib/hutool-all-5.8.16.jar:cn/hutool/http/body/FormUrlEncodedBody.class */
public class FormUrlEncodedBody extends BytesBody {
    ...
    public FormUrlEncodedBody(Map<String, Object> form, Charset charset) {
        super(StrUtil.bytes(UrlQuery.of((Map<? extends CharSequence, ?>) form, true).build(charset), charset));
    }
}
