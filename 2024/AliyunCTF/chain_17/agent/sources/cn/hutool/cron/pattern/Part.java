...
/* loaded from: agent.jar:BOOT-INF/lib/hutool-all-5.8.16.jar:cn/hutool/cron/pattern/Part.class */
public enum Part {
    SECOND(13, 0, 59),
    MINUTE(12, 0, 59),
    HOUR(11, 0, 23),
    ...
    public int checkValue(int value) throws CronException {
        Assert.checkBetween(value, this.min, this.max, () -> {
            return new CronException("Value {} out of range: [{} , {}]", Integer.valueOf(value), Integer.valueOf(this.min), Integer.valueOf(this.max));
        });
        return value;
    }
