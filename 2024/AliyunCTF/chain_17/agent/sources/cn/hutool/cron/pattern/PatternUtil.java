...
/* loaded from: agent.jar:BOOT-INF/lib/hutool-all-5.8.16.jar:cn/hutool/cron/pattern/PatternUtil.class */
class PatternUtil {
    PatternUtil() {
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public static int[] getFields(LocalDateTime dateTime, boolean isMatchSecond) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static int[] getFields(Calendar calendar, boolean isMatchSecond) {
