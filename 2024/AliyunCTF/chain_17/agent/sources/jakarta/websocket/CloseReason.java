...
/* loaded from: agent.jar:BOOT-INF/lib/tomcat-embed-websocket-10.1.18.jar:jakarta/websocket/CloseReason.class */
public class CloseReason {
    private final CloseCode closeCode;
    private final String reasonPhrase;

    /* loaded from: agent.jar:BOOT-INF/lib/tomcat-embed-websocket-10.1.18.jar:jakarta/websocket/CloseReason$CloseCode.class */
    ...
    /* loaded from: agent.jar:BOOT-INF/lib/tomcat-embed-websocket-10.1.18.jar:jakarta/websocket/CloseReason$CloseCodes.class */
    public enum CloseCodes implements CloseCode {
        ...
        CANNOT_ACCEPT(1003),
        RESERVED(1004),
        NO_STATUS_CODE(PgServer.PG_TYPE_INT2_ARRAY),
        ...
        TLS_HANDSHAKE_FAILURE(PgServer.PG_TYPE_VARCHAR_ARRAY);
