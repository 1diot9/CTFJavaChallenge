...
/* loaded from: agent.jar:BOOT-INF/lib/tomcat-embed-websocket-10.1.18.jar:jakarta/websocket/server/ServerEndpointConfig.class */
public interface ServerEndpointConfig extends EndpointConfig {
    ...
    /* loaded from: agent.jar:BOOT-INF/lib/tomcat-embed-websocket-10.1.18.jar:jakarta/websocket/server/ServerEndpointConfig$Builder.class */
    ...
    /* loaded from: agent.jar:BOOT-INF/lib/tomcat-embed-websocket-10.1.18.jar:jakarta/websocket/server/ServerEndpointConfig$Configurator.class */
    public static class Configurator {
        ...
        /* loaded from: agent.jar:BOOT-INF/lib/tomcat-embed-websocket-10.1.18.jar:jakarta/websocket/server/ServerEndpointConfig$Configurator$PrivilegedLoadDefault.class */
