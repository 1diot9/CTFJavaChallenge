...
/* loaded from: agent.jar:BOOT-INF/lib/micrometer-observation-1.12.2.jar:io/micrometer/observation/aop/ObservedAspectObservationDocumentation.class */
public enum ObservedAspectObservationDocumentation implements ObservationDocumentation {
    DEFAULT;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* loaded from: agent.jar:BOOT-INF/lib/micrometer-observation-1.12.2.jar:io/micrometer/observation/aop/ObservedAspectObservationDocumentation$ObservedAspectLowCardinalityKeyName.class */
