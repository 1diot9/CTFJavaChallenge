...
/* loaded from: agent.jar:BOOT-INF/lib/jackson-core-2.15.3.jar:com/fasterxml/jackson/core/io/doubleparser/JavaBigDecimalFromCharArray.class */
final class JavaBigDecimalFromCharArray extends AbstractNumberParser {
    ...
    BigDecimal parseBigDecimalStringWithManyDigits(char[] str, int offset, int length) {
        ...
        int integerPartIndex = index;
        int swarLimit = Math.min(endIndex - 8, 1073741824);
