...
/* loaded from: agent.jar:BOOT-INF/lib/jackson-core-2.15.3.jar:com/fasterxml/jackson/core/io/doubleparser/FastDoubleSwar.class */
class FastDoubleSwar {
    ...
    public static int tryToParseFourDigitsUtf8(int chunk) {
        ...
        int val2 = (val * 2561) >>> 8;
        return ((val2 & Const.MAX_ARRAY_DIMENSIONS) * 100) + ((val2 & 16711680) >> 16);
    }
