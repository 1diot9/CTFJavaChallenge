...
/* loaded from: agent.jar:BOOT-INF/lib/jackson-databind-2.15.3.jar:com/fasterxml/jackson/databind/PropertyName.class */
public class PropertyName implements Serializable {
    ...
    public String toString() {
        ...
        return StrPool.DELIM_START + this._namespace + "}" + this._simpleName;
    }
}
