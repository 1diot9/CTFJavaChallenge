...
/* loaded from: agent.jar:BOOT-INF/lib/jackson-core-2.15.3.jar:com/fasterxml/jackson/core/util/RequestPayload.class */
public class RequestPayload implements Serializable {
    ...
    public RequestPayload(byte[] bytes, String charset) {
        ...
        this._charset = (charset == null || charset.isEmpty()) ? CharsetUtil.UTF_8 : charset;
    }
