...
/* loaded from: agent.jar:BOOT-INF/lib/tomcat-embed-core-10.1.18.jar:org/apache/tomcat/util/buf/CharChunk.class */
public final class CharChunk extends AbstractChunk implements CharSequence {
    ...
    /* loaded from: agent.jar:BOOT-INF/lib/tomcat-embed-core-10.1.18.jar:org/apache/tomcat/util/buf/CharChunk$CharInputChannel.class */
    public interface CharInputChannel {
        int realReadChars() throws IOException;
    }

    /* loaded from: agent.jar:BOOT-INF/lib/tomcat-embed-core-10.1.18.jar:org/apache/tomcat/util/buf/CharChunk$CharOutputChannel.class */
