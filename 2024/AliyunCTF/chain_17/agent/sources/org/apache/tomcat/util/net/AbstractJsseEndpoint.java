...
/* loaded from: agent.jar:BOOT-INF/lib/tomcat-embed-core-10.1.18.jar:org/apache/tomcat/util/net/AbstractJsseEndpoint.class */
public abstract class AbstractJsseEndpoint<S, U> extends AbstractEndpoint<S, U> {
    ...
    protected void createSSLContext(SSLHostConfig sslHostConfig) throws IllegalArgumentException {
        if (sslHostConfig.getCertificateVerification().isOptional() && this.negotiableProtocols.contains(JaasCredentialsValidator.DEFAULT_APPNAME)) {
