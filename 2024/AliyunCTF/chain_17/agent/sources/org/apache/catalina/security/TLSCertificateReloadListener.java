...
/* loaded from: agent.jar:BOOT-INF/lib/tomcat-embed-core-10.1.18.jar:org/apache/catalina/security/TLSCertificateReloadListener.class */
public class TLSCertificateReloadListener implements LifecycleListener {
    ...
    private final SimpleDateFormat dateFormat = new SimpleDateFormat(DatePattern.UTC_WITH_XXX_OFFSET_PATTERN);
