...
/* loaded from: agent.jar:BOOT-INF/lib/tomcat-embed-core-10.1.18.jar:org/apache/catalina/authenticator/BasicAuthenticator.class */
public class BasicAuthenticator extends AuthenticatorBase {
    ...
    public void setCharset(String charsetString) {
        ...
        } else if (CharsetUtil.UTF_8.equalsIgnoreCase(charsetString)) {
        ...
        if (authorization != null) {
            ...
            try {
                ...
                if (this.log.isDebugEnabled()) {
                    this.log.debug(sm.getString("basicAuthenticator.invalidAuthorization", iae.getMessage()));
                }
            }
        }
    ...
    /* loaded from: agent.jar:BOOT-INF/lib/tomcat-embed-core-10.1.18.jar:org/apache/catalina/authenticator/BasicAuthenticator$BasicCredentials.class */
