...
/* loaded from: agent.jar:BOOT-INF/lib/tomcat-embed-core-10.1.18.jar:org/apache/catalina/startup/ClassLoaderFactory.class */
public final class ClassLoaderFactory {
    private static final Log log = LogFactory.getLog((Class<?>) ClassLoaderFactory.class);

    /* loaded from: agent.jar:BOOT-INF/lib/tomcat-embed-core-10.1.18.jar:org/apache/catalina/startup/ClassLoaderFactory$RepositoryType.class */
    ...
    private static URL buildClassLoaderUrl(File file) throws MalformedURLException, URISyntaxException {
        ...
        return new URI(fileUrlString.replace("!/", "%21/")).toURL();
    }

    /* loaded from: agent.jar:BOOT-INF/lib/tomcat-embed-core-10.1.18.jar:org/apache/catalina/startup/ClassLoaderFactory$Repository.class */
