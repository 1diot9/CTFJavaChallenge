...
/* loaded from: agent.jar:BOOT-INF/lib/tomcat-embed-core-10.1.18.jar:org/apache/catalina/core/ContainerBase.class */
public abstract class ContainerBase extends LifecycleMBeanBase implements Container {
    ...
    /* loaded from: agent.jar:BOOT-INF/lib/tomcat-embed-core-10.1.18.jar:org/apache/catalina/core/ContainerBase$PrivilegedAddChild.class */
    ...
    public String getMBeanKeyProperties() {
        ...
        while (true) {
            ...
            if (c instanceof Wrapper) {
                ...
                ContextName cn2 = new ContextName(c.getName(), false);
                keyProperties.insert(9, cn2.getDisplayName());
    ...
    public ObjectName[] getChildren() {
        ...
        synchronized (this.children) {
            names = new ArrayList<>(this.children.size());
    ...
    /* loaded from: agent.jar:BOOT-INF/lib/tomcat-embed-core-10.1.18.jar:org/apache/catalina/core/ContainerBase$ContainerBackgroundProcessorMonitor.class */
    ...
    /* JADX INFO: Access modifiers changed from: protected */
    /* loaded from: agent.jar:BOOT-INF/lib/tomcat-embed-core-10.1.18.jar:org/apache/catalina/core/ContainerBase$ContainerBackgroundProcessor.class */
    ...
    /* loaded from: agent.jar:BOOT-INF/lib/tomcat-embed-core-10.1.18.jar:org/apache/catalina/core/ContainerBase$StartChild.class */
    ...
    /* loaded from: agent.jar:BOOT-INF/lib/tomcat-embed-core-10.1.18.jar:org/apache/catalina/core/ContainerBase$StopChild.class */
