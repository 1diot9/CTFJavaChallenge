...
/* loaded from: agent.jar:BOOT-INF/lib/tomcat-embed-core-10.1.18.jar:org/apache/catalina/valves/rewrite/RewriteValve.class */
        ...
        try {
            ...
            while (true) {
                ...
                if (newtest != null && !test.equals(newtest.toString())) {
                    if (this.containerLog.isDebugEnabled()) {
                        this.containerLog.debug("Rewrote " + test + " as " + newtest + " with rule pattern " + rule.getPatternString());
                    }
                    if (rule.isHost()) {
                        host = newtest;
                    } else {
        ...
        if (tokenizer.hasMoreTokens()) {
            ...
            if (token.equals("RewriteRule")) {
                ...
                if (tokenizer.hasMoreTokens()) {
                    ...
                    if (flags2.startsWith("[") && flags2.endsWith("]")) {
