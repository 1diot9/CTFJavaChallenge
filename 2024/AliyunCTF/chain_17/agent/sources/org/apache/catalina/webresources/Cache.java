...
/* loaded from: agent.jar:BOOT-INF/lib/tomcat-embed-core-10.1.18.jar:org/apache/catalina/webresources/Cache.class */
public class Cache {
    ...
    private boolean noCache(String path) {
        if (!path.endsWith(".class") || (!path.startsWith("/WEB-INF/classes/") && !path.startsWith(Constants.WEB_INF_LIB))) {
