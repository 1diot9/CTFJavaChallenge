...
/* loaded from: agent.jar:BOOT-INF/lib/tomcat-embed-core-10.1.18.jar:org/apache/catalina/startup/Tomcat.class */
public class Tomcat {
    ...
    public Context addWebapp(String contextPath, URL source) throws IOException {
        ContextName cn2 = new ContextName(contextPath, (String) null);
        Host h = getHost();
        if (h.findChild(cn2.getName()) != null) {
            throw new IllegalArgumentException(sm.getString("tomcat.addWebapp.conflictChild", source, contextPath, cn2.getName()));
        }
        File targetWar = new File(h.getAppBaseFile(), cn2.getBaseName() + ".war");
        File targetDir = new File(h.getAppBaseFile(), cn2.getBaseName());
        if (targetWar.exists()) {
    ...
    /* loaded from: agent.jar:BOOT-INF/lib/tomcat-embed-core-10.1.18.jar:org/apache/catalina/startup/Tomcat$SimpleRealm.class */
    public class SimpleRealm extends RealmBase {
        ...
        protected Principal getPrincipal(String username) {
            ...
            if (p == null) {
                String pass = Tomcat.this.userPass.get(username);
                if (pass != null) {
                    p = new GenericPrincipal(username, Tomcat.this.userRoles.get(username));
    ...
    public void enableNaming() {
        ...
        if (System.getProperty(CoreTestConstants.JAVA_NAMING_FACTORY_INITIAL) == null) {
            System.setProperty(CoreTestConstants.JAVA_NAMING_FACTORY_INITIAL, "org.apache.naming.java.javaURLContextFactory");
        }
    }
    ...
    public static void initWebappDefaults(Context ctx) {
        ...
        ctx.addWelcomeFile(RootAction.DEFAULT_INDEX_FILE_NAME);
    ...
    /* loaded from: agent.jar:BOOT-INF/lib/tomcat-embed-core-10.1.18.jar:org/apache/catalina/startup/Tomcat$FixContextListener.class */
    ...
    /* loaded from: agent.jar:BOOT-INF/lib/tomcat-embed-core-10.1.18.jar:org/apache/catalina/startup/Tomcat$DefaultWebXmlListener.class */
    ...
    /* loaded from: agent.jar:BOOT-INF/lib/tomcat-embed-core-10.1.18.jar:org/apache/catalina/startup/Tomcat$ExistingStandardWrapper.class */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:52:0x016b, code lost:            r0.start();     */
    /* JADX WARN: Code restructure failed: missing block: B:53:0x0170, code lost:            if (r14 == false) goto L62;     */
    /* JADX WARN: Code restructure failed: missing block: B:54:0x0173, code lost:            r0.getServer().await();     */
    /* JADX WARN: Code restructure failed: missing block: B:55:0x017c, code lost:            return;     */
