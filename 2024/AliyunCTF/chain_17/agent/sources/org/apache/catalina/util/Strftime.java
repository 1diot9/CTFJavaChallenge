...
/* loaded from: agent.jar:BOOT-INF/lib/tomcat-embed-core-10.1.18.jar:org/apache/catalina/util/Strftime.class */
public class Strftime {
    ...
    static {
        ...
        translate.put("g", "yy");
        translate.put("G", DatePattern.NORM_YEAR_PATTERN);
        translate.put("H", "HH");
        translate.put("h", "MMM");
        translate.put("I", "hh");
        translate.put("j", "DDD");
        ...
        translate.put("S", "ss");
        translate.put("t", "\t");
        translate.put("T", DatePattern.NORM_TIME_PATTERN);
        translate.put("V", "ww");
        translate.put("X", DatePattern.NORM_TIME_PATTERN);
        translate.put("x", "MM/dd/yy");
        translate.put("y", "yy");
        translate.put("Y", DatePattern.NORM_YEAR_PATTERN);
        translate.put("Z", "z");
        translate.put("z", "Z");
