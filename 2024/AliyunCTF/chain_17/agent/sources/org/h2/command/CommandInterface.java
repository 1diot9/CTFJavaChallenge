...
/* loaded from: agent.jar:BOOT-INF/lib/h2-2.2.224.jar:org/h2/command/CommandInterface.class */
public interface CommandInterface extends AutoCloseable {
    ...
    public static final int CREATE_MATERIALIZED_VIEW = 102;
    public static final int REFRESH_MATERIALIZED_VIEW = 103;
    public static final int DROP_MATERIALIZED_VIEW = 104;
    ...
    ResultInterface executeQuery(long j, boolean z);

    ResultWithGeneratedKeys executeUpdate(Object obj);
