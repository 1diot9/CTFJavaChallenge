...
/* loaded from: agent.jar:BOOT-INF/lib/h2-2.2.224.jar:org/h2/api/ErrorCode.class */
public class ErrorCode {
    ...
    public static boolean isCommon(int i) {
        switch (i) {
            case 2000:
            case VALUE_TOO_LONG_2 /* 22001 */:
            case NUMERIC_VALUE_OUT_OF_RANGE_1 /* 22003 */:
            case DATA_CONVERSION_ERROR_1 /* 22018 */:
            case NULL_NOT_ALLOWED /* 23502 */:
            case REFERENTIAL_INTEGRITY_VIOLATED_CHILD_EXISTS_1 /* 23503 */:
            case DUPLICATE_KEY_1 /* 23505 */:
            case REFERENTIAL_INTEGRITY_VIOLATED_PARENT_MISSING_1 /* 23506 */:
            case SYNTAX_ERROR_1 /* 42000 */:
            case SYNTAX_ERROR_2 /* 42001 */:
            case TABLE_OR_VIEW_ALREADY_EXISTS_1 /* 42101 */:
            case TABLE_OR_VIEW_NOT_FOUND_1 /* 42102 */:
            case TABLE_OR_VIEW_NOT_FOUND_WITH_CANDIDATES_2 /* 42103 */:
            case TABLE_OR_VIEW_NOT_FOUND_DATABASE_EMPTY_1 /* 42104 */:
            case LOCK_TIMEOUT_1 /* 50200 */:
            case OBJECT_CLOSED /* 90007 */:
            case FUNCTION_ALIAS_ALREADY_EXISTS_1 /* 90076 */:
                return true;
            default:
                return false;
        }
    ...
    public static String getState(int i) {
        switch (i) {
            case 2000:
                return "02000";
            case INVALID_PARAMETER_COUNT_2 /* 7001 */:
                return "07001";
            case ERROR_OPENING_DATABASE_1 /* 8000 */:
                return "08000";
            case COLUMN_COUNT_DOES_NOT_MATCH /* 21002 */:
                return "21S02";
            case ARRAY_ELEMENT_ERROR_2 /* 22034 */:
                return "2202E";
            case NULL_VALUE_IN_ARRAY_TARGET /* 22035 */:
                return "2200E";
            case TABLE_OR_VIEW_ALREADY_EXISTS_1 /* 42101 */:
                return "42S01";
            case TABLE_OR_VIEW_NOT_FOUND_1 /* 42102 */:
            ...
            case TABLE_OR_VIEW_NOT_FOUND_DATABASE_EMPTY_1 /* 42104 */:
                return "42S04";
            case INDEX_ALREADY_EXISTS_1 /* 42111 */:
                return "42S11";
            case INDEX_NOT_FOUND_1 /* 42112 */:
                return "42S12";
            case DUPLICATE_COLUMN_NAME_1 /* 42121 */:
                return "42S21";
            case COLUMN_NOT_FOUND_1 /* 42122 */:
                return "42S22";
            case IDENTICAL_EXPRESSIONS_SHOULD_BE_USED /* 42131 */:
                return "42S31";
            case GENERAL_ERROR_1 /* 50000 */:
                return "HY000";
            case UNKNOWN_DATA_TYPE_1 /* 50004 */:
                return "HY004";
            case FEATURE_NOT_SUPPORTED_1 /* 50100 */:
                return "HYC00";
            case LOCK_TIMEOUT_1 /* 50200 */:
                return "HYT00";
            default:
