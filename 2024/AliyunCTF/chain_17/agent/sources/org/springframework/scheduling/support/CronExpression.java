...
/* loaded from: agent.jar:BOOT-INF/lib/spring-context-6.1.3.jar:org/springframework/scheduling/support/CronExpression.class */
public final class CronExpression {
    ...
    public static CronExpression parse(String expression) {
        ...
        String[] fields = StringUtils.tokenizeToStringArray(expression2, CharSequenceUtil.SPACE);
        if (fields.length != 6) {
