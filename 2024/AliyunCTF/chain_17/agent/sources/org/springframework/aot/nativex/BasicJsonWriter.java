...
/* loaded from: agent.jar:BOOT-INF/lib/spring-core-6.1.3.jar:org/springframework/aot/nativex/BasicJsonWriter.class */
public class BasicJsonWriter {
    ...
    private void writeObject(Map<String, Object> attributes, boolean newLine) {
        if (attributes.isEmpty()) {
            ...
            this.writer.println(StrPool.DELIM_START).indented(writeAll(attributes.entrySet().iterator(), entry -> {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* loaded from: agent.jar:BOOT-INF/lib/spring-core-6.1.3.jar:org/springframework/aot/nativex/BasicJsonWriter$IndentingWriter.class */
