...
/* loaded from: agent.jar:BOOT-INF/lib/spring-core-6.1.3.jar:org/springframework/util/StopWatch.class */
public class StopWatch {
    ...
    public String prettyPrint(TimeUnit timeUnit) {
        ...
        sb.append(total).append(CharSequenceUtil.SPACE).append(timeUnit.name().toLowerCase(Locale.ENGLISH));
    ...
    /* loaded from: agent.jar:BOOT-INF/lib/spring-core-6.1.3.jar:org/springframework/util/StopWatch$TaskInfo.class */
