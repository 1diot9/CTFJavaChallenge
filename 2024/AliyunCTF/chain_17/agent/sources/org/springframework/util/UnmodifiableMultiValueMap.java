...
/* loaded from: agent.jar:BOOT-INF/lib/spring-core-6.1.3.jar:org/springframework/util/UnmodifiableMultiValueMap.class */
public final class UnmodifiableMultiValueMap<K, V> implements MultiValueMap<K, V>, Serializable {
    ...
    /* loaded from: agent.jar:BOOT-INF/lib/spring-core-6.1.3.jar:org/springframework/util/UnmodifiableMultiValueMap$UnmodifiableEntrySet.class */
    private static class UnmodifiableEntrySet<K, V> implements Set<Map.Entry<K, List<V>>>, Serializable {
        ...
        /* loaded from: agent.jar:BOOT-INF/lib/spring-core-6.1.3.jar:org/springframework/util/UnmodifiableMultiValueMap$UnmodifiableEntrySet$UnmodifiableEntrySpliterator.class */
        ...
        /* JADX INFO: Access modifiers changed from: private */
        /* loaded from: agent.jar:BOOT-INF/lib/spring-core-6.1.3.jar:org/springframework/util/UnmodifiableMultiValueMap$UnmodifiableEntrySet$UnmodifiableEntry.class */
    ...
    /* loaded from: agent.jar:BOOT-INF/lib/spring-core-6.1.3.jar:org/springframework/util/UnmodifiableMultiValueMap$UnmodifiableValueCollection.class */
    private static class UnmodifiableValueCollection<V> implements Collection<List<V>>, Serializable {
        ...
        /* JADX INFO: Access modifiers changed from: private */
        /* loaded from: agent.jar:BOOT-INF/lib/spring-core-6.1.3.jar:org/springframework/util/UnmodifiableMultiValueMap$UnmodifiableValueCollection$UnmodifiableValueSpliterator.class */
