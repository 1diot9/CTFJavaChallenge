...
/* loaded from: agent.jar:BOOT-INF/lib/spring-core-6.1.3.jar:org/springframework/util/ResourceUtils.class */
public abstract class ResourceUtils {
    ...
    public static boolean isJarURL(URL url) {
        String protocol = url.getProtocol();
        return "jar".equals(protocol) || URL_PROTOCOL_WAR.equals(protocol) || "zip".equals(protocol) || "vfszip".equals(protocol) || "wsjar".equals(protocol);
    }
    ...
    public static URI toURI(String location) throws URISyntaxException {
        return new URI(StringUtils.replace(location, CharSequenceUtil.SPACE, "%20"));
    }
    ...
    public static URL toRelativeURL(URL root, String relativePath) throws MalformedURLException {
        return toURL(StringUtils.applyRelativePath(root.toString(), StringUtils.replace(relativePath, "#", "%23")));
    }
