...
/* loaded from: agent.jar:BOOT-INF/lib/spring-core-6.1.3.jar:org/springframework/util/AutoPopulatingList.class */
public class AutoPopulatingList<E> implements List<E>, Serializable {
    private final List<E> backingList;
    private final ElementFactory<E> elementFactory;

    @FunctionalInterface
    /* loaded from: agent.jar:BOOT-INF/lib/spring-core-6.1.3.jar:org/springframework/util/AutoPopulatingList$ElementFactory.class */
    ...
    /* loaded from: agent.jar:BOOT-INF/lib/spring-core-6.1.3.jar:org/springframework/util/AutoPopulatingList$ElementInstantiationException.class */
    ...
    /* loaded from: agent.jar:BOOT-INF/lib/spring-core-6.1.3.jar:org/springframework/util/AutoPopulatingList$ReflectiveElementFactory.class */
