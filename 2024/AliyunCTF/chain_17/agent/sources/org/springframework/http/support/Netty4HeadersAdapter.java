...
/* loaded from: agent.jar:BOOT-INF/lib/spring-web-6.1.3.jar:org/springframework/http/support/Netty4HeadersAdapter.class */
public final class Netty4HeadersAdapter implements MultiValueMap<String, String> {
    ...
    /* loaded from: agent.jar:BOOT-INF/lib/spring-web-6.1.3.jar:org/springframework/http/support/Netty4HeadersAdapter$EntryIterator.class */
    ...
    /* loaded from: agent.jar:BOOT-INF/lib/spring-web-6.1.3.jar:org/springframework/http/support/Netty4HeadersAdapter$HeaderEntry.class */
    ...
    /* loaded from: agent.jar:BOOT-INF/lib/spring-web-6.1.3.jar:org/springframework/http/support/Netty4HeadersAdapter$HeaderNames.class */
    ...
    /* loaded from: agent.jar:BOOT-INF/lib/spring-web-6.1.3.jar:org/springframework/http/support/Netty4HeadersAdapter$HeaderNamesIterator.class */
