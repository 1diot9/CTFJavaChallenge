...
/* loaded from: agent.jar:BOOT-INF/lib/spring-web-6.1.3.jar:org/springframework/http/MediaType.class */
public class MediaType extends MimeType implements Serializable {
    ...
    public static final MediaType IMAGE_GIF = new MediaType("image", ImgUtil.IMAGE_TYPE_GIF);
    public static final MediaType IMAGE_JPEG = new MediaType("image", ImgUtil.IMAGE_TYPE_JPEG);
    public static final MediaType IMAGE_PNG = new MediaType("image", ImgUtil.IMAGE_TYPE_PNG);
