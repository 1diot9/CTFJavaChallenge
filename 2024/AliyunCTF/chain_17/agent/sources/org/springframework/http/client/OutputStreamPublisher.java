...
/* loaded from: agent.jar:BOOT-INF/lib/spring-web-6.1.3.jar:org/springframework/http/client/OutputStreamPublisher.class */
final class OutputStreamPublisher<T> implements Flow.Publisher<T> {
    ...
    /* loaded from: agent.jar:BOOT-INF/lib/spring-web-6.1.3.jar:org/springframework/http/client/OutputStreamPublisher$ByteMapper.class */
    ...
    @FunctionalInterface
    /* loaded from: agent.jar:BOOT-INF/lib/spring-web-6.1.3.jar:org/springframework/http/client/OutputStreamPublisher$OutputStreamHandler.class */
    ...
    /* loaded from: agent.jar:BOOT-INF/lib/spring-web-6.1.3.jar:org/springframework/http/client/OutputStreamPublisher$OutputStreamSubscription.class */
