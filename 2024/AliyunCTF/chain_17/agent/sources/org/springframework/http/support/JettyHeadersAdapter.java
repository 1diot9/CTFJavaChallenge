...
/* loaded from: agent.jar:BOOT-INF/lib/spring-web-6.1.3.jar:org/springframework/http/support/JettyHeadersAdapter.class */
public final class JettyHeadersAdapter implements MultiValueMap<String, String> {
    ...
    /* loaded from: agent.jar:BOOT-INF/lib/spring-web-6.1.3.jar:org/springframework/http/support/JettyHeadersAdapter$EntryIterator.class */
    ...
    /* loaded from: agent.jar:BOOT-INF/lib/spring-web-6.1.3.jar:org/springframework/http/support/JettyHeadersAdapter$HeaderEntry.class */
    ...
    /* loaded from: agent.jar:BOOT-INF/lib/spring-web-6.1.3.jar:org/springframework/http/support/JettyHeadersAdapter$HeaderNames.class */
    ...
    /* loaded from: agent.jar:BOOT-INF/lib/spring-web-6.1.3.jar:org/springframework/http/support/JettyHeadersAdapter$HeaderNamesIterator.class */
