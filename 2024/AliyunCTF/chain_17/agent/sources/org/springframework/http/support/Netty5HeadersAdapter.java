...
/* loaded from: agent.jar:BOOT-INF/lib/spring-web-6.1.3.jar:org/springframework/http/support/Netty5HeadersAdapter.class */
public final class Netty5HeadersAdapter implements MultiValueMap<String, String> {
    ...
    /* loaded from: agent.jar:BOOT-INF/lib/spring-web-6.1.3.jar:org/springframework/http/support/Netty5HeadersAdapter$EntryIterator.class */
    ...
    /* loaded from: agent.jar:BOOT-INF/lib/spring-web-6.1.3.jar:org/springframework/http/support/Netty5HeadersAdapter$HeaderEntry.class */
    ...
    /* loaded from: agent.jar:BOOT-INF/lib/spring-web-6.1.3.jar:org/springframework/http/support/Netty5HeadersAdapter$HeaderNames.class */
    ...
    /* loaded from: agent.jar:BOOT-INF/lib/spring-web-6.1.3.jar:org/springframework/http/support/Netty5HeadersAdapter$HeaderNamesIterator.class */
