...
/* loaded from: agent.jar:BOOT-INF/lib/spring-web-6.1.3.jar:org/springframework/http/server/reactive/observation/ServerHttpObservationDocumentation.class */
public enum ServerHttpObservationDocumentation implements ObservationDocumentation {
    ...
    /* loaded from: agent.jar:BOOT-INF/lib/spring-web-6.1.3.jar:org/springframework/http/server/reactive/observation/ServerHttpObservationDocumentation$HighCardinalityKeyNames.class */
    ...
    /* loaded from: agent.jar:BOOT-INF/lib/spring-web-6.1.3.jar:org/springframework/http/server/reactive/observation/ServerHttpObservationDocumentation$LowCardinalityKeyNames.class */
