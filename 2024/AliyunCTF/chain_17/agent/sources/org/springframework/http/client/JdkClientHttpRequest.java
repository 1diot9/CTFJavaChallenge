...
/* loaded from: agent.jar:BOOT-INF/lib/spring-web-6.1.3.jar:org/springframework/http/client/JdkClientHttpRequest.class */
class JdkClientHttpRequest extends AbstractStreamingClientHttpRequest {
    ...
    /* loaded from: agent.jar:BOOT-INF/lib/spring-web-6.1.3.jar:org/springframework/http/client/JdkClientHttpRequest$ByteBufferMapper.class */
