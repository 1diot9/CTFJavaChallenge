...
/* loaded from: agent.jar:BOOT-INF/lib/spring-expression-6.1.3.jar:org/springframework/expression/spel/SpelMessage.class */
public enum SpelMessage {
    ...
    TYPE_NOT_FOUND(Kind.ERROR, PgServer.PG_TYPE_INT2_ARRAY, "Type cannot be found ''{0}''"),
    ...
    INVALID_TYPE_FOR_SELECTION(Kind.ERROR, PgServer.PG_TYPE_VARCHAR_ARRAY, "Cannot perform selection on input data of type ''{0}''"),
    ...
    RIGHT_OPERAND_PROBLEM(Kind.ERROR, PgServer.PG_TYPE_BPCHAR, "Problem parsing right operand"),
    NOT_EXPECTED_TOKEN(Kind.ERROR, PgServer.PG_TYPE_VARCHAR, "Unexpected token. Expected ''{0}'' but was ''{1}''"),
    ...
    NEGATIVE_REPEATED_TEXT_COUNT(Kind.ERROR, 1081, "Repeat count ''{0}'' must not be negative");

    private final Kind kind;
    private final int code;
    private final String message;

    /* loaded from: agent.jar:BOOT-INF/lib/spring-expression-6.1.3.jar:org/springframework/expression/spel/SpelMessage$Kind.class */
    public enum Kind {
        INFO,
        WARNING,
        ERROR
