...
/* loaded from: agent.jar:BOOT-INF/lib/spring-expression-6.1.3.jar:org/springframework/expression/spel/ast/OpPlus.class */
public class OpPlus extends Operator {
    ...
    public TypedValue getValueInternal(ExpressionState state) throws EvaluationException {
        ...
        if (leftOperand instanceof String) {
            ...
            String rightString2 = rightOperand == null ? "null" : convertTypedValueToString(operandTwoValue, state);
        ...
        if (rightOperand instanceof String) {
            ...
            String leftString3 = leftOperand == null ? "null" : convertTypedValueToString(operandOneValue, state);
    ...
    private void checkStringLength(String string) {
        if (string.length() > 100000) {
            throw new SpelEvaluationException(getStartPosition(), SpelMessage.MAX_CONCATENATED_STRING_LENGTH_EXCEEDED, 100000);
        }
    }
