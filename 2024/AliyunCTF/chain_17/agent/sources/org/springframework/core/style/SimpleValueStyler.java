...
/* loaded from: agent.jar:BOOT-INF/lib/spring-core-6.1.3.jar:org/springframework/core/style/SimpleValueStyler.class */
public class SimpleValueStyler extends DefaultValueStyler {
    ...
    protected <K, V> String styleMap(Map<K, V> map) {
        StringJoiner result = new StringJoiner(", ", StrPool.DELIM_START, "}");
