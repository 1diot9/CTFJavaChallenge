...
/* loaded from: agent.jar:BOOT-INF/lib/spring-core-6.1.3.jar:org/springframework/core/annotation/SynthesizedMergedAnnotationInvocationHandler.class */
public final class SynthesizedMergedAnnotationInvocationHandler<A extends Annotation> implements InvocationHandler {
    ...
    private String annotationToString() {
        ...
        if (string == null) {
            StringBuilder builder = new StringBuilder(StrPool.AT).append(getName(this.type)).append('(');
            for (int i = 0; i < this.attributes.size(); i++) {
                Method attribute = this.attributes.get(i);
                if (i > 0) {
                    builder.append(", ");
