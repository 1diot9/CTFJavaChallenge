...
/* loaded from: agent.jar:BOOT-INF/lib/spring-core-6.1.3.jar:org/springframework/core/metrics/DefaultApplicationStartup.class */
class DefaultApplicationStartup implements ApplicationStartup {
    ...
    /* loaded from: agent.jar:BOOT-INF/lib/spring-core-6.1.3.jar:org/springframework/core/metrics/DefaultApplicationStartup$DefaultStartupStep.class */
    public static class DefaultStartupStep implements StartupStep {
        ...
        /* loaded from: agent.jar:BOOT-INF/lib/spring-core-6.1.3.jar:org/springframework/core/metrics/DefaultApplicationStartup$DefaultStartupStep$DefaultTags.class */
