...
/* loaded from: agent.jar:BOOT-INF/lib/spring-core-6.1.3.jar:org/springframework/core/NativeDetector.class */
public abstract class NativeDetector {
    ...
    /* loaded from: agent.jar:BOOT-INF/lib/spring-core-6.1.3.jar:org/springframework/core/NativeDetector$Context.class */
    public enum Context {
        BUILD("buildtime"),
        RUN("runtime");
