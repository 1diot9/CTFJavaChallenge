...
/* loaded from: agent.jar:org/springframework/boot/loader/launch/PropertiesLauncher.class */
public class PropertiesLauncher extends Launcher {
    ...
    */
    ...
    private String handleUrl(String path) {
        if (path.startsWith(JAR_FILE_PREFIX) || path.startsWith("file:")) {
    ...
    private String getProperty(String name, String manifestKey, String defaultValue) throws Exception {
        ...
        if (this.properties.containsKey(name)) {
            return getResolvedProperty(name, manifestKey2, this.properties.getProperty(name), "properties");
        }
    ...
    /* loaded from: agent.jar:org/springframework/boot/loader/launch/PropertiesLauncher$Instantiator.class */
    public static final class Instantiator<T> extends Record {
        ...
        /* JADX INFO: Access modifiers changed from: private */
        /* loaded from: agent.jar:org/springframework/boot/loader/launch/PropertiesLauncher$Instantiator$Using.class */
