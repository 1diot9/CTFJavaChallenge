...
/* loaded from: agent.jar:BOOT-INF/lib/spring-boot-3.2.2.jar:org/springframework/boot/jdbc/EmbeddedDatabaseConnection.class */
public enum EmbeddedDatabaseConnection {
    ...
    /* loaded from: agent.jar:BOOT-INF/lib/spring-boot-3.2.2.jar:org/springframework/boot/jdbc/EmbeddedDatabaseConnection$IsEmbedded.class */
    private static final class IsEmbedded implements ConnectionCallback<Boolean> {
        private IsEmbedded() {
        }

        /* renamed from: doInConnection, reason: merged with bridge method [inline-methods] */
        public Boolean m2113doInConnection(Connection connection) throws SQLException, DataAccessException {
