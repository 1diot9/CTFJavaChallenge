...
/* loaded from: agent.jar:BOOT-INF/lib/spring-boot-3.2.2.jar:org/springframework/boot/r2dbc/EmbeddedDatabaseConnection.class */
public enum EmbeddedDatabaseConnection {
    ...
    H2("io.r2dbc.h2.H2ConnectionFactoryProvider", "r2dbc:h2:mem:///%s?options=DB_CLOSE_DELAY=-1;DB_CLOSE_ON_EXIT=FALSE", options2 -> {
        return options2.getValue(ConnectionFactoryOptions.DRIVER).equals(JaasCredentialsValidator.DEFAULT_APPNAME) && options2.getValue(ConnectionFactoryOptions.PROTOCOL).equals("mem");
    });
