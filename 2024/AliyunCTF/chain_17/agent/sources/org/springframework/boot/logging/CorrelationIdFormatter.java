...
/* loaded from: agent.jar:BOOT-INF/lib/spring-boot-3.2.2.jar:org/springframework/boot/logging/CorrelationIdFormatter.class */
public final class CorrelationIdFormatter {
    ...
    /* loaded from: agent.jar:BOOT-INF/lib/spring-boot-3.2.2.jar:org/springframework/boot/logging/CorrelationIdFormatter$Part.class */
    public static final class Part extends Record {
        ...
        String resolve(UnaryOperator<String> resolver) {
            ...
            return padding <= 0 ? resolved : resolved + CharSequenceUtil.SPACE.repeat(padding);
        }

        String blank() {
            return CharSequenceUtil.SPACE.repeat(this.length);
        }
