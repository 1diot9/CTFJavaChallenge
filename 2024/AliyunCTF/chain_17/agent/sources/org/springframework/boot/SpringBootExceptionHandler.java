...
/* loaded from: agent.jar:BOOT-INF/lib/spring-boot-3.2.2.jar:org/springframework/boot/SpringBootExceptionHandler.class */
public class SpringBootExceptionHandler implements Thread.UncaughtExceptionHandler {
    ...
    private static final LoggedExceptionHandlerThreadLocal handler;
    ...
    /* loaded from: agent.jar:BOOT-INF/lib/spring-boot-3.2.2.jar:org/springframework/boot/SpringBootExceptionHandler$LoggedExceptionHandlerThreadLocal.class */
    public static final class LoggedExceptionHandlerThreadLocal extends ThreadLocal<SpringBootExceptionHandler> {
