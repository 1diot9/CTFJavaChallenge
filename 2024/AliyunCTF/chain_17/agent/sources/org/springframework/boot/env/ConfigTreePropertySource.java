...
/* loaded from: agent.jar:BOOT-INF/lib/spring-boot-3.2.2.jar:org/springframework/boot/env/ConfigTreePropertySource.class */
public class ConfigTreePropertySource extends EnumerablePropertySource<Path> implements OriginLookup<String> {
    ...
    /* loaded from: agent.jar:BOOT-INF/lib/spring-boot-3.2.2.jar:org/springframework/boot/env/ConfigTreePropertySource$Option.class */
    public enum Option {
        ALWAYS_READ,
        USE_LOWERCASE_NAMES,
    ...
    /* loaded from: agent.jar:BOOT-INF/lib/spring-boot-3.2.2.jar:org/springframework/boot/env/ConfigTreePropertySource$Value.class */
    ...
    /* loaded from: agent.jar:BOOT-INF/lib/spring-boot-3.2.2.jar:org/springframework/boot/env/ConfigTreePropertySource$PropertyFile.class */
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* loaded from: agent.jar:BOOT-INF/lib/spring-boot-3.2.2.jar:org/springframework/boot/env/ConfigTreePropertySource$PropertyFileContent.class */
