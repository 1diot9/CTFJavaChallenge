...
/* loaded from: agent.jar:BOOT-INF/lib/spring-boot-3.2.2.jar:org/springframework/boot/web/server/MimeMappings.class */
public class MimeMappings implements Iterable<Mapping> {
    ...
    /* loaded from: agent.jar:BOOT-INF/lib/spring-boot-3.2.2.jar:org/springframework/boot/web/server/MimeMappings$Mapping.class */
    ...
    /* loaded from: agent.jar:BOOT-INF/lib/spring-boot-3.2.2.jar:org/springframework/boot/web/server/MimeMappings$DefaultMimeMappings.class */
    static final class DefaultMimeMappings extends MimeMappings {
        ...
        static {
            ...
            mappings.add(ImgUtil.IMAGE_TYPE_GIF, "image/gif");
            ...
            mappings.add(ImgUtil.IMAGE_TYPE_JPEG, "image/jpeg");
            mappings.add(ImgUtil.IMAGE_TYPE_JPG, "image/jpeg");
            mappings.add("js", "text/javascript");
            mappings.add("json", "application/json");
            mappings.add("otf", "font/otf");
            mappings.add("pdf", MediaType.APPLICATION_PDF_VALUE);
            mappings.add(ImgUtil.IMAGE_TYPE_PNG, "image/png");
    ...
    /* loaded from: agent.jar:BOOT-INF/lib/spring-boot-3.2.2.jar:org/springframework/boot/web/server/MimeMappings$LazyMimeMappingsCopy.class */
    ...
    /* loaded from: agent.jar:BOOT-INF/lib/spring-boot-3.2.2.jar:org/springframework/boot/web/server/MimeMappings$MimeMappingsRuntimeHints.class */
