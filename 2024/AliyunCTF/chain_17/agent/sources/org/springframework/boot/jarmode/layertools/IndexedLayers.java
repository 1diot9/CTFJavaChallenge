...
/* loaded from: agent.jar:BOOT-INF/lib/spring-boot-jarmode-layertools-3.2.2.jar:org/springframework/boot/jarmode/layertools/IndexedLayers.class */
public class IndexedLayers implements Layers {
    ...
    IndexedLayers(String indexFile) {
        String[] lines = (String[]) Arrays.stream(indexFile.split(StrPool.LF)).map(line -> {
            return line.replace(StrPool.CR, "");
