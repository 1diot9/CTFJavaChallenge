...
/* loaded from: agent.jar:org/springframework/boot/loader/zip/ZipString.class */
final class ZipString {
    ...
    /* loaded from: agent.jar:org/springframework/boot/loader/zip/ZipString$CompareType.class */
    ...
    public static int hash(ByteBuffer buffer, DataBlock dataBlock, long pos, int len, boolean addEndSlash) throws IOException {
        ...
        while (len > 0) {
            ...
            while (byteIndex < count) {
                ...
                if (codePoint <= 65535) {
                    lastChar = (char) (codePoint & NetUtil.PORT_RANGE_MAX);
