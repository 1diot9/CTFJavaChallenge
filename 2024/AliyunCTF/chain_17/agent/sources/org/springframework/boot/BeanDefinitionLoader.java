...
/* loaded from: agent.jar:BOOT-INF/lib/spring-boot-3.2.2.jar:org/springframework/boot/BeanDefinitionLoader.class */
public class BeanDefinitionLoader {
    ...
    @FunctionalInterface
    /* loaded from: agent.jar:BOOT-INF/lib/spring-boot-3.2.2.jar:org/springframework/boot/BeanDefinitionLoader$GroovyBeanDefinitionSource.class */
    ...
    /* loaded from: agent.jar:BOOT-INF/lib/spring-boot-3.2.2.jar:org/springframework/boot/BeanDefinitionLoader$ClassExcludeFilter.class */
