...
/* loaded from: agent.jar:BOOT-INF/lib/spring-boot-3.2.2.jar:org/springframework/boot/ssl/AliasKeyManagerFactory.class */
final class AliasKeyManagerFactory extends KeyManagerFactory {
    ...
    /* loaded from: agent.jar:BOOT-INF/lib/spring-boot-3.2.2.jar:org/springframework/boot/ssl/AliasKeyManagerFactory$AliasKeyManagerFactorySpi.class */
    ...
    /* loaded from: agent.jar:BOOT-INF/lib/spring-boot-3.2.2.jar:org/springframework/boot/ssl/AliasKeyManagerFactory$AliasX509ExtendedKeyManager.class */
