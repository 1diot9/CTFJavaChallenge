...
/* loaded from: agent.jar:BOOT-INF/lib/spring-boot-3.2.2.jar:org/springframework/boot/web/embedded/netty/NettyWebServer.class */
public class NettyWebServer implements WebServer {
    ...
    private void tryAppend(StringBuilder message, String format, Supplier<Object> supplier) {
        try {
            ...
            message.append(!message.isEmpty() ? CharSequenceUtil.SPACE : "");
