...
/* loaded from: agent.jar:BOOT-INF/lib/spring-boot-jarmode-layertools-3.2.2.jar:org/springframework/boot/jarmode/layertools/HelpCommand.class */
class HelpCommand extends Command {
    ...
    private String getUsage(Command command) {
        ...
        command.getParameters().getDescriptions().forEach(param -> {
            usage.append(CharSequenceUtil.SPACE).append(param);
        });
