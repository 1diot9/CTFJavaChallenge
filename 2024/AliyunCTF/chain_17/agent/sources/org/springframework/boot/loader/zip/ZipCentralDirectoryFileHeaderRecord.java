...
/* loaded from: agent.jar:org/springframework/boot/loader/zip/ZipCentralDirectoryFileHeaderRecord.class */
final class ZipCentralDirectoryFileHeaderRecord extends Record {
    ...
    private long decodeMsDosFormatDateTime(short date, short time) {
        int year = getChronoValue(((date >> 9) & 127) + 1980, ChronoField.YEAR);
