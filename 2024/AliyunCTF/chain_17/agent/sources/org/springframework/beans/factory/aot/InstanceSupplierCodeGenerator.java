...
/* loaded from: agent.jar:BOOT-INF/lib/spring-beans-6.1.3.jar:org/springframework/beans/factory/aot/InstanceSupplierCodeGenerator.class */
public class InstanceSupplierCodeGenerator {
    ...
    private CodeBlock generateWithGeneratorCode(boolean hasArguments, CodeBlock newInstance) {
        ...
        CodeBlock.Builder code = CodeBlock.builder();
        code.add(StrPool.LF, new Object[0]);
        code.indent().indent();
    ...
    /* loaded from: agent.jar:BOOT-INF/lib/spring-beans-6.1.3.jar:org/springframework/beans/factory/aot/InstanceSupplierCodeGenerator$KotlinDelegate.class */
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* loaded from: agent.jar:BOOT-INF/lib/spring-beans-6.1.3.jar:org/springframework/beans/factory/aot/InstanceSupplierCodeGenerator$ProxyRuntimeHintsRegistrar.class */
