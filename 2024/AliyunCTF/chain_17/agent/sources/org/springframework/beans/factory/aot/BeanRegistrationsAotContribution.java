...
/* loaded from: agent.jar:BOOT-INF/lib/spring-beans-6.1.3.jar:org/springframework/beans/factory/aot/BeanRegistrationsAotContribution.class */
class BeanRegistrationsAotContribution implements BeanFactoryInitializationAotContribution {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* loaded from: agent.jar:BOOT-INF/lib/spring-beans-6.1.3.jar:org/springframework/beans/factory/aot/BeanRegistrationsAotContribution$Registration.class */
    ...
    /* loaded from: agent.jar:BOOT-INF/lib/spring-beans-6.1.3.jar:org/springframework/beans/factory/aot/BeanRegistrationsAotContribution$BeanRegistrationsCodeGenerator.class */
