...
/* loaded from: agent.jar:BOOT-INF/lib/spring-web-6.1.3.jar:org/springframework/web/server/adapter/WebHttpHandlerBuilder.class */
public final class WebHttpHandlerBuilder {
    ...
    public WebHttpHandlerBuilder m2740clone() {
        return new WebHttpHandlerBuilder(this);
    }

    /* loaded from: agent.jar:BOOT-INF/lib/spring-web-6.1.3.jar:org/springframework/web/server/adapter/WebHttpHandlerBuilder$SpringWebBlockHoundIntegration.class */
