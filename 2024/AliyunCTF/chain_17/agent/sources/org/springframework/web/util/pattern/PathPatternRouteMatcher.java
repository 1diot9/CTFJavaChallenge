...
/* loaded from: agent.jar:BOOT-INF/lib/spring-web-6.1.3.jar:org/springframework/web/util/pattern/PathPatternRouteMatcher.class */
public class PathPatternRouteMatcher implements RouteMatcher {
    ...
    /* loaded from: agent.jar:BOOT-INF/lib/spring-web-6.1.3.jar:org/springframework/web/util/pattern/PathPatternRouteMatcher$PathContainerRoute.class */
