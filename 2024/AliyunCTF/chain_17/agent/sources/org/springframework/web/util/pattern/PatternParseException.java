...
/* loaded from: agent.jar:BOOT-INF/lib/spring-web-6.1.3.jar:org/springframework/web/util/pattern/PatternParseException.class */
public class PatternParseException extends IllegalArgumentException {
    ...
    public String toDetailedString() {
        ...
        sb.append(CharSequenceUtil.SPACE.repeat(Math.max(0, this.position)));
        sb.append("^\n");
    ...
    /* loaded from: agent.jar:BOOT-INF/lib/spring-web-6.1.3.jar:org/springframework/web/util/pattern/PatternParseException$PatternMessage.class */
