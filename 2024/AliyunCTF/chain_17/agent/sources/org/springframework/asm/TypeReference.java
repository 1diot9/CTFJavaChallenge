...
/* loaded from: agent.jar:BOOT-INF/lib/spring-core-6.1.3.jar:org/springframework/asm/TypeReference.class */
public class TypeReference {
    ...
    public static TypeReference newSuperTypeReference(final int itfIndex) {
        return new TypeReference(268435456 | ((itfIndex & NetUtil.PORT_RANGE_MAX) << 8));
    }
    ...
    public static void putTarget(final int targetTypeAndInfo, final ByteVector output) {
