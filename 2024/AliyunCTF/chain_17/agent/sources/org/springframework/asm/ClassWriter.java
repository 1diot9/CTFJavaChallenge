...
/* loaded from: agent.jar:BOOT-INF/lib/spring-core-6.1.3.jar:org/springframework/asm/ClassWriter.class */
public class ClassWriter extends ClassVisitor {
    ...
    public final void visit(final int version, final int access, final String name, final String signature, final String superName, final String[] interfaces) {
        ...
        this.thisClass = this.symbolTable.setMajorVersionAndClassName(version & NetUtil.PORT_RANGE_MAX, name);
        if (signature != null) {
        ...
        if (this.compute == 1 && (version & NetUtil.PORT_RANGE_MAX) >= 51) {
            this.compute = 2;
        }
    }
    ...
    public byte[] toByteArray() {
        ...
        if ((this.accessFlags & 4096) != 0 && (this.version & NetUtil.PORT_RANGE_MAX) < 49) {
            attributesCount++;
            size += 6;
        ...
        int mask = (this.version & NetUtil.PORT_RANGE_MAX) < 49 ? 4096 : 0;
