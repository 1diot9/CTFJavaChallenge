...
/* loaded from: agent.jar:BOOT-INF/lib/snakeyaml-2.2.jar:org/yaml/snakeyaml/scanner/ScannerImpl.class */
public final class ScannerImpl implements Scanner {
    ...
    static {
        ...
        ESCAPE_REPLACEMENTS.put('n', StrPool.LF);
        ESCAPE_REPLACEMENTS.put('v', "\u000b");
        ESCAPE_REPLACEMENTS.put('f', "\f");
        ESCAPE_REPLACEMENTS.put('r', StrPool.CR);
        ESCAPE_REPLACEMENTS.put('e', "\u001b");
        ESCAPE_REPLACEMENTS.put(' ', CharSequenceUtil.SPACE);
    ...
    private Integer scanYamlDirectiveNumber(Mark startMark) {
        ...
        Integer value = Integer.valueOf(Integer.parseInt(number));
        return value;
    }
    ...
    private List<Token> scanBlockScalar(char style) {
        ...
        while (this.reader.getColumn() == indent && this.reader.peek() != 0) {
            ...
            if (folded && StrPool.LF.equals(lineBreak) && leadingNonSpace && " \t".indexOf(this.reader.peek()) == -1) {
                if (breaks.length() == 0) {
                    chunks.append(CharSequenceUtil.SPACE);
                }
            } else {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:73:0x0222, code lost:            return r0.toString();     */
    /*
    ...
    */
    ...
    private String scanFlowScalarSpaces(Mark startMark) {
        ...
        if (lineBreak.length() != 0) {
            ...
            if (!StrPool.LF.equals(lineBreak)) {
                chunks.append(lineBreak);
    ...
    /* loaded from: agent.jar:BOOT-INF/lib/snakeyaml-2.2.jar:org/yaml/snakeyaml/scanner/ScannerImpl$Chomping.class */
