...
/* loaded from: agent.jar:BOOT-INF/lib/logback-classic-1.4.14.jar:ch/qos/logback/classic/encoder/JsonEncoder.class */
public class JsonEncoder extends EncoderBase<ILoggingEvent> {
    ...
    private void appendLoggerContext(StringBuilder sb, LoggerContextVO loggerContextVO) {
        ...
        sb.append(',');
        appendMap(sb, "properties", loggerContextVO.getPropertyMap());
        sb.append('}');
    }
