...
/* loaded from: agent.jar:BOOT-INF/lib/logback-classic-1.4.14.jar:ch/qos/logback/classic/Level.class */
public final class Level implements Serializable {
    ...
    public static final Level OFF = new Level(Integer.MAX_VALUE, CompareMode.OFF);
    ...
    public static Level toLevel(String sArg, Level defaultLevel) {
        ...
        if (in.equalsIgnoreCase(CompareMode.OFF)) {
            return OFF;
        }
        return defaultLevel;
    }
