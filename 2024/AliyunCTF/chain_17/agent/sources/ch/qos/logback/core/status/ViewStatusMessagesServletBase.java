...
/* loaded from: agent.jar:BOOT-INF/lib/logback-core-1.4.14.jar:ch/qos/logback/core/status/ViewStatusMessagesServletBase.class */
public abstract class ViewStatusMessagesServletBase extends HttpServlet {
    ...
    private static CachingDateFormatter SDF = new CachingDateFormatter(DatePattern.NORM_DATETIME_PATTERN);
