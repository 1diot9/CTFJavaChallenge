...
/* loaded from: agent.jar:BOOT-INF/lib/logback-core-1.4.14.jar:ch/qos/logback/core/net/SMTPAppenderBase.class */
public abstract class SMTPAppenderBase<E> extends AppenderBase<E> {
    ...
    private String charsetEncoding = CharsetUtil.UTF_8;
    ...
    private List<InternetAddress> parseAddress(E event) {
        ...
        for (int i = 0; i < len; i++) {
            try {
                ...
                addError("Could not parse email address for [" + String.valueOf(this.toPatternLayoutList.get(i)) + "] for event [" + String.valueOf(event) + "]", e);
                return iaList;
            }
        }
        return iaList;
    ...
    /* loaded from: agent.jar:BOOT-INF/lib/logback-core-1.4.14.jar:ch/qos/logback/core/net/SMTPAppenderBase$SenderRunnable.class */
