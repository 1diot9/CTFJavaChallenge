...
/* loaded from: agent.jar:BOOT-INF/lib/logback-core-1.4.14.jar:ch/qos/logback/core/util/StatusPrinter.class */
public class StatusPrinter {
    ...
    public static void buildStr(StringBuilder sb, String indentation, Status s) {
        ...
        if (cachingDateFormat != null) {
            ...
            sb.append(dateStr).append(CharSequenceUtil.SPACE);
        }
