...
/* loaded from: server.jar:BOOT-INF/lib/tomcat-embed-el-10.1.18.jar:jakarta/el/CompositeELResolver.class */
public class CompositeELResolver extends ELResolver {
    ...
    @Deprecated(forRemoval = true, since = "EL 5.0")
    /* loaded from: server.jar:BOOT-INF/lib/tomcat-embed-el-10.1.18.jar:jakarta/el/CompositeELResolver$FeatureIterator.class */
