...
/* loaded from: server.jar:BOOT-INF/lib/logback-classic-1.4.14.jar:ch/qos/logback/classic/PatternLayout.class */
public class PatternLayout extends PatternLayoutBase<ILoggingEvent> {
    ...
    static {
        ...
        DEFAULT_CONVERTER_MAP.put(JsonEncoder.MESSAGE_ATTR_NAME, MessageConverter.class.getName());
        ...
        DEFAULT_CONVERTER_MAP.put(JsonEncoder.MDC_ATTR_NAME, MDCConverter.class.getName());
        ...
        DEFAULT_CONVERTER_MAP.put(JsonEncoder.THROWABLE_ATTR_NAME, ThrowableProxyConverter.class.getName());
        ...
        DEFAULT_CONVERTER_MAP.put(JsonEncoder.SEQUENCE_NUMBER_ATTR_NAME, SequenceNumberConverter.class.getName());
