...
/* loaded from: server.jar:BOOT-INF/lib/logback-classic-1.4.14.jar:ch/qos/logback/classic/net/SocketNode.class */
public class SocketNode implements Runnable {
    ...
    public void run() {
        try {
            ...
            this.logger.error("Could not open ObjectInputStream to " + String.valueOf(this.socket), (Throwable) e);
            this.closed = true;
        }
        while (!this.closed) {
            try {
                ...
                this.logger.info("Caught java.io.IOException: " + String.valueOf(e4));
