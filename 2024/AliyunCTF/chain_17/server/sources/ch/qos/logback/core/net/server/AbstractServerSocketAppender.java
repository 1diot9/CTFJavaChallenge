...
/* loaded from: server.jar:BOOT-INF/lib/logback-core-1.4.14.jar:ch/qos/logback/core/net/server/AbstractServerSocketAppender.class */
public abstract class AbstractServerSocketAppender<E> extends AppenderBase<E> {
    ...
    public void start() {
        ...
        try {
            ...
            addError("server startup error: " + String.valueOf(ex), ex);
        }
    }
    ...
    public void stop() {
        ...
        try {
            ...
            addError("server shutdown error: " + String.valueOf(ex), ex);
        }
    }
