...
/* loaded from: server.jar:BOOT-INF/lib/logback-core-1.4.14.jar:ch/qos/logback/core/AsyncAppenderBase.class */
public class AsyncAppenderBase<E> extends UnsynchronizedAppenderBase<E> implements AppenderAttachable<E> {
    ...
    /* loaded from: server.jar:BOOT-INF/lib/logback-core-1.4.14.jar:ch/qos/logback/core/AsyncAppenderBase$Worker.class */
        ...
        public void run() {
            ...
            while (asyncAppenderBase.isStarted()) {
                try {
                    ...
                    arrayList.add(asyncAppenderBase.blockingQueue.take());
                    asyncAppenderBase.blockingQueue.drainTo(arrayList);
