...
/* loaded from: server.jar:BOOT-INF/lib/tomcat-embed-core-10.1.18.jar:org/apache/tomcat/util/http/fileupload/MultipartStream.class */
public class MultipartStream {
    ...
    /* loaded from: server.jar:BOOT-INF/lib/tomcat-embed-core-10.1.18.jar:org/apache/tomcat/util/http/fileupload/MultipartStream$ProgressNotifier.class */
    ...
    /* loaded from: server.jar:BOOT-INF/lib/tomcat-embed-core-10.1.18.jar:org/apache/tomcat/util/http/fileupload/MultipartStream$MalformedStreamException.class */
    ...
    /* loaded from: server.jar:BOOT-INF/lib/tomcat-embed-core-10.1.18.jar:org/apache/tomcat/util/http/fileupload/MultipartStream$IllegalBoundaryException.class */
    ...
    /* loaded from: server.jar:BOOT-INF/lib/tomcat-embed-core-10.1.18.jar:org/apache/tomcat/util/http/fileupload/MultipartStream$ItemInputStream.class */
    public class ItemInputStream extends InputStream implements Closeable {
        ...
        public int read() throws IOException {
            ...
            this.total++;
            byte[] bArr = MultipartStream.this.buffer;
        ...
        public long skip(long bytes) throws IOException {
            ...
            MultipartStream.this.head = (int) (r0.head + res);
            return res;
        }
