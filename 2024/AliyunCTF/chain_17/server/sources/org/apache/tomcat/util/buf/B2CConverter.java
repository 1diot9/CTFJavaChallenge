...
/* loaded from: server.jar:BOOT-INF/lib/tomcat-embed-core-10.1.18.jar:org/apache/tomcat/util/buf/B2CConverter.class */
public class B2CConverter {
    ...
    public void recycle() {
        try {
            ...
            log.warn(sm.getString("b2cConverter.decoderResetFail", this.decoder.charset()), t);
        }
