...
/* loaded from: server.jar:BOOT-INF/lib/tomcat-embed-core-10.1.18.jar:org/apache/tomcat/util/net/SocketWrapperBase.class */
public abstract class SocketWrapperBase<E> {
    ...
    /* loaded from: server.jar:BOOT-INF/lib/tomcat-embed-core-10.1.18.jar:org/apache/tomcat/util/net/SocketWrapperBase$BlockingMode.class */
    ...
    /* loaded from: server.jar:BOOT-INF/lib/tomcat-embed-core-10.1.18.jar:org/apache/tomcat/util/net/SocketWrapperBase$CompletionCheck.class */
    ...
    /* loaded from: server.jar:BOOT-INF/lib/tomcat-embed-core-10.1.18.jar:org/apache/tomcat/util/net/SocketWrapperBase$CompletionHandlerCall.class */
    ...
    /* loaded from: server.jar:BOOT-INF/lib/tomcat-embed-core-10.1.18.jar:org/apache/tomcat/util/net/SocketWrapperBase$CompletionState.class */
    ...
    public SocketWrapperBase(E socket, AbstractEndpoint<E, ?> endpoint) {
        ...
        this.connectionId = Long.toHexString(connectionIdGenerator.getAndIncrement());
    }
    ...
    /* JADX INFO: Access modifiers changed from: protected */
    /* loaded from: server.jar:BOOT-INF/lib/tomcat-embed-core-10.1.18.jar:org/apache/tomcat/util/net/SocketWrapperBase$OperationState.class */
    ...
    /* JADX INFO: Access modifiers changed from: protected */
    /* loaded from: server.jar:BOOT-INF/lib/tomcat-embed-core-10.1.18.jar:org/apache/tomcat/util/net/SocketWrapperBase$VectoredIOCompletionHandler.class */
    public class VectoredIOCompletionHandler<A> implements CompletionHandler<Long, SocketWrapperBase<E>.OperationState<A>> {
        ...
        public void completed(Long l, SocketWrapperBase<E>.OperationState<A> operationState) {
            ...
            if (operationState.check != null) {
                ...
                if (callHandler == CompletionHandlerCall.CONTINUE || (!operationState.read && operationState.hasOutboundRemaining())) {
                    z = false;
    ...
    /* JADX WARN: Code restructure failed: missing block: B:89:0x00ad, code lost:            if (r15.writePending.tryAcquire(r21, r23) == false) goto L36;     */
    /*
    ...
    */
    ...
    public ServletConnection getServletConnection(String protocol, String protocolConnectionId) {
        if (this.servletConnection == null) {
            this.servletConnection = new ServletConnectionImpl(this.connectionId, protocol, protocolConnectionId, this.endpoint.isSSLEnabled());
        }
