...
/* loaded from: server.jar:BOOT-INF/lib/tomcat-embed-core-10.1.18.jar:org/apache/tomcat/util/json/JavaCharStream.class */
public class JavaCharStream {
    ...
    protected void FillBuff() throws IOException {
        ...
        try {
            int i = this.inputStream.read(this.nextCharBuf, this.maxNextCharInd, Opcodes.ACC_SYNTHETIC - this.maxNextCharInd);
            if (i == -1) {
    ...
    public JavaCharStream(Reader dstream, int startline, int startcolumn, int buffersize) {
        ...
        this.nextCharBuf = new char[Opcodes.ACC_SYNTHETIC];
    }

    public JavaCharStream(Reader dstream, int startline, int startcolumn) {
        this(dstream, startline, startcolumn, Opcodes.ACC_SYNTHETIC);
    }

    public JavaCharStream(Reader dstream) {
        this(dstream, 1, 1, Opcodes.ACC_SYNTHETIC);
    }
    ...
    public void ReInit(Reader dstream, int startline, int startcolumn) {
        ReInit(dstream, startline, startcolumn, Opcodes.ACC_SYNTHETIC);
    }

    public void ReInit(Reader dstream) {
        ReInit(dstream, 1, 1, Opcodes.ACC_SYNTHETIC);
    }
    ...
    public JavaCharStream(InputStream dstream, int startline, int startcolumn, int buffersize) {
        this(new InputStreamReader(dstream), startline, startcolumn, Opcodes.ACC_SYNTHETIC);
    }
    ...
    public JavaCharStream(InputStream dstream, String encoding, int startline, int startcolumn) throws UnsupportedEncodingException {
        this(dstream, encoding, startline, startcolumn, Opcodes.ACC_SYNTHETIC);
    }
    ...
    public JavaCharStream(InputStream dstream, String encoding) throws UnsupportedEncodingException {
        this(dstream, encoding, 1, 1, Opcodes.ACC_SYNTHETIC);
    }
    ...
    public void ReInit(InputStream dstream, String encoding, int startline, int startcolumn) throws UnsupportedEncodingException {
        ReInit(dstream, encoding, startline, startcolumn, Opcodes.ACC_SYNTHETIC);
    }
    ...
    public void ReInit(InputStream dstream, String encoding) throws UnsupportedEncodingException {
        ReInit(dstream, encoding, 1, 1, Opcodes.ACC_SYNTHETIC);
    }
