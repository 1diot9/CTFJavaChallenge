...
/* loaded from: server.jar:BOOT-INF/lib/tomcat-embed-core-10.1.18.jar:org/apache/tomcat/util/net/SSLHostConfigCertificate.class */
public class SSLHostConfigCertificate implements Serializable {
    ...
    /* loaded from: server.jar:BOOT-INF/lib/tomcat-embed-core-10.1.18.jar:org/apache/tomcat/util/net/SSLHostConfigCertificate$StoreType.class */
    ...
    public KeyStore getCertificateKeystore() throws IOException {
        ...
        if (result == null && this.storeType == StoreType.KEYSTORE) {
            result = SSLUtilBase.getStore(getCertificateKeystoreType(), getCertificateKeystoreProvider(), getCertificateKeystoreFile(), getCertificateKeystorePassword(), getCertificateKeystorePasswordFile());
        }
        return result;
    }
    ...
    /* loaded from: server.jar:BOOT-INF/lib/tomcat-embed-core-10.1.18.jar:org/apache/tomcat/util/net/SSLHostConfigCertificate$Type.class */
    public enum Type {
