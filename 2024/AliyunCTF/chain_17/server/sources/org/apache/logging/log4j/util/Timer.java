...
/* loaded from: server.jar:BOOT-INF/lib/log4j-api-2.21.1.jar:org/apache/logging/log4j/util/Timer.class */
public class Timer implements Serializable, StringBuilderFormattable {
    ...
    /* loaded from: server.jar:BOOT-INF/lib/log4j-api-2.21.1.jar:org/apache/logging/log4j/util/Timer$Status.class */
    public enum Status {
        Started,
        Stopped,
        Paused
