...
/* loaded from: server.jar:BOOT-INF/lib/tomcat-embed-core-10.1.18.jar:org/apache/catalina/core/ApplicationContext.class */
public class ApplicationContext implements ServletContext {
    private final StandardContext context;
    private final Service service;
    private static final StringManager sm = StringManager.getManager((Class<?>) ApplicationContext.class);
    ...
    public URL getResource(String path) throws MalformedURLException {
        String validatedPath = validateResourcePath(path, !this.context.getContextGetResourceRequiresSlash());
    ...
    /* loaded from: server.jar:BOOT-INF/lib/tomcat-embed-core-10.1.18.jar:org/apache/catalina/core/ApplicationContext$DispatchData.class */
