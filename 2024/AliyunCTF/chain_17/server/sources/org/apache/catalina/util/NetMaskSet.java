...
/* loaded from: server.jar:BOOT-INF/lib/tomcat-embed-core-10.1.18.jar:org/apache/catalina/util/NetMaskSet.class */
public class NetMaskSet {
    ...
    public String toString() {
        ...
        if (result.startsWith(PropertyAccessor.PROPERTY_KEY_PREFIX)) {
