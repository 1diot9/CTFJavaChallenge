...
/* loaded from: server.jar:BOOT-INF/lib/tomcat-embed-core-10.1.18.jar:org/apache/catalina/authenticator/SpnegoAuthenticator.class */
public class SpnegoAuthenticator extends AuthenticatorBase {
        ...
        try {
            try {
                try {
                    ...
                    if (this.log.isDebugEnabled()) {
                        this.log.debug(sm.getString("spnegoAuthenticator.ticketValidateFail"), e5);
                    }
                    response.setHeader("WWW-Authenticate", AUTH_HEADER_VALUE_NEGOTIATE);
                    response.sendError(401);
                    if (0 != 0) {
                    ...
                    if (!(cause instanceof GSSException)) {
                        this.log.error(sm.getString("spnegoAuthenticator.serviceLoginFail"), e8);
                    } else if (this.log.isDebugEnabled()) {
                        this.log.debug(sm.getString("spnegoAuthenticator.serviceLoginFail"), e8);
                    }
                    response.setHeader("WWW-Authenticate", AUTH_HEADER_VALUE_NEGOTIATE);
                    response.sendError(401);
                    if (0 != 0) {
                ...
                this.log.error(sm.getString("spnegoAuthenticator.serviceLoginFail"), e11);
    ...
    /* loaded from: server.jar:BOOT-INF/lib/tomcat-embed-core-10.1.18.jar:org/apache/catalina/authenticator/SpnegoAuthenticator$AcceptAction.class */
    ...
    /* loaded from: server.jar:BOOT-INF/lib/tomcat-embed-core-10.1.18.jar:org/apache/catalina/authenticator/SpnegoAuthenticator$AuthenticateAction.class */
    ...
    /* loaded from: server.jar:BOOT-INF/lib/tomcat-embed-core-10.1.18.jar:org/apache/catalina/authenticator/SpnegoAuthenticator$SpnegoTokenFixer.class */
