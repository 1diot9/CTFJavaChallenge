...
/* loaded from: server.jar:BOOT-INF/lib/tomcat-embed-core-10.1.18.jar:org/apache/catalina/realm/UserDatabaseRealm.class */
public class UserDatabaseRealm extends RealmBase {
                ...
                if (this.database == null) {
                    try {
                        if (this.localJndiResource) {
                            ...
                            if (server == null) {
                                this.containerLog.error(sm.getString("userDatabaseRealm.noNamingContext"));
                                return null;
                            }
    ...
    /* loaded from: server.jar:BOOT-INF/lib/tomcat-embed-core-10.1.18.jar:org/apache/catalina/realm/UserDatabaseRealm$UserDatabasePrincipal.class */
