...
/* loaded from: server.jar:BOOT-INF/lib/tomcat-embed-core-10.1.18.jar:org/apache/coyote/http2/StreamStateMachine.class */
class StreamStateMachine {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public final synchronized String getCurrentStateName() {
        return this.state.name();
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* loaded from: server.jar:BOOT-INF/lib/tomcat-embed-core-10.1.18.jar:org/apache/coyote/http2/StreamStateMachine$State.class */
    public enum State {
