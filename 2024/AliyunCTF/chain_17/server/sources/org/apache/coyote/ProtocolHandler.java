...
/* loaded from: server.jar:BOOT-INF/lib/tomcat-embed-core-10.1.18.jar:org/apache/coyote/ProtocolHandler.class */
public interface ProtocolHandler {
    ...
    static ProtocolHandler create(String protocol) throws ClassNotFoundException, InstantiationException, IllegalAccessException, IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
        if (protocol == null || org.apache.coyote.http11.Constants.HTTP_11.equals(protocol) || Http11NioProtocol.class.getName().equals(protocol)) {
