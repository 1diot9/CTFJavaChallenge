...
/* loaded from: server.jar:BOOT-INF/lib/tomcat-embed-core-10.1.18.jar:org/apache/coyote/http2/Hpack.class */
final class Hpack {
    ...
    /* loaded from: server.jar:BOOT-INF/lib/tomcat-embed-core-10.1.18.jar:org/apache/coyote/http2/Hpack$HeaderField.class */
    ...
    public static int decodeInteger(ByteBuffer source, int n) throws HpackException {
        ...
        do {
            ...
            b = source.get();
            i += (b & Opcodes.LAND) * (PREFIX_TABLE[m] + 1);
            m += 7;
        } while ((b & 128) == 128);
        return i;
    }
