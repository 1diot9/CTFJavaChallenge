...
/* loaded from: server.jar:BOOT-INF/lib/tomcat-embed-el-10.1.18.jar:org/apache/el/stream/Stream.class */
public class Stream {
    ...
    public Optional average() {
        ...
        while (true) {
            ...
            count++;
            number = ELArithmetic.add(sum, this.iterator.next());
        }
        if (count == 0) {
            return Optional.EMPTY;
        }
    ...
    /* loaded from: server.jar:BOOT-INF/lib/tomcat-embed-el-10.1.18.jar:org/apache/el/stream/Stream$LambdaExpressionComparator.class */
    ...
    /* loaded from: server.jar:BOOT-INF/lib/tomcat-embed-el-10.1.18.jar:org/apache/el/stream/Stream$OpIterator.class */
