...
/* loaded from: server.jar:BOOT-INF/lib/tomcat-embed-core-10.1.18.jar:org/apache/naming/NamingContextEnumeration.class */
public class NamingContextEnumeration implements NamingEnumeration<NameClassPair> {
    ...
    public NameClassPair m875next() throws NamingException {
        return m876nextElement();
    }
    ...
    public NameClassPair m876nextElement() {
