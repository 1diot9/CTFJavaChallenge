...
/* loaded from: server.jar:BOOT-INF/lib/tomcat-embed-core-10.1.18.jar:org/apache/naming/NamingContextBindingsEnumeration.class */
public class NamingContextBindingsEnumeration implements NamingEnumeration<Binding> {
    ...
    public Binding m873next() throws NamingException {
    ...
    public Binding m874nextElement() {
        try {
            return nextElementInternal();
