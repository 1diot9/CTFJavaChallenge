...
/* loaded from: server.jar:BOOT-INF/lib/spring-aop-6.1.3.jar:org/springframework/aop/config/AopConfigUtils.class */
public abstract class AopConfigUtils {
    ...
    private static BeanDefinition registerOrEscalateApcAsRequired(Class<?> cls, BeanDefinitionRegistry registry, @Nullable Object source) {
        ...
        beanDefinition.getPropertyValues().add(AbstractBeanDefinition.ORDER_ATTRIBUTE, Integer.MIN_VALUE);
