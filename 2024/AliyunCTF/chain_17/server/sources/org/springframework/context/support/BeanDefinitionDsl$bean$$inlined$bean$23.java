...
/* loaded from: server.jar:BOOT-INF/lib/spring-context-6.1.3.jar:org/springframework/context/support/BeanDefinitionDsl$bean$$inlined$bean$23.class */
public final class BeanDefinitionDsl$bean$$inlined$bean$23<T> implements Supplier {
    final /* synthetic */ BeanDefinitionDsl this$0;
    final /* synthetic */ Function22 $f$inlined;

    public BeanDefinitionDsl$bean$$inlined$bean$23(BeanDefinitionDsl $receiver, Function22 function22) {
    ...
    public final T get() {
        ...
        Function22 function22 = this.$f$inlined;
        ...
        Object bean19 = context19.getBean(Object.class);
        Intrinsics.checkNotNullExpressionValue(bean19, "context.getBean(T::class.java)");
        GenericApplicationContext context20 = beanSupplierContext.getContext();
        Intrinsics.reifiedOperationMarker(4, "U");
        Object bean20 = context20.getBean(Object.class);
        Intrinsics.checkNotNullExpressionValue(bean20, "context.getBean(T::class.java)");
        GenericApplicationContext context21 = beanSupplierContext.getContext();
        Intrinsics.reifiedOperationMarker(4, "V");
        Object bean21 = context21.getBean(Object.class);
        Intrinsics.checkNotNullExpressionValue(bean21, "context.getBean(T::class.java)");
        GenericApplicationContext context22 = beanSupplierContext.getContext();
        Intrinsics.reifiedOperationMarker(4, "W");
        Object bean22 = context22.getBean(Object.class);
        Intrinsics.checkNotNullExpressionValue(bean22, "context.getBean(T::class.java)");
        return (T) function22.invoke(bean, bean2, bean3, bean4, bean5, bean6, bean7, bean8, bean9, bean10, bean11, bean12, bean13, bean14, bean15, bean16, bean17, bean18, bean19, bean20, bean21, bean22);
    }
}
