...
/* loaded from: server.jar:BOOT-INF/lib/spring-context-6.1.3.jar:org/springframework/context/support/BeanDefinitionDsl$bean$$inlined$bean$13.class */
public final class BeanDefinitionDsl$bean$$inlined$bean$13<T> implements Supplier {
    final /* synthetic */ BeanDefinitionDsl this$0;
    final /* synthetic */ Function12 $f$inlined;

    public BeanDefinitionDsl$bean$$inlined$bean$13(BeanDefinitionDsl $receiver, Function12 function12) {
    ...
    public final T get() {
        ...
        Function12 function12 = this.$f$inlined;
        ...
        return (T) function12.invoke(bean, bean2, bean3, bean4, bean5, bean6, bean7, bean8, bean9, bean10, bean11, bean12);
    }
}
