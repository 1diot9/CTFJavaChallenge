...
/* loaded from: server.jar:BOOT-INF/lib/spring-context-6.1.3.jar:org/springframework/context/support/BeanDefinitionDsl$bean$$inlined$bean$7.class */
public final class BeanDefinitionDsl$bean$$inlined$bean$7<T> implements Supplier {
    final /* synthetic */ BeanDefinitionDsl this$0;
    final /* synthetic */ Function6 $f$inlined;

    public BeanDefinitionDsl$bean$$inlined$bean$7(BeanDefinitionDsl $receiver, Function6 function6) {
        this.this$0 = $receiver;
        this.$f$inlined = function6;
    }
    ...
    public final T get() {
        ...
        Function6 function6 = this.$f$inlined;
        ...
        return (T) function6.invoke(bean, bean2, bean3, bean4, bean5, bean6);
    }
}
