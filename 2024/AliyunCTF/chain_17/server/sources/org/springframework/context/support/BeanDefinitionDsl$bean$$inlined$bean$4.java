...
/* loaded from: server.jar:BOOT-INF/lib/spring-context-6.1.3.jar:org/springframework/context/support/BeanDefinitionDsl$bean$$inlined$bean$4.class */
public final class BeanDefinitionDsl$bean$$inlined$bean$4<T> implements Supplier {
    final /* synthetic */ BeanDefinitionDsl this$0;
    final /* synthetic */ Function3 $f$inlined;

    public BeanDefinitionDsl$bean$$inlined$bean$4(BeanDefinitionDsl $receiver, Function3 function3) {
    ...
    public final T get() {
        ...
        return (T) function3.invoke(bean, bean2, bean3);
    }
}
