...
/* loaded from: server.jar:BOOT-INF/lib/spring-context-6.1.3.jar:org/springframework/context/support/BeanDefinitionDsl$bean$$inlined$bean$16.class */
public final class BeanDefinitionDsl$bean$$inlined$bean$16<T> implements Supplier {
    final /* synthetic */ BeanDefinitionDsl this$0;
    final /* synthetic */ Function15 $f$inlined;

    public BeanDefinitionDsl$bean$$inlined$bean$16(BeanDefinitionDsl $receiver, Function15 function15) {
        this.this$0 = $receiver;
        this.$f$inlined = function15;
    }
    ...
    public final T get() {
        ...
        Function15 function15 = this.$f$inlined;
        ...
        return (T) function15.invoke(bean, bean2, bean3, bean4, bean5, bean6, bean7, bean8, bean9, bean10, bean11, bean12, bean13, bean14, bean15);
    }
}
