...
/* loaded from: server.jar:BOOT-INF/lib/spring-context-6.1.3.jar:org/springframework/context/support/BeanDefinitionDsl$bean$$inlined$bean$3.class */
public final class BeanDefinitionDsl$bean$$inlined$bean$3<T> implements Supplier {
    final /* synthetic */ BeanDefinitionDsl this$0;
    final /* synthetic */ Function2 $f$inlined;

    public BeanDefinitionDsl$bean$$inlined$bean$3(BeanDefinitionDsl $receiver, Function2 function2) {
    ...
    public final T get() {
        ...
        return (T) function2.invoke(bean, bean2);
    }
}
