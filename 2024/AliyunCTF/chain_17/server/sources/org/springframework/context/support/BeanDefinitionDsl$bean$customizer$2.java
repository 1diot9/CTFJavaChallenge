...
/* loaded from: server.jar:BOOT-INF/lib/spring-context-6.1.3.jar:org/springframework/context/support/BeanDefinitionDsl$bean$customizer$2.class */
public final class BeanDefinitionDsl$bean$customizer$2 implements BeanDefinitionCustomizer {
    ...
    public BeanDefinitionDsl$bean$customizer$2(BeanDefinitionDsl.Scope $scope, Boolean $isLazyInit, Boolean $isPrimary, Boolean $isAutowireCandidate, String $initMethodName, String $destroyMethodName, String $description, BeanDefinitionDsl.Role $role, Integer $order) {
        this.$scope = $scope;
