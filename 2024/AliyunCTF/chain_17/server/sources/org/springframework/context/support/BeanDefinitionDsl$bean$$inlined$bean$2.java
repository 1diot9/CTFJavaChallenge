...
/* loaded from: server.jar:BOOT-INF/lib/spring-context-6.1.3.jar:org/springframework/context/support/BeanDefinitionDsl$bean$$inlined$bean$2.class */
public final class BeanDefinitionDsl$bean$$inlined$bean$2<T> implements Supplier {
    final /* synthetic */ BeanDefinitionDsl this$0;
    final /* synthetic */ Function1 $f$inlined;

    public BeanDefinitionDsl$bean$$inlined$bean$2(BeanDefinitionDsl $receiver, Function1 function1) {
    ...
    public final T get() {
        ...
        Function1 function1 = this.$f$inlined;
        ...
        return (T) function1.invoke(bean);
    }
}
