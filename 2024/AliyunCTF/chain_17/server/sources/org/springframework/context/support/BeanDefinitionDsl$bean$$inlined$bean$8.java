...
/* loaded from: server.jar:BOOT-INF/lib/spring-context-6.1.3.jar:org/springframework/context/support/BeanDefinitionDsl$bean$$inlined$bean$8.class */
public final class BeanDefinitionDsl$bean$$inlined$bean$8<T> implements Supplier {
    final /* synthetic */ BeanDefinitionDsl this$0;
    final /* synthetic */ Function7 $f$inlined;

    public BeanDefinitionDsl$bean$$inlined$bean$8(BeanDefinitionDsl $receiver, Function7 function7) {
        this.this$0 = $receiver;
        this.$f$inlined = function7;
    }
    ...
    public final T get() {
        ...
        Function7 function7 = this.$f$inlined;
        ...
        return (T) function7.invoke(bean, bean2, bean3, bean4, bean5, bean6, bean7);
    }
}
