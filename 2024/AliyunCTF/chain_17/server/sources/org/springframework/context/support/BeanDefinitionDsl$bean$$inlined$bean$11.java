...
/* loaded from: server.jar:BOOT-INF/lib/spring-context-6.1.3.jar:org/springframework/context/support/BeanDefinitionDsl$bean$$inlined$bean$11.class */
public final class BeanDefinitionDsl$bean$$inlined$bean$11<T> implements Supplier {
    final /* synthetic */ BeanDefinitionDsl this$0;
    final /* synthetic */ Function10 $f$inlined;

    public BeanDefinitionDsl$bean$$inlined$bean$11(BeanDefinitionDsl $receiver, Function10 function10) {
    ...
    public final T get() {
        ...
        return (T) function10.invoke(bean, bean2, bean3, bean4, bean5, bean6, bean7, bean8, bean9, bean10);
    }
}
