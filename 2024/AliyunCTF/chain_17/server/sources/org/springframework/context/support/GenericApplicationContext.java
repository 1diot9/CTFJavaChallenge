...
/* loaded from: server.jar:BOOT-INF/lib/spring-context-6.1.3.jar:org/springframework/context/support/GenericApplicationContext.class */
public class GenericApplicationContext extends AbstractApplicationContext implements BeanDefinitionRegistry {
    ...
    public void refreshForAotProcessing(RuntimeHints runtimeHints) {
        if (this.logger.isDebugEnabled()) {
            this.logger.debug("Preparing bean factory for AOT processing");
        }
        prepareRefresh();
    ...
    /* loaded from: server.jar:BOOT-INF/lib/spring-context-6.1.3.jar:org/springframework/context/support/GenericApplicationContext$ClassDerivedBeanDefinition.class */
