...
/* loaded from: server.jar:BOOT-INF/lib/spring-context-6.1.3.jar:org/springframework/context/support/BeanDefinitionDsl$bean$$inlined$bean$5.class */
public final class BeanDefinitionDsl$bean$$inlined$bean$5<T> implements Supplier {
    final /* synthetic */ BeanDefinitionDsl this$0;
    final /* synthetic */ Function4 $f$inlined;

    public BeanDefinitionDsl$bean$$inlined$bean$5(BeanDefinitionDsl $receiver, Function4 function4) {
        this.this$0 = $receiver;
        this.$f$inlined = function4;
    }
    ...
    public final T get() {
        ...
        Function4 function4 = this.$f$inlined;
        ...
        return (T) function4.invoke(bean, bean2, bean3, bean4);
    }
}
