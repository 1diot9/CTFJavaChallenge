...
/* loaded from: server.jar:BOOT-INF/lib/spring-context-6.1.3.jar:org/springframework/context/annotation/ComponentScanBeanDefinitionParser.class */
    ...
    protected void parseScope(Element element, ClassPathBeanDefinitionScanner scanner) {
        ...
        if (element.hasAttribute(SCOPED_PROXY_ATTRIBUTE)) {
            ...
            switch (mode.hashCode()) {
                case -2110678425:
                    if (mode.equals("targetClass")) {
                        z = false;
                        break;
                    }
                    break;
                case -1598539174:
                    if (mode.equals("interfaces")) {
                        z = true;
                        break;
                    }
                    break;
    ...
    protected TypeFilter createTypeFilter(Element element, @Nullable ClassLoader classLoader, ParserContext parserContext) throws ClassNotFoundException {
        ...
        switch (filterType.hashCode()) {
            ...
            case 108392519:
                ...
                break;
            case 1025902281:
                if (filterType.equals("assignable")) {
                    z = true;
                    break;
                }
                break;
