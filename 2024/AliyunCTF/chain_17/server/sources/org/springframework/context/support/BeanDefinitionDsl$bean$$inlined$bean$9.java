...
/* loaded from: server.jar:BOOT-INF/lib/spring-context-6.1.3.jar:org/springframework/context/support/BeanDefinitionDsl$bean$$inlined$bean$9.class */
public final class BeanDefinitionDsl$bean$$inlined$bean$9<T> implements Supplier {
    final /* synthetic */ BeanDefinitionDsl this$0;
    final /* synthetic */ Function8 $f$inlined;

    public BeanDefinitionDsl$bean$$inlined$bean$9(BeanDefinitionDsl $receiver, Function8 function8) {
    ...
    public final T get() {
        ...
        Function8 function8 = this.$f$inlined;
        ...
        return (T) function8.invoke(bean, bean2, bean3, bean4, bean5, bean6, bean7, bean8);
    }
}
