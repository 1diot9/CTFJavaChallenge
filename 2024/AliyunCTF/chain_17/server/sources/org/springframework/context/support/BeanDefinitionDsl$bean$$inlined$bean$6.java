...
/* loaded from: server.jar:BOOT-INF/lib/spring-context-6.1.3.jar:org/springframework/context/support/BeanDefinitionDsl$bean$$inlined$bean$6.class */
public final class BeanDefinitionDsl$bean$$inlined$bean$6<T> implements Supplier {
    final /* synthetic */ BeanDefinitionDsl this$0;
    final /* synthetic */ Function5 $f$inlined;

    public BeanDefinitionDsl$bean$$inlined$bean$6(BeanDefinitionDsl $receiver, Function5 function5) {
    ...
    public final T get() {
        ...
        Function5 function5 = this.$f$inlined;
        ...
        return (T) function5.invoke(bean, bean2, bean3, bean4, bean5);
    }
}
