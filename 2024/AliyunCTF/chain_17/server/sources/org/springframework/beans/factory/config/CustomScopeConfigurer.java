...
/* loaded from: server.jar:BOOT-INF/lib/spring-beans-6.1.3.jar:org/springframework/beans/factory/config/CustomScopeConfigurer.class */
            ...
            this.scopes.forEach((scopeKey, value) -> {
                ...
                if (value instanceof Class) {
                    ...
                    if (value instanceof String) {
                        String scopeClassName = (String) value;
                        Class<?> scopeClass2 = ClassUtils.resolveClassName(scopeClassName, this.beanClassLoader);
