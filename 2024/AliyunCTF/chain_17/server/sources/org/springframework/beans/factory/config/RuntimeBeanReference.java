...
/* loaded from: server.jar:BOOT-INF/lib/spring-beans-6.1.3.jar:org/springframework/beans/factory/config/RuntimeBeanReference.class */
    ...
    public boolean equals(@Nullable Object other) {
        if (this != other) {
            if (other instanceof RuntimeBeanReference) {
                ...
                if (!this.beanName.equals(that.beanName) || this.beanType != that.beanType || this.toParent != that.toParent) {
                }
            }
            return false;
        }
