...
/* loaded from: server.jar:BOOT-INF/lib/spring-beans-6.1.3.jar:org/springframework/beans/factory/annotation/InjectionMetadata.class */
public class InjectionMetadata {
    ...
    public Collection<InjectedElement> getInjectedElements(@Nullable PropertyValues pvs) {
        return this.injectedElements.stream().filter(candidate -> {
            return candidate.shouldInject(pvs);
        }).toList();
    }
    ...
    /* loaded from: server.jar:BOOT-INF/lib/spring-beans-6.1.3.jar:org/springframework/beans/factory/annotation/InjectionMetadata$InjectedElement.class */
    public static abstract class InjectedElement {
        ...
        /* JADX INFO: Access modifiers changed from: protected */
        public boolean shouldInject(@Nullable PropertyValues pvs) {
        ...
        public boolean equals(@Nullable Object other) {
            if (this != other) {
                if (other instanceof InjectedElement) {
                    InjectedElement that = (InjectedElement) other;
