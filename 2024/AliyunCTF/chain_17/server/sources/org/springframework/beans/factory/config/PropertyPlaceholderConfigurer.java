...
@Deprecated
/* loaded from: server.jar:BOOT-INF/lib/spring-beans-6.1.3.jar:org/springframework/beans/factory/config/PropertyPlaceholderConfigurer.class */
public class PropertyPlaceholderConfigurer extends PlaceholderConfigurerSupport {
    public static final int SYSTEM_PROPERTIES_MODE_NEVER = 0;
    public static final int SYSTEM_PROPERTIES_MODE_FALLBACK = 1;
    public static final int SYSTEM_PROPERTIES_MODE_OVERRIDE = 2;
    private static final Map<String, Integer> constants = Map.of("SYSTEM_PROPERTIES_MODE_NEVER", 0, "SYSTEM_PROPERTIES_MODE_FALLBACK", 1, "SYSTEM_PROPERTIES_MODE_OVERRIDE", 2);
    ...
    public void setSystemPropertiesModeName(String constantName) throws IllegalArgumentException {
        ...
        this.systemPropertiesMode = mode.intValue();
    }
    ...
    /* loaded from: server.jar:BOOT-INF/lib/spring-beans-6.1.3.jar:org/springframework/beans/factory/config/PropertyPlaceholderConfigurer$PlaceholderResolvingStringValueResolver.class */
    ...
    /* loaded from: server.jar:BOOT-INF/lib/spring-beans-6.1.3.jar:org/springframework/beans/factory/config/PropertyPlaceholderConfigurer$PropertyPlaceholderConfigurerResolver.class */
