...
/* loaded from: server.jar:BOOT-INF/lib/spring-beans-6.1.3.jar:org/springframework/beans/MutablePropertyValues.class */
    ...
    public boolean equals(@Nullable Object other) {
        if (this != other) {
            if (other instanceof MutablePropertyValues) {
                ...
                if (this.propertyValueList.equals(that.propertyValueList)) {
                }
            }
            return false;
        }
