...
/* loaded from: server.jar:BOOT-INF/lib/spring-beans-6.1.3.jar:org/springframework/beans/factory/groovy/GroovyBeanDefinitionReader.class */
public class GroovyBeanDefinitionReader extends AbstractBeanDefinitionReader implements GroovyObject {
        ...
        try {
            ...
            if (!ObjectUtils.isEmpty(args)) {
                ...
                if (lastArg instanceof Closure) {
                    Closure<?> closure = (Closure) lastArg;
                    callable = closure;
                    index--;
                }
    ...
    public Object invokeMethod(String name, Object arg) {
        ...
        if (DefaultBeanDefinitionDocumentReader.NESTED_BEANS_ELEMENT.equals(name) && args.length == 1) {
            Object obj = args[0];
        ...
        if (obj instanceof Class) {
            ...
            if (obj2 instanceof RuntimeBeanReference) {
                ...
                if (obj3 instanceof Map) {
                    Map<?, ?> namedArgs = (Map) obj3;
                    if (args.length > 1) {
                        Object obj4 = args[1];
                        if (obj4 instanceof Class) {
                            Class<?> clazz = (Class) obj4;
    ...
    /* loaded from: server.jar:BOOT-INF/lib/spring-beans-6.1.3.jar:org/springframework/beans/factory/groovy/GroovyBeanDefinitionReader$DeferredProperty.class */
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* loaded from: server.jar:BOOT-INF/lib/spring-beans-6.1.3.jar:org/springframework/beans/factory/groovy/GroovyBeanDefinitionReader$GroovyRuntimeBeanReference.class */
    public class GroovyRuntimeBeanReference extends RuntimeBeanReference implements GroovyObject {
        ...
        /* loaded from: server.jar:BOOT-INF/lib/spring-beans-6.1.3.jar:org/springframework/beans/factory/groovy/GroovyBeanDefinitionReader$GroovyRuntimeBeanReference$GroovyPropertyValue.class */
