...
/* loaded from: server.jar:BOOT-INF/lib/spring-beans-6.1.3.jar:org/springframework/beans/factory/config/PropertyPathFactoryBean.class */
        ...
        if (target != null) {
            if (logger.isWarnEnabled() && this.targetBeanName != null) {
                ...
                if (beanFactory instanceof ConfigurableBeanFactory) {
                    ...
                    if (cbf.isCurrentlyInCreation(this.targetBeanName)) {
