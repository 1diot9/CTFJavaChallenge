...
/* loaded from: server.jar:BOOT-INF/lib/spring-beans-6.1.3.jar:org/springframework/beans/factory/xml/UtilNamespaceHandler.class */
public class UtilNamespaceHandler extends NamespaceHandlerSupport {
    ...
    public void init() {
        ...
        registerBeanDefinitionParser(JsonEncoder.CONTEXT_PROPERTIES_ATTR_NAME, new PropertiesBeanDefinitionParser());
    }

    /* loaded from: server.jar:BOOT-INF/lib/spring-beans-6.1.3.jar:org/springframework/beans/factory/xml/UtilNamespaceHandler$ConstantBeanDefinitionParser.class */
    ...
    /* loaded from: server.jar:BOOT-INF/lib/spring-beans-6.1.3.jar:org/springframework/beans/factory/xml/UtilNamespaceHandler$PropertyPathBeanDefinitionParser.class */
    ...
    /* loaded from: server.jar:BOOT-INF/lib/spring-beans-6.1.3.jar:org/springframework/beans/factory/xml/UtilNamespaceHandler$ListBeanDefinitionParser.class */
    ...
    /* loaded from: server.jar:BOOT-INF/lib/spring-beans-6.1.3.jar:org/springframework/beans/factory/xml/UtilNamespaceHandler$SetBeanDefinitionParser.class */
    ...
    /* loaded from: server.jar:BOOT-INF/lib/spring-beans-6.1.3.jar:org/springframework/beans/factory/xml/UtilNamespaceHandler$MapBeanDefinitionParser.class */
    ...
    /* loaded from: server.jar:BOOT-INF/lib/spring-beans-6.1.3.jar:org/springframework/beans/factory/xml/UtilNamespaceHandler$PropertiesBeanDefinitionParser.class */
    private static class PropertiesBeanDefinitionParser extends AbstractSingleBeanDefinitionParser {
        ...
        protected void doParse(Element element, ParserContext parserContext, BeanDefinitionBuilder builder) {
            ...
            builder.addPropertyValue(JsonEncoder.CONTEXT_PROPERTIES_ATTR_NAME, parsedProps);
