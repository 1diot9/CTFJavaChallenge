...
/* loaded from: server.jar:BOOT-INF/lib/spring-boot-3.2.2.jar:org/springframework/boot/logging/java/SimpleFormatter.class */
public class SimpleFormatter extends Formatter {
    ...
    public String format(LogRecord record) {
        ...
        return String.format(this.format, date, source, record.getLoggerName(), record.getLevel().getLocalizedName(), message, throwable, thread, this.pid);
    }
