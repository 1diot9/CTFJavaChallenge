...
/* loaded from: server.jar:BOOT-INF/lib/spring-boot-3.2.2.jar:org/springframework/boot/BootstrapRegistry.class */
public interface BootstrapRegistry {

    /* loaded from: server.jar:BOOT-INF/lib/spring-boot-3.2.2.jar:org/springframework/boot/BootstrapRegistry$Scope.class */
    public enum Scope {
        SINGLETON,
        PROTOTYPE
    }
    ...
    @FunctionalInterface
    /* loaded from: server.jar:BOOT-INF/lib/spring-boot-3.2.2.jar:org/springframework/boot/BootstrapRegistry$InstanceSupplier.class */
