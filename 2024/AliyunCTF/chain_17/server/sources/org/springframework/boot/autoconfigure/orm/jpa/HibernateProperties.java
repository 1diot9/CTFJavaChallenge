...
/* loaded from: server.jar:BOOT-INF/lib/spring-boot-autoconfigure-3.2.2.jar:org/springframework/boot/autoconfigure/orm/jpa/HibernateProperties.class */
public class HibernateProperties {
    ...
    private String determineDdlAuto(Map<String, String> existing, Supplier<String> defaultDdlAuto) {
        ...
        if (existing.get("jakarta.persistence.schema-generation.database.action") != null) {
            return null;
        }
        return defaultDdlAuto.get();
    }

    /* loaded from: server.jar:BOOT-INF/lib/spring-boot-autoconfigure-3.2.2.jar:org/springframework/boot/autoconfigure/orm/jpa/HibernateProperties$Naming.class */
