...
/* loaded from: server.jar:BOOT-INF/lib/spring-boot-3.2.2.jar:org/springframework/boot/web/embedded/tomcat/TomcatEmbeddedWebappClassLoader.class */
public class TomcatEmbeddedWebappClassLoader extends ParallelWebappClassLoader {
    ...
    public Class<?> loadClass(String name, boolean resolve) throws ClassNotFoundException {
        ...
        synchronized (classLoadingLock) {
            ...
            Class<?> resolveIfNecessary = resolveIfNecessary(result2, resolve);
