...
/* loaded from: server.jar:BOOT-INF/lib/spring-boot-autoconfigure-3.2.2.jar:org/springframework/boot/autoconfigure/reactor/ReactorProperties.class */
public class ReactorProperties {
    private ContextPropagationMode contextPropagation = ContextPropagationMode.LIMITED;

    /* loaded from: server.jar:BOOT-INF/lib/spring-boot-autoconfigure-3.2.2.jar:org/springframework/boot/autoconfigure/reactor/ReactorProperties$ContextPropagationMode.class */
