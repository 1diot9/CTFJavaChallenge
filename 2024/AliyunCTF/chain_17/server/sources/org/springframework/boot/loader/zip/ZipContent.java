...
/* loaded from: server.jar:org/springframework/boot/loader/zip/ZipContent.class */
public final class ZipContent implements Closeable {
    ...
    /* loaded from: server.jar:org/springframework/boot/loader/zip/ZipContent$Kind.class */
    public enum Kind {
        ZIP,
        NESTED_ZIP,
        NESTED_DIRECTORY
    ...
    /* loaded from: server.jar:org/springframework/boot/loader/zip/ZipContent$Source.class */
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* loaded from: server.jar:org/springframework/boot/loader/zip/ZipContent$Loader.class */
    ...
    /* loaded from: server.jar:org/springframework/boot/loader/zip/ZipContent$Entry.class */
    public class Entry {
