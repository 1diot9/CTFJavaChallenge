...
/* loaded from: server.jar:org/springframework/boot/loader/launch/Archive.class */
public interface Archive extends AutoCloseable {
    public static final Predicate<Entry> ALL_ENTRIES = entry -> {
        return true;
    };

    /* loaded from: server.jar:org/springframework/boot/loader/launch/Archive$Entry.class */
