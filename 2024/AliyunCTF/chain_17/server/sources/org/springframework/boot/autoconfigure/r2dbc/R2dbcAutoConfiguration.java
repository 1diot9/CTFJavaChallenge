...
/* loaded from: server.jar:BOOT-INF/lib/spring-boot-autoconfigure-3.2.2.jar:org/springframework/boot/autoconfigure/r2dbc/R2dbcAutoConfiguration.class */
public class R2dbcAutoConfiguration {
    ...
    /* loaded from: server.jar:BOOT-INF/lib/spring-boot-autoconfigure-3.2.2.jar:org/springframework/boot/autoconfigure/r2dbc/R2dbcAutoConfiguration$PropertiesR2dbcConnectionDetails.class */
    static class PropertiesR2dbcConnectionDetails implements R2dbcConnectionDetails {
        ...
        public ConnectionFactoryOptions getConnectionFactoryOptions() {
            ...
            Option<String> option = ConnectionFactoryOptions.USER;
            ...
            Option<CharSequence> option2 = ConnectionFactoryOptions.PASSWORD;
