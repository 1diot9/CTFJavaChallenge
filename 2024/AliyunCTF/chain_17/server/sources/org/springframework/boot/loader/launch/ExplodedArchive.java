...
/* loaded from: server.jar:org/springframework/boot/loader/launch/ExplodedArchive.class */
class ExplodedArchive implements Archive {
    private static final Object NO_MANIFEST = new Object();
    private static final Set<String> SKIPPED_NAMES = Set.of(".", CallerDataConverter.DEFAULT_RANGE_DELIMITER);
    ...
    /* loaded from: server.jar:org/springframework/boot/loader/launch/ExplodedArchive$FileArchiveEntry.class */
