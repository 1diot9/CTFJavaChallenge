...
/* loaded from: server.jar:org/springframework/boot/loader/net/protocol/jar/Handler.class */
public class Handler extends URLStreamHandler {
    ...
    protected void parseURL(URL url, String spec, int start, int limit) {
        if (spec.regionMatches(true, start, ResourceUtils.JAR_URL_PREFIX, 0, 4)) {
    ...
    private String extractPath(URL url, String spec, int start, int limit, int anchorIndex) {
        ...
        if (spec.length() >= 4 && spec.regionMatches(true, 0, ResourceUtils.JAR_URL_PREFIX, 0, 4)) {
