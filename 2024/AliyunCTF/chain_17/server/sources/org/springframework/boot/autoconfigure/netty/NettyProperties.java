...
/* loaded from: server.jar:BOOT-INF/lib/spring-boot-autoconfigure-3.2.2.jar:org/springframework/boot/autoconfigure/netty/NettyProperties.class */
public class NettyProperties {
    private LeakDetection leakDetection;

    /* loaded from: server.jar:BOOT-INF/lib/spring-boot-autoconfigure-3.2.2.jar:org/springframework/boot/autoconfigure/netty/NettyProperties$LeakDetection.class */
