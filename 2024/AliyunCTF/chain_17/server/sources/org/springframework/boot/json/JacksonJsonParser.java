...
/* loaded from: server.jar:BOOT-INF/lib/spring-boot-3.2.2.jar:org/springframework/boot/json/JacksonJsonParser.class */
public class JacksonJsonParser extends AbstractJsonParser {
    ...
    /* loaded from: server.jar:BOOT-INF/lib/spring-boot-3.2.2.jar:org/springframework/boot/json/JacksonJsonParser$MapTypeReference.class */
    private static final class MapTypeReference extends TypeReference<Map<String, Object>> {
        private MapTypeReference() {
        }
    }

    /* loaded from: server.jar:BOOT-INF/lib/spring-boot-3.2.2.jar:org/springframework/boot/json/JacksonJsonParser$ListTypeReference.class */
