...
/* loaded from: server.jar:BOOT-INF/lib/spring-boot-3.2.2.jar:org/springframework/boot/convert/PeriodStyle.class */
public enum PeriodStyle {
    ...
    /* loaded from: server.jar:BOOT-INF/lib/spring-boot-3.2.2.jar:org/springframework/boot/convert/PeriodStyle$Unit.class */
    public enum Unit {
