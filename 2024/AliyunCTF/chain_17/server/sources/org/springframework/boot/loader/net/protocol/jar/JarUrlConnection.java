...
/* loaded from: server.jar:org/springframework/boot/loader/net/protocol/jar/JarUrlConnection.class */
public final class JarUrlConnection extends JarURLConnection {
    ...
    static {
        try {
            NOT_FOUND_URL = new URL(ResourceUtils.JAR_URL_PREFIX, null, 0, "nested:!/", new EmptyUrlStreamHandler());
    ...
    public static JarUrlConnection open(URL url) throws IOException {
        ...
        if (spec.startsWith("nested:")) {
            int separator = spec.indexOf(ResourceUtils.JAR_URL_SEPARATOR);
    ...
    /* loaded from: server.jar:org/springframework/boot/loader/net/protocol/jar/JarUrlConnection$ConnectionInputStream.class */
    ...
    /* loaded from: server.jar:org/springframework/boot/loader/net/protocol/jar/JarUrlConnection$EmptyUrlStreamHandler.class */
