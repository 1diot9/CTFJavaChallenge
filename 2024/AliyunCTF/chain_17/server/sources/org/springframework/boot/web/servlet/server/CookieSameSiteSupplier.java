...
@FunctionalInterface
/* loaded from: server.jar:BOOT-INF/lib/spring-boot-3.2.2.jar:org/springframework/boot/web/servlet/server/CookieSameSiteSupplier.class */
public interface CookieSameSiteSupplier {
    ...
    default CookieSameSiteSupplier when(Predicate<jakarta.servlet.http.Cookie> predicate) {
