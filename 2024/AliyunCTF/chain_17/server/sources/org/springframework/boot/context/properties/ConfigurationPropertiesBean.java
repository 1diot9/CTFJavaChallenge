...
/* loaded from: server.jar:BOOT-INF/lib/spring-boot-3.2.2.jar:org/springframework/boot/context/properties/ConfigurationPropertiesBean.class */
public final class ConfigurationPropertiesBean {
    ...
    @Deprecated(since = "3.0.8", forRemoval = true)
    /* loaded from: server.jar:BOOT-INF/lib/spring-boot-3.2.2.jar:org/springframework/boot/context/properties/ConfigurationPropertiesBean$BindMethod.class */
