...
/* loaded from: server.jar:BOOT-INF/lib/spring-boot-autoconfigure-3.2.2.jar:org/springframework/boot/autoconfigure/thymeleaf/ThymeleafAutoConfiguration.class */
public class ThymeleafAutoConfiguration {

    @ConditionalOnMissingBean(name = {"defaultTemplateResolver"})
    @Configuration(proxyBeanMethods = false)
    /* loaded from: server.jar:BOOT-INF/lib/spring-boot-autoconfigure-3.2.2.jar:org/springframework/boot/autoconfigure/thymeleaf/ThymeleafAutoConfiguration$DefaultTemplateResolverConfiguration.class */
    ...
    /* loaded from: server.jar:BOOT-INF/lib/spring-boot-autoconfigure-3.2.2.jar:org/springframework/boot/autoconfigure/thymeleaf/ThymeleafAutoConfiguration$ThymeleafWebMvcConfiguration.class */
    static class ThymeleafWebMvcConfiguration {
        ...
        @Configuration(proxyBeanMethods = false)
        /* loaded from: server.jar:BOOT-INF/lib/spring-boot-autoconfigure-3.2.2.jar:org/springframework/boot/autoconfigure/thymeleaf/ThymeleafAutoConfiguration$ThymeleafWebMvcConfiguration$ThymeleafViewResolverConfiguration.class */
    ...
    /* loaded from: server.jar:BOOT-INF/lib/spring-boot-autoconfigure-3.2.2.jar:org/springframework/boot/autoconfigure/thymeleaf/ThymeleafAutoConfiguration$ThymeleafWebFluxConfiguration.class */
    static class ThymeleafWebFluxConfiguration {
        ...
        private void mapProperties(ThymeleafProperties properties, ThymeleafReactiveViewResolver resolver) {
            ...
            PropertyMapper.Source from = map.from(properties::getEncoding);
            Objects.requireNonNull(resolver);
            from.to(resolver::setDefaultCharset);
            resolver.setExcludedViewNames(properties.getExcludedViewNames());
            resolver.setViewNames(properties.getViewNames());
        }
        ...
        private void mapReactiveProperties(ThymeleafProperties.Reactive properties, ThymeleafReactiveViewResolver resolver) {
            PropertyMapper map = PropertyMapper.get();
            Objects.requireNonNull(properties);
            PropertyMapper.Source whenNonNull = map.from(properties::getMediaTypes).whenNonNull();
            Objects.requireNonNull(resolver);
            whenNonNull.to(resolver::setSupportedMediaTypes);
            Objects.requireNonNull(properties);
            PropertyMapper.Source<Integer> when = map.from(properties::getMaxChunkSize).asInt((v0) -> {
                return v0.toBytes();
            }).when(size -> {
            ...
            Objects.requireNonNull(properties);
            PropertyMapper.Source from = map.from(properties::getFullModeViewNames);
            Objects.requireNonNull(resolver);
            from.to(resolver::setFullModeViewNames);
            Objects.requireNonNull(properties);
            PropertyMapper.Source from2 = map.from(properties::getChunkedModeViewNames);
            Objects.requireNonNull(resolver);
            from2.to(resolver::setChunkedModeViewNames);
        }
    }

    @Configuration(proxyBeanMethods = false)
    @ConditionalOnClass({LayoutDialect.class})
    /* loaded from: server.jar:BOOT-INF/lib/spring-boot-autoconfigure-3.2.2.jar:org/springframework/boot/autoconfigure/thymeleaf/ThymeleafAutoConfiguration$ThymeleafWebLayoutConfiguration.class */
    ...
    /* loaded from: server.jar:BOOT-INF/lib/spring-boot-autoconfigure-3.2.2.jar:org/springframework/boot/autoconfigure/thymeleaf/ThymeleafAutoConfiguration$DataAttributeDialectConfiguration.class */
    ...
    /* loaded from: server.jar:BOOT-INF/lib/spring-boot-autoconfigure-3.2.2.jar:org/springframework/boot/autoconfigure/thymeleaf/ThymeleafAutoConfiguration$ThymeleafSecurityDialectConfiguration.class */
