...
/* loaded from: server.jar:BOOT-INF/lib/spring-boot-3.2.2.jar:org/springframework/boot/ansi/AnsiOutput.class */
public abstract class AnsiOutput {
    ...
    /* loaded from: server.jar:BOOT-INF/lib/spring-boot-3.2.2.jar:org/springframework/boot/ansi/AnsiOutput$Enabled.class */
    public enum Enabled {
        DETECT,
        ALWAYS,
        NEVER
