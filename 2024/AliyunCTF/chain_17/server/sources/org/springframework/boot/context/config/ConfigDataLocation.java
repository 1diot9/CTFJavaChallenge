...
/* loaded from: server.jar:BOOT-INF/lib/spring-boot-3.2.2.jar:org/springframework/boot/context/config/ConfigDataLocation.class */
public final class ConfigDataLocation implements OriginProvider {
    ...
    public String toString() {
        return !this.optional ? this.value : "optional:" + this.value;
    }
