...
/* loaded from: server.jar:BOOT-INF/lib/spring-web-6.1.3.jar:org/springframework/http/server/ServletServerHttpResponse.class */
public class ServletServerHttpResponse implements ServerHttpResponse {
    ...
    /* loaded from: server.jar:BOOT-INF/lib/spring-web-6.1.3.jar:org/springframework/http/server/ServletServerHttpResponse$ServletResponseHttpHeaders.class */
    private class ServletResponseHttpHeaders extends HttpHeaders {
        ...
        public String getFirst(String headerName) {
            ...
            String value2 = ServletServerHttpResponse.this.servletResponse.getHeader(headerName);
            return value2 != null ? value2 : super.getFirst(headerName);
        }
