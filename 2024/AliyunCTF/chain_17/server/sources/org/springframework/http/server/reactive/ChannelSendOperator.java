...
/* loaded from: server.jar:BOOT-INF/lib/spring-web-6.1.3.jar:org/springframework/http/server/reactive/ChannelSendOperator.class */
public class ChannelSendOperator<T> extends Mono<Void> implements Scannable {
    ...
    /* loaded from: server.jar:BOOT-INF/lib/spring-web-6.1.3.jar:org/springframework/http/server/reactive/ChannelSendOperator$State.class */
    private enum State {
        NEW,
    ...
    /* loaded from: server.jar:BOOT-INF/lib/spring-web-6.1.3.jar:org/springframework/http/server/reactive/ChannelSendOperator$WriteBarrier.class */
        ...
        public final void onNext(T item) {
            ...
            synchronized (this) {
                if (this.state == State.READY_TO_WRITE) {
                    ...
                    try {
                        Publisher<Void> result = ChannelSendOperator.this.writeFunction.apply(this);
        ...
        private void releaseCachedItem() {
            synchronized (this) {
                ...
                if (item instanceof DataBuffer) {
                    DataBuffer dataBuffer = (DataBuffer) item;
    ...
    /* loaded from: server.jar:BOOT-INF/lib/spring-web-6.1.3.jar:org/springframework/http/server/reactive/ChannelSendOperator$WriteCompletionBarrier.class */
