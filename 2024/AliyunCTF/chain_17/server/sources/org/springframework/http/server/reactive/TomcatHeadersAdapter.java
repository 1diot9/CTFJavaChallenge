...
/* loaded from: server.jar:BOOT-INF/lib/spring-web-6.1.3.jar:org/springframework/http/server/reactive/TomcatHeadersAdapter.class */
public class TomcatHeadersAdapter implements MultiValueMap<String, String> {
    ...
    /* loaded from: server.jar:BOOT-INF/lib/spring-web-6.1.3.jar:org/springframework/http/server/reactive/TomcatHeadersAdapter$EntryIterator.class */
    ...
    /* loaded from: server.jar:BOOT-INF/lib/spring-web-6.1.3.jar:org/springframework/http/server/reactive/TomcatHeadersAdapter$HeaderEntry.class */
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* loaded from: server.jar:BOOT-INF/lib/spring-web-6.1.3.jar:org/springframework/http/server/reactive/TomcatHeadersAdapter$HeaderNames.class */
    public class HeaderNames extends AbstractSet<String> {
        private HeaderNames() {
        }
    ...
    /* loaded from: server.jar:BOOT-INF/lib/spring-web-6.1.3.jar:org/springframework/http/server/reactive/TomcatHeadersAdapter$HeaderNamesIterator.class */
