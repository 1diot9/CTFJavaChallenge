...
/* loaded from: server.jar:BOOT-INF/lib/spring-web-6.1.3.jar:org/springframework/http/codec/KotlinSerializationStringEncoder.class */
public abstract class KotlinSerializationStringEncoder<T extends StringFormat> extends KotlinSerializationSupport<T> implements Encoder<Object> {
    private final CharSequenceEncoder charSequenceEncoder;

    /* JADX INFO: Access modifiers changed from: protected */
    public KotlinSerializationStringEncoder(T format, MimeType... supportedMimeTypes) {
    ...
    public DataBuffer encodeValue(Object value, DataBufferFactory bufferFactory, ResolvableType valueType, @Nullable MimeType mimeType, @Nullable Map<String, Object> hints) {
        ...
        String string = ((StringFormat) format()).encodeToString(serializer, value);
        return this.charSequenceEncoder.encodeValue((CharSequence) string, bufferFactory, valueType, mimeType, (Map<String, Object>) null);
    }
}
