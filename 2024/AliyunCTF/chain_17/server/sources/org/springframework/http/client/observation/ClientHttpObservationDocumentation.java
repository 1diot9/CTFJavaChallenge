...
/* loaded from: server.jar:BOOT-INF/lib/spring-web-6.1.3.jar:org/springframework/http/client/observation/ClientHttpObservationDocumentation.class */
public enum ClientHttpObservationDocumentation implements ObservationDocumentation {
    ...
    /* loaded from: server.jar:BOOT-INF/lib/spring-web-6.1.3.jar:org/springframework/http/client/observation/ClientHttpObservationDocumentation$HighCardinalityKeyNames.class */
    ...
    /* loaded from: server.jar:BOOT-INF/lib/spring-web-6.1.3.jar:org/springframework/http/client/observation/ClientHttpObservationDocumentation$LowCardinalityKeyNames.class */
