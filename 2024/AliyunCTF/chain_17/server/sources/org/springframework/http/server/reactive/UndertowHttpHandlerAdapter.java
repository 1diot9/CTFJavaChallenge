...
/* loaded from: server.jar:BOOT-INF/lib/spring-web-6.1.3.jar:org/springframework/http/server/reactive/UndertowHttpHandlerAdapter.class */
public class UndertowHttpHandlerAdapter implements io.undertow.server.HttpHandler {
    ...
    /* loaded from: server.jar:BOOT-INF/lib/spring-web-6.1.3.jar:org/springframework/http/server/reactive/UndertowHttpHandlerAdapter$HandlerResultSubscriber.class */
