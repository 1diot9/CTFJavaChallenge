...
/* loaded from: server.jar:BOOT-INF/lib/spring-web-6.1.3.jar:org/springframework/http/HttpStatus.class */
public enum HttpStatus implements HttpStatusCode {
    ...
    PROCESSING(Opcodes.FSUB, Series.INFORMATIONAL, "Processing"),
    EARLY_HINTS(Opcodes.DSUB, Series.INFORMATIONAL, "Early Hints"),
    CHECKPOINT(Opcodes.DSUB, Series.INFORMATIONAL, "Checkpoint"),
    ...
    TOO_MANY_REQUESTS(RateLimitFilter.DEFAULT_STATUS_CODE, Series.CLIENT_ERROR, "Too Many Requests"),
    ...
    /* loaded from: server.jar:BOOT-INF/lib/spring-web-6.1.3.jar:org/springframework/http/HttpStatus$Series.class */
    public enum Series {
        INFORMATIONAL(1),
        SUCCESSFUL(2),
        REDIRECTION(3),
