...
/* loaded from: server.jar:BOOT-INF/lib/spring-web-6.1.3.jar:org/springframework/http/server/reactive/DefaultServerHttpRequestBuilder.class */
public class DefaultServerHttpRequestBuilder implements ServerHttpRequest.Builder {
    ...
    /* loaded from: server.jar:BOOT-INF/lib/spring-web-6.1.3.jar:org/springframework/http/server/reactive/DefaultServerHttpRequestBuilder$MutatedServerHttpRequest.class */
