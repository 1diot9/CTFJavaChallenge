...
/* loaded from: server.jar:BOOT-INF/lib/spring-web-6.1.3.jar:org/springframework/http/client/reactive/JettyClientHttpConnector.class */
public class JettyClientHttpConnector implements ClientHttpConnector {
    ...
    /* loaded from: server.jar:BOOT-INF/lib/spring-web-6.1.3.jar:org/springframework/http/client/reactive/JettyClientHttpConnector$JettyDataBuffer.class */
    private static final class JettyDataBuffer implements PooledDataBuffer {
        ...
        /* loaded from: server.jar:BOOT-INF/lib/spring-web-6.1.3.jar:org/springframework/http/client/reactive/JettyClientHttpConnector$JettyDataBuffer$JettyByteBufferIterator.class */
