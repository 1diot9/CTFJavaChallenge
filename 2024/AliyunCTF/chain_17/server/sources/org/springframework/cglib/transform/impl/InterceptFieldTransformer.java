...
/* loaded from: server.jar:BOOT-INF/lib/spring-core-6.1.3.jar:org/springframework/cglib/transform/impl/InterceptFieldTransformer.class */
public class InterceptFieldTransformer extends ClassEmitterTransformer {
    ...
    private static String callbackName(Type type) {
        ...
        return TypeUtils.upperFirst(TypeUtils.getClassName(type));
    }
}
