...
/* loaded from: server.jar:BOOT-INF/lib/spring-core-6.1.3.jar:org/springframework/cglib/core/KeyFactory.class */
public abstract class KeyFactory {
    ...
    public static final FieldTypeCustomizer STORE_CLASS_AS_STRING = new FieldTypeCustomizer() { // from class: org.springframework.cglib.core.KeyFactory.1
    ...
    @Deprecated
    public static final Customizer OBJECT_BY_CLASS = (e, type) -> {
    ...
    /* loaded from: server.jar:BOOT-INF/lib/spring-core-6.1.3.jar:org/springframework/cglib/core/KeyFactory$Generator.class */
