...
/* loaded from: server.jar:BOOT-INF/lib/spring-core-6.1.3.jar:org/springframework/cglib/proxy/MethodInterceptorGenerator.class */
class MethodInterceptorGenerator implements CallbackGenerator {
    ...
    private static final Transformer METHOD_TO_CLASS = value -> {
    ...
    public void generateFindProxy(ClassEmitter ce, final Map sigMap) {
        ...
        ObjectSwitchCallback callback = new ObjectSwitchCallback() { // from class: org.springframework.cglib.proxy.MethodInterceptorGenerator.1
