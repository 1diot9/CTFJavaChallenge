...
/* loaded from: server.jar:BOOT-INF/lib/spring-expression-6.1.3.jar:org/springframework/expression/spel/support/StandardEvaluationContext.class */
public class StandardEvaluationContext implements EvaluationContext {
    ...
    public StandardEvaluationContext() {
        this.typeComparator = StandardTypeComparator.INSTANCE;
        this.operatorOverloader = StandardOperatorOverloader.INSTANCE;
