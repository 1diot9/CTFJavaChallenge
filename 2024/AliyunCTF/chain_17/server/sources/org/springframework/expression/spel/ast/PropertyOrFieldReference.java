...
/* loaded from: server.jar:BOOT-INF/lib/spring-expression-6.1.3.jar:org/springframework/expression/spel/ast/PropertyOrFieldReference.class */
public class PropertyOrFieldReference extends SpelNodeImpl {
    ...
    public TypedValue getValueInternal(ExpressionState state) throws EvaluationException {
        ...
        if (accessorToUse instanceof CompilablePropertyAccessor) {
            CompilablePropertyAccessor compilablePropertyAccessor = (CompilablePropertyAccessor) accessorToUse;
            ...
            for (PropertyAccessor accessor : accessorsToTry) {
                if (accessor.canRead(evalContext, contextObject.getValue(), name)) {
                    if (accessor instanceof ReflectivePropertyAccessor) {
                        ...
                        accessor = reflectivePropertyAccessor.createOptimalAccessor(evalContext, contextObject.getValue(), name);
                    }
    ...
    public boolean isCompilable() {
        ...
        if (propertyAccessor instanceof CompilablePropertyAccessor) {
            ...
            if (compilablePropertyAccessor.isCompilable()) {
                return true;
            }
        }
        return false;
    ...
    /* loaded from: server.jar:BOOT-INF/lib/spring-expression-6.1.3.jar:org/springframework/expression/spel/ast/PropertyOrFieldReference$AccessorLValue.class */
