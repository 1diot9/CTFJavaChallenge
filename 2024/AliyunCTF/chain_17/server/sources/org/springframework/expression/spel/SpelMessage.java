...
/* loaded from: server.jar:BOOT-INF/lib/spring-expression-6.1.3.jar:org/springframework/expression/spel/SpelMessage.class */
public enum SpelMessage {
    ...
    EXCEPTION_DURING_FUNCTION_CALL(Kind.ERROR, FastDoubleMath.DOUBLE_EXPONENT_BIAS, "A problem occurred whilst attempting to invoke the function ''{0}'': ''{1}''"),
    ...
    /* loaded from: server.jar:BOOT-INF/lib/spring-expression-6.1.3.jar:org/springframework/expression/spel/SpelMessage$Kind.class */
    public enum Kind {
        INFO,
        WARNING,
        ERROR
