...
/* loaded from: server.jar:BOOT-INF/lib/spring-context-6.1.3.jar:org/springframework/format/number/money/Jsr354NumberFormatAnnotationFormatterFactory.class */
public class Jsr354NumberFormatAnnotationFormatterFactory extends EmbeddedValueResolutionSupport implements AnnotationFormatterFactory<NumberFormat> {
    ...
    public /* bridge */ /* synthetic */ Parser getParser(NumberFormat annotation, Class fieldType) {
        return getParser2(annotation, (Class<?>) fieldType);
    }

    @Override // org.springframework.format.AnnotationFormatterFactory
    public /* bridge */ /* synthetic */ Printer getPrinter(NumberFormat annotation, Class fieldType) {
    ...
    /* loaded from: server.jar:BOOT-INF/lib/spring-context-6.1.3.jar:org/springframework/format/number/money/Jsr354NumberFormatAnnotationFormatterFactory$NumberDecoratingFormatter.class */
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* loaded from: server.jar:BOOT-INF/lib/spring-context-6.1.3.jar:org/springframework/format/number/money/Jsr354NumberFormatAnnotationFormatterFactory$PatternDecoratingFormatter.class */
