...
/* loaded from: server.jar:BOOT-INF/lib/spring-core-6.1.3.jar:org/springframework/core/MethodIntrospector.class */
public final class MethodIntrospector {

    @FunctionalInterface
    /* loaded from: server.jar:BOOT-INF/lib/spring-core-6.1.3.jar:org/springframework/core/MethodIntrospector$MetadataLookup.class */
        ...
        for (Class<?> currentHandlerType : handlerTypes) {
            ...
            ReflectionUtils.doWithMethods(currentHandlerType, method -> {
                ...
                if (inspect != null) {
                    ...
                    if (bridgedMethod == specificMethod || bridgedMethod == method || metadataLookup.inspect(bridgedMethod) == null) {
