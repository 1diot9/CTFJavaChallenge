...
/* loaded from: server.jar:BOOT-INF/lib/spring-core-6.1.3.jar:org/springframework/core/convert/TypeDescriptor.class */
public class TypeDescriptor implements Serializable {
    ...
    /* loaded from: server.jar:BOOT-INF/lib/spring-core-6.1.3.jar:org/springframework/core/convert/TypeDescriptor$AnnotatedElementAdapter.class */
    public class AnnotatedElementAdapter implements AnnotatedElement, Serializable {
        ...
        public boolean equals(@Nullable Object other) {
            if (this != other) {
                if (other instanceof AnnotatedElementAdapter) {
