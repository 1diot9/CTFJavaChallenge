...
/* loaded from: server.jar:BOOT-INF/lib/spring-core-6.1.3.jar:org/springframework/core/MethodParameter.class */
public class MethodParameter {
    ...
    private MethodParameter nested(int nestingLevel, @Nullable Integer typeIndex) {
        MethodParameter copy = mo2452clone();
    ...
    public MethodParameter withContainingClass(@Nullable Class<?> containingClass) {
        MethodParameter result = mo2452clone();
    ...
    public MethodParameter mo2452clone() {
    ...
    /* loaded from: server.jar:BOOT-INF/lib/spring-core-6.1.3.jar:org/springframework/core/MethodParameter$FieldAwareConstructorParameter.class */
    private static class FieldAwareConstructorParameter extends MethodParameter {
        ...
        /* renamed from: clone */
        public /* bridge */ /* synthetic */ Object mo2452clone() throws CloneNotSupportedException {
            return super.mo2452clone();
        }
    ...
    /* loaded from: server.jar:BOOT-INF/lib/spring-core-6.1.3.jar:org/springframework/core/MethodParameter$KotlinDelegate.class */
