...
/* loaded from: server.jar:BOOT-INF/lib/spring-core-6.1.3.jar:org/springframework/util/concurrent/SettableListenableFuture.class */
public class SettableListenableFuture<T> implements ListenableFuture<T> {
    ...
    /* loaded from: server.jar:BOOT-INF/lib/spring-core-6.1.3.jar:org/springframework/util/concurrent/SettableListenableFuture$SettableTask.class */
