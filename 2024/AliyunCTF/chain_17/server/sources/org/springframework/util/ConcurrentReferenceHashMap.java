...
/* loaded from: server.jar:BOOT-INF/lib/spring-core-6.1.3.jar:org/springframework/util/ConcurrentReferenceHashMap.class */
public class ConcurrentReferenceHashMap<K, V> extends AbstractMap<K, V> implements ConcurrentMap<K, V> {
    ...
    /* loaded from: server.jar:BOOT-INF/lib/spring-core-6.1.3.jar:org/springframework/util/ConcurrentReferenceHashMap$Entries.class */
    public interface Entries<V> {
        void add(@Nullable V value);
    }

    /* JADX INFO: Access modifiers changed from: protected */
    /* loaded from: server.jar:BOOT-INF/lib/spring-core-6.1.3.jar:org/springframework/util/ConcurrentReferenceHashMap$Reference.class */
    ...
    /* loaded from: server.jar:BOOT-INF/lib/spring-core-6.1.3.jar:org/springframework/util/ConcurrentReferenceHashMap$ReferenceType.class */
    ...
    /* JADX INFO: Access modifiers changed from: protected */
    /* loaded from: server.jar:BOOT-INF/lib/spring-core-6.1.3.jar:org/springframework/util/ConcurrentReferenceHashMap$Restructure.class */
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* loaded from: server.jar:BOOT-INF/lib/spring-core-6.1.3.jar:org/springframework/util/ConcurrentReferenceHashMap$TaskOption.class */
    ...
    /* JADX INFO: Access modifiers changed from: protected */
    /* loaded from: server.jar:BOOT-INF/lib/spring-core-6.1.3.jar:org/springframework/util/ConcurrentReferenceHashMap$Segment.class */
    public final class Segment extends ReentrantLock {
        ...
        private void restructure(boolean allowResize, @Nullable Reference<K, V> ref) {
            ...
            try {
                ...
                int expectedCount2 = expectedCount - toPurge.size();
                boolean needsResize = expectedCount2 > 0 && expectedCount2 >= this.resizeThreshold;
                ...
                if (resizing) {
                    ...
                    for (Reference<K, V> reference : this.references) {
                        for (Reference<K, V> ref2 = reference; ref2 != null; ref2 = ref2.getNext()) {
                    ...
                    for (int i = 0; i < this.references.length; i++) {
                        ...
                        for (Reference<K, V> ref3 = this.references[i]; ref3 != null; ref3 = ref3.getNext()) {
                            if (!toPurge.contains(ref3)) {
                                Entry<K, V> entry2 = ref3.get();
                                if (entry2 != null) {
                                    purgedRef = this.referenceManager.createReference(entry2, ref3.getHash(), purgedRef);
                                }
                                newCount++;
                            }
                        }
    ...
    /* JADX INFO: Access modifiers changed from: protected */
    /* loaded from: server.jar:BOOT-INF/lib/spring-core-6.1.3.jar:org/springframework/util/ConcurrentReferenceHashMap$Entry.class */
        ...
        public boolean equals(@Nullable Object other) {
            if (this != other) {
                if (other instanceof Map.Entry) {
                    ...
                    if (!ObjectUtils.nullSafeEquals(getKey(), that.getKey()) || !ObjectUtils.nullSafeEquals(getValue(), that.getValue())) {
                    }
                }
                return false;
            }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* loaded from: server.jar:BOOT-INF/lib/spring-core-6.1.3.jar:org/springframework/util/ConcurrentReferenceHashMap$Task.class */
    ...
    /* loaded from: server.jar:BOOT-INF/lib/spring-core-6.1.3.jar:org/springframework/util/ConcurrentReferenceHashMap$EntrySet.class */
    ...
    /* loaded from: server.jar:BOOT-INF/lib/spring-core-6.1.3.jar:org/springframework/util/ConcurrentReferenceHashMap$EntryIterator.class */
    private class EntryIterator implements Iterator<Map.Entry<K, V>> {
        ...
        private void moveToNextSegment() {
            ...
            if (this.segmentIndex < ConcurrentReferenceHashMap.this.segments.length) {
                this.references = ((Segment) ConcurrentReferenceHashMap.this.segments[this.segmentIndex]).references;
                this.segmentIndex++;
            }
        }
    ...
    /* JADX INFO: Access modifiers changed from: protected */
    /* loaded from: server.jar:BOOT-INF/lib/spring-core-6.1.3.jar:org/springframework/util/ConcurrentReferenceHashMap$ReferenceManager.class */
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* loaded from: server.jar:BOOT-INF/lib/spring-core-6.1.3.jar:org/springframework/util/ConcurrentReferenceHashMap$SoftEntryReference.class */
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* loaded from: server.jar:BOOT-INF/lib/spring-core-6.1.3.jar:org/springframework/util/ConcurrentReferenceHashMap$WeakEntryReference.class */
