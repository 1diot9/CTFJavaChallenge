...
/* loaded from: server.jar:BOOT-INF/lib/spring-core-6.1.3.jar:org/springframework/util/MimeType.class */
public class MimeType implements Comparable<MimeType>, Serializable {
    ...
    /* JADX INFO: Access modifiers changed from: protected */
    public void checkParameters(String parameter, String value) {
    ...
    public boolean equals(@Nullable Object other) {
        if (this != other) {
            if (other instanceof MimeType) {
                ...
                if (!this.type.equalsIgnoreCase(otherType.type) || !this.subtype.equalsIgnoreCase(otherType.subtype) || !parametersAreEqual(otherType)) {
                }
            }
            return false;
        }
    ...
    /* loaded from: server.jar:BOOT-INF/lib/spring-core-6.1.3.jar:org/springframework/util/MimeType$SpecificityComparator.class */
