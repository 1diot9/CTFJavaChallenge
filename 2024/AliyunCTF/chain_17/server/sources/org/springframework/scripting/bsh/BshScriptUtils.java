...
/* loaded from: server.jar:BOOT-INF/lib/spring-context-6.1.3.jar:org/springframework/scripting/bsh/BshScriptUtils.class */
public abstract class BshScriptUtils {
    ...
    /* loaded from: server.jar:BOOT-INF/lib/spring-context-6.1.3.jar:org/springframework/scripting/bsh/BshScriptUtils$BshObjectInvocationHandler.class */
    public static class BshObjectInvocationHandler implements InvocationHandler {
        ...
        private boolean isProxyForSameBshObject(Object obj) {
            ...
            if (ih instanceof BshObjectInvocationHandler) {
                BshObjectInvocationHandler that = (BshObjectInvocationHandler) ih;
                if (this.xt.equals(that.xt)) {
                    return true;
                }
            }
            return false;
    ...
    /* loaded from: server.jar:BOOT-INF/lib/spring-context-6.1.3.jar:org/springframework/scripting/bsh/BshScriptUtils$BshExecutionException.class */
