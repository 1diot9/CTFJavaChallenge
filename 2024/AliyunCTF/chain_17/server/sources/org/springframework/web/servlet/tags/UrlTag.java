...
/* loaded from: server.jar:BOOT-INF/lib/spring-webmvc-6.1.3.jar:org/springframework/web/servlet/tags/UrlTag.class */
public class UrlTag extends HtmlEscapingAwareTag implements ParamAware {
    ...
    /* loaded from: server.jar:BOOT-INF/lib/spring-webmvc-6.1.3.jar:org/springframework/web/servlet/tags/UrlTag$UrlType.class */
    public enum UrlType {
        CONTEXT_RELATIVE,
        RELATIVE,
        ABSOLUTE
    ...
    String createUrl() throws JspException {
        ...
        url.append(createQueryString(this.params, this.templateParams, url.indexOf(CoreConstants.NA) == -1));
