...
/* loaded from: server.jar:BOOT-INF/lib/spring-web-6.1.3.jar:org/springframework/web/client/RestOperationsExtensionsKt$exchange$2.class */
public final class RestOperationsExtensionsKt$exchange$2<T> extends ParameterizedTypeReference<T> {
}
