...
/* loaded from: server.jar:BOOT-INF/lib/spring-webmvc-6.1.3.jar:org/springframework/web/servlet/view/script/ScriptTemplateView.class */
public class ScriptTemplateView extends AbstractUrlBasedView {
    ...
    /* loaded from: server.jar:BOOT-INF/lib/spring-webmvc-6.1.3.jar:org/springframework/web/servlet/view/script/ScriptTemplateView$EngineKey.class */
        ...
        public boolean equals(@Nullable Object other) {
            if (this != other) {
                if (other instanceof EngineKey) {
                    EngineKey that = (EngineKey) other;
                    if (!this.engineName.equals(that.engineName) || !Arrays.equals(this.scripts, that.scripts)) {
                    }
                }
                return false;
            }
