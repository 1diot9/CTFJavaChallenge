...
/* loaded from: server.jar:BOOT-INF/lib/spring-webmvc-6.1.3.jar:org/springframework/web/servlet/function/ResourceHandlerFunction.class */
public class ResourceHandlerFunction implements HandlerFunction<ServerResponse> {
    ...
    public ServerResponse handle(ServerRequest request) {
        ...
        if (HttpMethod.GET.equals(method)) {
            return EntityResponse.fromObject(this.resource).headers(headers -> {
                this.headersConsumer.accept(this.resource, headers);
            }).build();
        }
        if (HttpMethod.HEAD.equals(method)) {
            Resource headResource = new HeadMethodResource(this.resource);
            return EntityResponse.fromObject(headResource).headers(headers2 -> {
                this.headersConsumer.accept(this.resource, headers2);
            }).build();
        }
    ...
    /* loaded from: server.jar:BOOT-INF/lib/spring-webmvc-6.1.3.jar:org/springframework/web/servlet/function/ResourceHandlerFunction$HeadMethodResource.class */
