...
/* loaded from: server.jar:BOOT-INF/lib/spring-web-6.1.3.jar:org/springframework/web/context/support/ServletContextResourcePatternResolver.class */
            ...
            try {
                ...
                while (entries.hasMoreElements()) {
                    ...
                    if (getPathMatcher().match(entryPattern, entryPath)) {
                        result.add(new UrlResource(ResourceUtils.URL_PROTOCOL_JAR, "file:" + jarFilePath + "!/" + entryPath));
                    }
                }
                jarFile.close();
            } finally {
