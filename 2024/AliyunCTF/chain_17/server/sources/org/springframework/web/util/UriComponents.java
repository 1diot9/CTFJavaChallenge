...
/* loaded from: server.jar:BOOT-INF/lib/spring-web-6.1.3.jar:org/springframework/web/util/UriComponents.class */
public abstract class UriComponents implements Serializable {
    ...
    /* loaded from: server.jar:BOOT-INF/lib/spring-web-6.1.3.jar:org/springframework/web/util/UriComponents$UriTemplateVariables.class */
    ...
    public abstract void copyToUriComponentsBuilder(UriComponentsBuilder builder);
    ...
    /* loaded from: server.jar:BOOT-INF/lib/spring-web-6.1.3.jar:org/springframework/web/util/UriComponents$MapTemplateVariables.class */
    ...
    /* loaded from: server.jar:BOOT-INF/lib/spring-web-6.1.3.jar:org/springframework/web/util/UriComponents$VarArgsTemplateVariables.class */
