...
/* loaded from: server.jar:BOOT-INF/lib/spring-web-6.1.3.jar:org/springframework/web/util/UriComponentsBuilder.class */
public class UriComponentsBuilder implements UriBuilder, Cloneable {
    ...
    /* loaded from: server.jar:BOOT-INF/lib/spring-web-6.1.3.jar:org/springframework/web/util/UriComponentsBuilder$EncodingHint.class */
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* loaded from: server.jar:BOOT-INF/lib/spring-web-6.1.3.jar:org/springframework/web/util/UriComponentsBuilder$PathComponentBuilder.class */
    ...
    public static InetSocketAddress parseForwardedFor(HttpRequest request, @Nullable InetSocketAddress remoteAddress) {
        return ForwardedHeaderUtils.parseForwardedFor(request.getURI(), request.getHeaders(), remoteAddress);
    }
    ...
    public UriComponents build(boolean encoded) {
        ...
        if (encoded) {
            encodingHint = EncodingHint.FULLY_ENCODED;
        } else {
            encodingHint = this.encodeTemplate ? EncodingHint.ENCODE_TEMPLATE : EncodingHint.NONE;
        }
    ...
    private UriComponents buildInternal(EncodingHint hint) {
        ...
        if (this.ssp != null) {
            ...
            HierarchicalUriComponents uric = new HierarchicalUriComponents(this.scheme, this.fragment, this.userInfo, this.host, this.port, this.pathBuilder.build(), queryParams, hint == EncodingHint.FULLY_ENCODED);
    ...
    public void resetPortIfDefaultForScheme() {
        if (this.scheme != null) {
            if (((this.scheme.equals("http") || this.scheme.equals("ws")) && "80".equals(this.port)) || ((this.scheme.equals("https") || this.scheme.equals("wss")) && "443".equals(this.port))) {
                port((String) null);
            }
        }
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* loaded from: server.jar:BOOT-INF/lib/spring-web-6.1.3.jar:org/springframework/web/util/UriComponentsBuilder$CompositePathComponentBuilder.class */
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* loaded from: server.jar:BOOT-INF/lib/spring-web-6.1.3.jar:org/springframework/web/util/UriComponentsBuilder$FullPathComponentBuilder.class */
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* loaded from: server.jar:BOOT-INF/lib/spring-web-6.1.3.jar:org/springframework/web/util/UriComponentsBuilder$PathSegmentComponentBuilder.class */
