...
/* loaded from: server.jar:BOOT-INF/lib/spring-webmvc-6.1.3.jar:org/springframework/web/servlet/view/document/AbstractXlsxStreamingView.class */
public abstract class AbstractXlsxStreamingView extends AbstractXlsxView {
    ...
    protected /* bridge */ /* synthetic */ Workbook mo2913createWorkbook(Map model, HttpServletRequest request) {
