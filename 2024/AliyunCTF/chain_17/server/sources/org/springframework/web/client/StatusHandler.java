...
/* loaded from: server.jar:BOOT-INF/lib/spring-web-6.1.3.jar:org/springframework/web/client/StatusHandler.class */
public final class StatusHandler {
    ...
    @FunctionalInterface
    /* loaded from: server.jar:BOOT-INF/lib/spring-web-6.1.3.jar:org/springframework/web/client/StatusHandler$ResponsePredicate.class */
