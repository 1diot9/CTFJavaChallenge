...
/* loaded from: server.jar:BOOT-INF/lib/spring-web-6.1.3.jar:org/springframework/web/client/DefaultRestClient.class */
public final class DefaultRestClient implements RestClient {
    ...
    /* loaded from: server.jar:BOOT-INF/lib/spring-web-6.1.3.jar:org/springframework/web/client/DefaultRestClient$DefaultRequestBodyUriSpec.class */
    public class DefaultRequestBodyUriSpec implements RestClient.RequestBodyUriSpec {
        ...
        /* JADX INFO: Access modifiers changed from: private */
        @FunctionalInterface
        /* loaded from: server.jar:BOOT-INF/lib/spring-web-6.1.3.jar:org/springframework/web/client/DefaultRestClient$DefaultRequestBodyUriSpec$InternalBody.class */
    ...
    /* loaded from: server.jar:BOOT-INF/lib/spring-web-6.1.3.jar:org/springframework/web/client/DefaultRestClient$DefaultResponseSpec.class */
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* loaded from: server.jar:BOOT-INF/lib/spring-web-6.1.3.jar:org/springframework/web/client/DefaultRestClient$DefaultConvertibleClientHttpResponse.class */
