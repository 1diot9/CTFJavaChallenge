...
/* loaded from: server.jar:BOOT-INF/lib/spring-web-6.1.3.jar:org/springframework/web/cors/UrlBasedCorsConfigurationSource.class */
public class UrlBasedCorsConfigurationSource implements CorsConfigurationSource {
    ...
    public Map<String, CorsConfiguration> getCorsConfigurations() {
        ...
        this.corsConfigurations.forEach((pattern, config) -> {
            result.put(pattern.getPatternString(), config);
        });
