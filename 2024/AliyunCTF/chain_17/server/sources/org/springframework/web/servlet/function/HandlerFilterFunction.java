...
@FunctionalInterface
/* loaded from: server.jar:BOOT-INF/lib/spring-webmvc-6.1.3.jar:org/springframework/web/servlet/function/HandlerFilterFunction.class */
        ...
        return (request, next) -> {
            try {
                ...
                if (handle instanceof ErrorHandlingServerResponse) {
                    ErrorHandlingServerResponse response = (ErrorHandlingServerResponse) handle;
