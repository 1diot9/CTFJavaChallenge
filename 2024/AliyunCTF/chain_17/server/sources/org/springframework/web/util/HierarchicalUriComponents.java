...
/* loaded from: server.jar:BOOT-INF/lib/spring-web-6.1.3.jar:org/springframework/web/util/HierarchicalUriComponents.class */
public final class HierarchicalUriComponents extends UriComponents {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* loaded from: server.jar:BOOT-INF/lib/spring-web-6.1.3.jar:org/springframework/web/util/HierarchicalUriComponents$PathComponent.class */
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* loaded from: server.jar:BOOT-INF/lib/spring-web-6.1.3.jar:org/springframework/web/util/HierarchicalUriComponents$Type.class */
    public enum Type {
    ...
    /* loaded from: server.jar:BOOT-INF/lib/spring-web-6.1.3.jar:org/springframework/web/util/HierarchicalUriComponents$EncodeState.class */
    ...
    /* loaded from: server.jar:BOOT-INF/lib/spring-web-6.1.3.jar:org/springframework/web/util/HierarchicalUriComponents$UriTemplateEncoder.class */
    ...
    /* loaded from: server.jar:BOOT-INF/lib/spring-web-6.1.3.jar:org/springframework/web/util/HierarchicalUriComponents$FullPathComponent.class */
    ...
    /* loaded from: server.jar:BOOT-INF/lib/spring-web-6.1.3.jar:org/springframework/web/util/HierarchicalUriComponents$PathSegmentComponent.class */
    ...
    /* loaded from: server.jar:BOOT-INF/lib/spring-web-6.1.3.jar:org/springframework/web/util/HierarchicalUriComponents$PathComponentComposite.class */
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* loaded from: server.jar:BOOT-INF/lib/spring-web-6.1.3.jar:org/springframework/web/util/HierarchicalUriComponents$QueryUriTemplateVariables.class */
