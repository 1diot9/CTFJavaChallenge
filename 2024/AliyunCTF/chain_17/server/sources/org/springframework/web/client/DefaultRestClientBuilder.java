...
/* loaded from: server.jar:BOOT-INF/lib/spring-web-6.1.3.jar:org/springframework/web/client/DefaultRestClientBuilder.class */
final class DefaultRestClientBuilder implements RestClient.Builder {
    ...
    public RestClient.Builder m2772clone() {
    ...
    public RestClient build() {
        ...
        List<HttpMessageConverter<?>> messageConverters = this.messageConverters != null ? this.messageConverters : initMessageConverters();
        return new DefaultRestClient(requestFactory, this.interceptors, this.initializers, uriBuilderFactory, defaultHeaders, this.statusHandlers, messageConverters, this.observationRegistry, this.observationConvention, new DefaultRestClientBuilder(this));
    }
    ...
    private HttpHeaders copyDefaultHeaders() {
        if (this.defaultHeaders != null) {
            ...
            this.defaultHeaders.forEach((key, values) -> {
                copy.put(key, (List<String>) new ArrayList(values));
            });
