...
/* loaded from: server.jar:BOOT-INF/lib/spring-web-6.1.3.jar:org/springframework/web/util/BindErrorUtils.class */
public abstract class BindErrorUtils {
    ...
    /* loaded from: server.jar:BOOT-INF/lib/spring-web-6.1.3.jar:org/springframework/web/util/BindErrorUtils$MethodArgumentErrorMessageSource.class */
