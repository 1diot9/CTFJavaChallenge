...
/* loaded from: server.jar:BOOT-INF/lib/spring-web-6.1.3.jar:org/springframework/web/server/session/InMemoryWebSessionStore.class */
public class InMemoryWebSessionStore implements WebSessionStore {
    ...
    /* loaded from: server.jar:BOOT-INF/lib/spring-web-6.1.3.jar:org/springframework/web/server/session/InMemoryWebSessionStore$State.class */
    public enum State {
        NEW,
        STARTED,
        EXPIRED
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* loaded from: server.jar:BOOT-INF/lib/spring-web-6.1.3.jar:org/springframework/web/server/session/InMemoryWebSessionStore$InMemoryWebSession.class */
    public class InMemoryWebSession implements WebSession {
        ...
        public Mono<Void> changeSessionId() {
            return Mono.defer(() -> {
                ...
                return Mono.empty();
            }).subscribeOn(Schedulers.boundedElastic()).publishOn(Schedulers.parallel()).then();
        }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* loaded from: server.jar:BOOT-INF/lib/spring-web-6.1.3.jar:org/springframework/web/server/session/InMemoryWebSessionStore$ExpiredSessionChecker.class */
