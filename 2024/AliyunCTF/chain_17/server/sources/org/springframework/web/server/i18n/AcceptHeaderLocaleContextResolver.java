...
/* loaded from: server.jar:BOOT-INF/lib/spring-web-6.1.3.jar:org/springframework/web/server/i18n/AcceptHeaderLocaleContextResolver.class */
            ...
            if (supportedLocales.contains(locale)) {
                ...
                while (true) {
                    if (it.hasNext()) {
                        ...
                        if (!StringUtils.hasLength(supportedLocale.getCountry()) && supportedLocale.getLanguage().equals(locale.getLanguage())) {
