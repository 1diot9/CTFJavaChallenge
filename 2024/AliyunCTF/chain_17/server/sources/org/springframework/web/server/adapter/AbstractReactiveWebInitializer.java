...
/* loaded from: server.jar:BOOT-INF/lib/spring-web-6.1.3.jar:org/springframework/web/server/adapter/AbstractReactiveWebInitializer.class */
public abstract class AbstractReactiveWebInitializer implements WebApplicationInitializer {
    ...
    /* loaded from: server.jar:BOOT-INF/lib/spring-web-6.1.3.jar:org/springframework/web/server/adapter/AbstractReactiveWebInitializer$ServletContextDestroyedListener.class */
