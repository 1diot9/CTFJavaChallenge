...
/* loaded from: server.jar:BOOT-INF/lib/spring-web-6.1.3.jar:org/springframework/web/bind/annotation/RequestMethod.class */
    ...
    public static RequestMethod resolve(String method) {
        ...
        switch (method.hashCode()) {
            ...
            case 79599:
                ...
                break;
            case 2213344:
                if (method.equals(WebContentGenerator.METHOD_HEAD)) {
                    z = true;
                    break;
                }
                break;
