...
/* loaded from: server.jar:BOOT-INF/lib/snakeyaml-2.2.jar:org/yaml/snakeyaml/constructor/Constructor.class */
public class Constructor extends SafeConstructor {
    ...
    /* loaded from: server.jar:BOOT-INF/lib/snakeyaml-2.2.jar:org/yaml/snakeyaml/constructor/Constructor$ConstructMapping.class */
                ...
                try {
                    ...
                    if (!typeDetected && valueNode.getNodeId() != NodeId.scalar && (arguments = property.getActualTypeArguments()) != null && arguments.length > 0) {
                        if (valueNode.getNodeId() == NodeId.sequence) {
                            ...
                            mappingNode.setTypes(keyType, valueType);
                            ...
                            mappingNode2.setOnlyKeyType(t2);
    ...
    /* loaded from: server.jar:BOOT-INF/lib/snakeyaml-2.2.jar:org/yaml/snakeyaml/constructor/Constructor$ConstructYamlObject.class */
    ...
    /* loaded from: server.jar:BOOT-INF/lib/snakeyaml-2.2.jar:org/yaml/snakeyaml/constructor/Constructor$ConstructScalar.class */
    ...
    /* loaded from: server.jar:BOOT-INF/lib/snakeyaml-2.2.jar:org/yaml/snakeyaml/constructor/Constructor$ConstructSequence.class */
