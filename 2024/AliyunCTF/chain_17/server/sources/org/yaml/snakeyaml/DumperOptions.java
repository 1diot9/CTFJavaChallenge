...
/* loaded from: server.jar:BOOT-INF/lib/snakeyaml-2.2.jar:org/yaml/snakeyaml/DumperOptions.class */
public class DumperOptions {
    ...
    /* loaded from: server.jar:BOOT-INF/lib/snakeyaml-2.2.jar:org/yaml/snakeyaml/DumperOptions$NonPrintableStyle.class */
    public enum NonPrintableStyle {
        BINARY,
        ESCAPE
    }

    /* loaded from: server.jar:BOOT-INF/lib/snakeyaml-2.2.jar:org/yaml/snakeyaml/DumperOptions$ScalarStyle.class */
    ...
    /* loaded from: server.jar:BOOT-INF/lib/snakeyaml-2.2.jar:org/yaml/snakeyaml/DumperOptions$FlowStyle.class */
    ...
    /* loaded from: server.jar:BOOT-INF/lib/snakeyaml-2.2.jar:org/yaml/snakeyaml/DumperOptions$LineBreak.class */
    ...
    /* loaded from: server.jar:BOOT-INF/lib/snakeyaml-2.2.jar:org/yaml/snakeyaml/DumperOptions$Version.class */
    public enum Version {
