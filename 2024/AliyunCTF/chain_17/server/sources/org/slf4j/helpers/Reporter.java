...
/* loaded from: server.jar:BOOT-INF/lib/slf4j-api-2.0.11.jar:org/slf4j/helpers/Reporter.class */
public class Reporter {
    ...
    /* loaded from: server.jar:BOOT-INF/lib/slf4j-api-2.0.11.jar:org/slf4j/helpers/Reporter$TargetChoice.class */
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* loaded from: server.jar:BOOT-INF/lib/slf4j-api-2.0.11.jar:org/slf4j/helpers/Reporter$Level.class */
    public enum Level {
        INFO(1),
        WARN(2),
        ERROR(3);
