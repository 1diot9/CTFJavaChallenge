...
/* loaded from: server.jar:BOOT-INF/lib/jooq-3.19.3.jar:org/jooq/tools/jdbc/MockExecuteContext.class */
public class MockExecuteContext {
    ...
    public MockExecuteContext(String[] sql, Object[][] bindings, int autoGeneratedKeys, int[] columnIndexes, String[] columnNames, int[] outParameterTypes) {
        this.sql = sql;
