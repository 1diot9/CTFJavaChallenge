...
/* loaded from: server.jar:BOOT-INF/lib/jooq-3.19.3.jar:org/jooq/exception/SQLStateSubclass.class */
public enum SQLStateSubclass {
    ...
    static {
        for (SQLStateSubclass clazz : values()) {
            lookup.put(clazz.sqlStateClassName() + clazz.subclass, clazz);
        }
    }

    SQLStateSubclass(SQLStateClass clazz, String subclass) {
        this.clazz = clazz;
    ...
    public static SQLStateSubclass fromCode(String code) {
        ...
        SQLStateSubclass result2 = lookup.get(code.substring(0, 2) + "000");
        if (result2 != null) {
            return result2;
        }
        return OTHER;
