...
/* loaded from: server.jar:BOOT-INF/lib/jooq-3.19.3.jar:org/jooq/conf/MigrationSchema.class */
public class MigrationSchema extends SettingsBase implements Serializable, Cloneable, XMLAppendable {
    ...
    public MigrationSchema withCatalog(String value) {
        setCatalog(value);
        return this;
    }

    public MigrationSchema withSchema(String value) {
        setSchema(value);
        return this;
    }
    ...
    public boolean equals(Object that) {
        ...
        MigrationSchema other = (MigrationSchema) that;
