...
/* loaded from: server.jar:BOOT-INF/lib/jooq-3.19.3.jar:org/jooq/impl/SettingsEnabledPreparedStatement.class */
final class SettingsEnabledPreparedStatement extends DefaultStatement implements PreparedStatement {
    ...
    /* loaded from: server.jar:BOOT-INF/lib/jooq-3.19.3.jar:org/jooq/impl/SettingsEnabledPreparedStatement$MethodType.class */
    ...
    public SettingsEnabledPreparedStatement(Connection connection) throws SQLException {
        this(connection, (String) null, MethodType.BATCH);
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public SettingsEnabledPreparedStatement(Connection connection, String sql) throws SQLException {
        this(connection, sql, MethodType.SQL);
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public SettingsEnabledPreparedStatement(Connection connection, String sql, int resultSetType, int resultSetConcurrency) throws SQLException {
        this(connection, sql, MethodType.SQL_RST_RSC, connection.createStatement(resultSetType, resultSetConcurrency));
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public SettingsEnabledPreparedStatement(Connection connection, String sql, int resultSetType, int resultSetConcurrency, int resultSetHoldability) throws SQLException {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public SettingsEnabledPreparedStatement(Connection connection, String sql, int autoGeneratedKeys) throws SQLException {
        this(connection, sql, MethodType.SQL_AGK);
        this.autoGeneratedKeys = autoGeneratedKeys;
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public SettingsEnabledPreparedStatement(Connection connection, String sql, int[] columnIndexes) throws SQLException {
        this(connection, sql, MethodType.SQL_CI);
        this.columnIndexes = columnIndexes;
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public SettingsEnabledPreparedStatement(Connection connection, String sql, String[] columnNames) throws SQLException {
