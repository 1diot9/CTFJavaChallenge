...
/* loaded from: server.jar:BOOT-INF/lib/jooq-3.19.3.jar:org/jooq/impl/CovarSamp.class */
public final class CovarSamp extends AbstractAggregateFunction<BigDecimal> implements QOM.CovarSamp {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public CovarSamp(Field<? extends Number> y, Field<? extends Number> x) {
        super(false, Names.N_COVAR_SAMP, (DataType) SQLDataType.NUMERIC, (Field<?>[]) new Field[]{Tools.nullSafeNotNull(y, SQLDataType.INTEGER), Tools.nullSafeNotNull(x, SQLDataType.INTEGER)});
    }
    ...
    private void acceptEmulation(Context<?> ctx) {
        ...
        ctx.visit(fo(DSL.sum(field.times((Field<? extends Number>) y))).minus(fo(DSL.sum(x(field, y))).times((Field<? extends Number>) fo(DSL.sum(y(field, y)))).div(fon(DSL.count(field.plus(y))).cast(d(ctx)))).div(fon(DSL.count(field.plus(y))).cast(d(ctx)).minus(DSL.inline(1))));
    }
    ...
    public final Function2<? super Field<? extends Number>, ? super Field<? extends Number>, ? extends QOM.CovarSamp> $constructor() {
        return (a1, a2) -> {
            return new CovarSamp(a1, a2);
        };
    }

    @Override // org.jooq.impl.AbstractNamed, org.jooq.impl.AbstractQueryPart, org.jooq.QueryPart
    public boolean equals(Object that) {
        if (!(that instanceof QOM.CovarSamp)) {
            return super.equals(that);
        }
        QOM.CovarSamp o = (QOM.CovarSamp) that;
