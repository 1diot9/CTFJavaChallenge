...
/* loaded from: server.jar:BOOT-INF/lib/jooq-3.19.3.jar:org/jooq/impl/RegrSlope.class */
public final class RegrSlope extends AbstractAggregateFunction<BigDecimal> implements QOM.RegrSlope {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public RegrSlope(Field<? extends Number> y, Field<? extends Number> x) {
        super(false, Names.N_REGR_SLOPE, (DataType) SQLDataType.NUMERIC, (Field<?>[]) new Field[]{Tools.nullSafeNotNull(y, SQLDataType.INTEGER), Tools.nullSafeNotNull(x, SQLDataType.INTEGER)});
    }
    ...
    private final void acceptEmulation(Context<?> ctx) {
        ...
        ctx.visit(fo(DSL.covarPop(field, field2)).div((Field<? extends Number>) fon(DSL.varPop(y(field, field2)))));
    }

    @Override // org.jooq.impl.QOM.RegrSlope
    ...
    public final Function2<? super Field<? extends Number>, ? super Field<? extends Number>, ? extends QOM.RegrSlope> $constructor() {
        return (a1, a2) -> {
            return new RegrSlope(a1, a2);
        };
    }

    @Override // org.jooq.impl.AbstractNamed, org.jooq.impl.AbstractQueryPart, org.jooq.QueryPart
    public boolean equals(Object that) {
        if (!(that instanceof QOM.RegrSlope)) {
            return super.equals(that);
        }
        QOM.RegrSlope o = (QOM.RegrSlope) that;
