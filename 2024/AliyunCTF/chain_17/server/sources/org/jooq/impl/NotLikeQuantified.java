...
/* loaded from: server.jar:BOOT-INF/lib/jooq-3.19.3.jar:org/jooq/impl/NotLikeQuantified.class */
final class NotLikeQuantified extends AbstractCondition implements QOM.NotLikeQuantified, LikeEscapeStep {
    ...
    public NotLikeQuantified(Field<?> value, QuantifiedSelect<? extends Record1<String>> pattern) {
        this(value, pattern, null);
    }

    NotLikeQuantified(Field<?> value, QuantifiedSelect<? extends Record1<String>> pattern, Character escape) {
    ...
    public final void accept(Context<?> ctx) {
        EqQuantified.acceptCompareCondition(ctx, this, this.value, Comparator.NOT_LIKE, this.pattern, this.escape);
    }
    ...
    @Override // org.jooq.impl.QOM.UOperator3
    public final QOM.NotLikeQuantified $arg2(QuantifiedSelect<? extends Record1<String>> newValue) {
    ...
    public final Function3<? super Field<?>, ? super QuantifiedSelect<? extends Record1<String>>, ? super Character, ? extends QOM.NotLikeQuantified> $constructor() {
        return (a1, a2, a3) -> {
            return new NotLikeQuantified(a1, a2, a3);
        };
    }

    @Override // org.jooq.impl.AbstractNamed, org.jooq.impl.AbstractQueryPart, org.jooq.QueryPart
    public boolean equals(Object that) {
        if (!(that instanceof QOM.NotLikeQuantified)) {
            return super.equals(that);
        }
        QOM.NotLikeQuantified o = (QOM.NotLikeQuantified) that;
