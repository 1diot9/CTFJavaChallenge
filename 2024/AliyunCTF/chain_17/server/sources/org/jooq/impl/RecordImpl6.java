...
/* loaded from: server.jar:BOOT-INF/lib/jooq-3.19.3.jar:org/jooq/impl/RecordImpl6.class */
public final class RecordImpl6<T1, T2, T3, T4, T5, T6> extends AbstractRecord implements InternalRecord, Record6<T1, T2, T3, T4, T5, T6> {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public RecordImpl6(AbstractRow<?> row) {
        super(row);
    }
    ...
    public <T> Record6<T1, T2, T3, T4, T5, T6> with(Field<T> field, T value) {
        return (Record6) super.with((Field<Field<T>>) field, (Field<T>) value);
    }

    @Override // org.jooq.impl.AbstractRecord, org.jooq.Record
    public <T, U> Record6<T1, T2, T3, T4, T5, T6> with(Field<T> field, U value, Converter<? extends T, ? super U> converter) {
        return (Record6) super.with((Field) field, (Field<T>) value, (Converter<? extends T, ? super Field<T>>) converter);
    }
