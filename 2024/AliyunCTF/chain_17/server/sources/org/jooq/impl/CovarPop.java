...
/* loaded from: server.jar:BOOT-INF/lib/jooq-3.19.3.jar:org/jooq/impl/CovarPop.class */
public final class CovarPop extends AbstractAggregateFunction<BigDecimal> implements QOM.CovarPop {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public CovarPop(Field<? extends Number> y, Field<? extends Number> x) {
        super(false, Names.N_COVAR_POP, (DataType) SQLDataType.NUMERIC, (Field<?>[]) new Field[]{Tools.nullSafeNotNull(y, SQLDataType.INTEGER), Tools.nullSafeNotNull(x, SQLDataType.INTEGER)});
    }
    ...
    private final void acceptEmulation(Context<?> ctx) {
        ...
        ctx.visit(fo(DSL.regrSXY(field, field2)).div((Field<? extends Number>) fo(DSL.regrCount(field2, field))));
    }

    @Override // org.jooq.impl.QOM.CovarPop
    ...
    public final Function2<? super Field<? extends Number>, ? super Field<? extends Number>, ? extends QOM.CovarPop> $constructor() {
        return (a1, a2) -> {
            return new CovarPop(a1, a2);
        };
    }

    @Override // org.jooq.impl.AbstractNamed, org.jooq.impl.AbstractQueryPart, org.jooq.QueryPart
    public boolean equals(Object that) {
        if (!(that instanceof QOM.CovarPop)) {
            return super.equals(that);
        }
        QOM.CovarPop o = (QOM.CovarPop) that;
