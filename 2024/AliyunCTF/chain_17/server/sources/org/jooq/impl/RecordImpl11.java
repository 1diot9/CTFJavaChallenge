...
/* loaded from: server.jar:BOOT-INF/lib/jooq-3.19.3.jar:org/jooq/impl/RecordImpl11.class */
public final class RecordImpl11<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11> extends AbstractRecord implements InternalRecord, Record11<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11> {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public RecordImpl11(AbstractRow<?> row) {
        super(row);
    }
    ...
    @Override // org.jooq.Record11
    public final Record11<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11> value1(T1 value) {
        set(0, value);
        return this;
    }

    @Override // org.jooq.Record11
    public final Record11<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11> value2(T2 value) {
        set(1, value);
        return this;
    }

    @Override // org.jooq.Record11
    public final Record11<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11> value3(T3 value) {
        set(2, value);
        return this;
    }

    @Override // org.jooq.Record11
    public final Record11<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11> value4(T4 value) {
        set(3, value);
        return this;
    }

    @Override // org.jooq.Record11
    public final Record11<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11> value5(T5 value) {
        set(4, value);
        return this;
    }

    @Override // org.jooq.Record11
    public final Record11<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11> value6(T6 value) {
        set(5, value);
        return this;
    }

    @Override // org.jooq.Record11
    public final Record11<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11> value7(T7 value) {
        set(6, value);
        return this;
    }

    @Override // org.jooq.Record11
    public final Record11<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11> value8(T8 value) {
        set(7, value);
        return this;
    }

    @Override // org.jooq.Record11
    public final Record11<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11> value9(T9 value) {
        set(8, value);
        return this;
    }

    @Override // org.jooq.Record11
    public final Record11<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11> value10(T10 value) {
        set(9, value);
        return this;
    }

    @Override // org.jooq.Record11
    public final Record11<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11> value11(T11 value) {
        set(10, value);
        return this;
    }
    ...
    public <T> Record11<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11> with(Field<T> field, T value) {
        return (Record11) super.with((Field<Field<T>>) field, (Field<T>) value);
    }

    @Override // org.jooq.impl.AbstractRecord, org.jooq.Record
    public <T, U> Record11<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11> with(Field<T> field, U value, Converter<? extends T, ? super U> converter) {
        return (Record11) super.with((Field) field, (Field<T>) value, (Converter<? extends T, ? super Field<T>>) converter);
    }
