...
/* loaded from: server.jar:BOOT-INF/lib/jooq-3.19.3.jar:org/jooq/impl/NotInList.class */
public final class NotInList<T> extends AbstractInList<T> implements QOM.NotInList<T> {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public NotInList(Field<T> field, List<? extends Field<?>> values) {
        super(field, values);
    }
