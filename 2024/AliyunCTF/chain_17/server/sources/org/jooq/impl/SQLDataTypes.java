...
/* loaded from: server.jar:BOOT-INF/lib/jooq-3.19.3.jar:org/jooq/impl/SQLDataTypes.class */
final class SQLDataTypes {
    private SQLDataTypes() {
    }

    /* loaded from: server.jar:BOOT-INF/lib/jooq-3.19.3.jar:org/jooq/impl/SQLDataTypes$DuckDBDataType.class */
    ...
    /* loaded from: server.jar:BOOT-INF/lib/jooq-3.19.3.jar:org/jooq/impl/SQLDataTypes$TrinoDataType.class */
