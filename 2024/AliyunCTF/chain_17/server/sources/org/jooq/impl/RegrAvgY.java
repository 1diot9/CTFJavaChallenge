...
/* loaded from: server.jar:BOOT-INF/lib/jooq-3.19.3.jar:org/jooq/impl/RegrAvgY.class */
public final class RegrAvgY extends AbstractAggregateFunction<BigDecimal> implements QOM.RegrAvgY {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public RegrAvgY(Field<? extends Number> y, Field<? extends Number> x) {
        super(false, Names.N_REGR_AVGY, (DataType) SQLDataType.NUMERIC, (Field<?>[]) new Field[]{Tools.nullSafeNotNull(y, SQLDataType.INTEGER), Tools.nullSafeNotNull(x, SQLDataType.INTEGER)});
    }
    ...
    public final Function2<? super Field<? extends Number>, ? super Field<? extends Number>, ? extends QOM.RegrAvgY> $constructor() {
        return (a1, a2) -> {
            return new RegrAvgY(a1, a2);
        };
    }

    @Override // org.jooq.impl.AbstractNamed, org.jooq.impl.AbstractQueryPart, org.jooq.QueryPart
    public boolean equals(Object that) {
        if (!(that instanceof QOM.RegrAvgY)) {
            return super.equals(that);
        }
        QOM.RegrAvgY o = (QOM.RegrAvgY) that;
