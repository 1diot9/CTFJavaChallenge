...
/* loaded from: server.jar:BOOT-INF/lib/jooq-3.19.3.jar:org/jooq/impl/Ge.class */
public final class Ge<T> extends AbstractCondition implements QOM.Ge<T> {
    final Field<T> arg1;
    final Field<T> arg2;

    /* JADX INFO: Access modifiers changed from: package-private */
    public Ge(Field<T> arg1, Field<T> arg2) {
    ...
    public final void accept(Context<?> ctx) {
        Eq.acceptCompareCondition(ctx, this, this.arg1, Comparator.GREATER_OR_EQUAL, this.arg2, (v0, v1) -> {
            return v0.ge(v1);
        }, (v0, v1) -> {
            return v0.ge(v1);
        }, (c, a1, a2) -> {
    ...
    public boolean equals(Object that) {
        if (!(that instanceof QOM.Ge)) {
            return super.equals(that);
        }
        QOM.Ge<?> o = (QOM.Ge) that;
