...
/* loaded from: server.jar:BOOT-INF/lib/jooq-3.19.3.jar:org/jooq/impl/RowImplN.class */
public final class RowImplN extends AbstractRow<Record> implements RowN {
    /* JADX INFO: Access modifiers changed from: package-private */
    public RowImplN(SelectField<?>... fields) {
        super(fields);
    }
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public RowImplN(FieldsImpl<?> fields) {
        super(fields);
    }
    ...
    public final <U> SelectField<U> mapping(java.util.function.Function<? super Object[], ? extends U> function) {
        return convertFrom(r -> {
            ...
            return function.apply(r.intoArray());
        });
    }

    @Override // org.jooq.RowN
    public final <U> SelectField<U> mapping(Class<U> uType, java.util.function.Function<? super Object[], ? extends U> function) {
    ...
    public final Condition compare(Comparator comparator, Object... values) {
        return compare(comparator, DSL.row((Collection<?>) Tools.fields(values, dataTypes())));
    }
    ...
    public final BetweenAndStepN between(Object... values) {
        return between(DSL.row((SelectField<?>[]) Tools.fieldsArray(values, dataTypes())));
    }

    @Override // org.jooq.RowN
    public final BetweenAndStepN between(Field<?>... values) {
        return between(DSL.row((SelectField<?>[]) values));
    }
    ...
    public final BetweenAndStepN betweenSymmetric(Object... values) {
        return betweenSymmetric(DSL.row((SelectField<?>[]) Tools.fieldsArray(values, dataTypes())));
    }

    @Override // org.jooq.RowN
    public final BetweenAndStepN betweenSymmetric(Field<?>... values) {
        return betweenSymmetric(DSL.row((SelectField<?>[]) values));
    }
    ...
    public final BetweenAndStepN notBetween(Object... values) {
        return notBetween(DSL.row((SelectField<?>[]) Tools.fieldsArray(values, dataTypes())));
    }

    @Override // org.jooq.RowN
    public final BetweenAndStepN notBetween(Field<?>... values) {
        return notBetween(DSL.row((SelectField<?>[]) values));
    }
    ...
    public final BetweenAndStepN notBetweenSymmetric(Object... values) {
        return notBetweenSymmetric(DSL.row((SelectField<?>[]) Tools.fieldsArray(values, dataTypes())));
    }

    @Override // org.jooq.RowN
    public final BetweenAndStepN notBetweenSymmetric(Field<?>... values) {
        return notBetweenSymmetric(DSL.row((SelectField<?>[]) values));
    }
    ...
    public final Condition isNotDistinctFrom(Field<?>... values) {
        return isNotDistinctFrom(DSL.row((SelectField<?>[]) values));
    }
    ...
    public final Condition isDistinctFrom(Field<?>... values) {
        return isDistinctFrom(DSL.row((SelectField<?>[]) values));
    }
    ...
    public final Condition in(Record... records) {
        ...
        for (Record record : records) {
            rows.add((QueryPartList<Row>) record.valuesRow());
        }
