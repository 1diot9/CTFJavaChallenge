...
/* loaded from: server.jar:BOOT-INF/lib/jooq-3.19.3.jar:org/jooq/impl/ToDate.class */
public final class ToDate extends AbstractField<Date> implements QOM.ToDate {
    ...
    /* loaded from: server.jar:BOOT-INF/lib/jooq-3.19.3.jar:org/jooq/impl/ToDate$1.class */
    static /* synthetic */ class AnonymousClass1 {
        static final /* synthetic */ int[] $SwitchMap$org$jooq$SQLDialect = new int[SQLDialect.values().length];
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public ToDate(Field<String> value, Field<String> formatMask) {
        super(Names.N_TO_DATE, Tools.allNotNull(SQLDataType.DATE, value, formatMask));
    ...
    public final void accept(Context<?> ctx) {
        switch (AnonymousClass1.$SwitchMap$org$jooq$SQLDialect[ctx.family().ordinal()]) {
            default:
                ctx.visit(DSL.function(Names.N_TO_DATE, getDataType(), (Field<?>[]) new Field[]{this.value, this.formatMask}));
                return;
        }
    }
    ...
    public final Function2<? super Field<String>, ? super Field<String>, ? extends QOM.ToDate> $constructor() {
        return (a1, a2) -> {
            return new ToDate(a1, a2);
        };
    }

    @Override // org.jooq.impl.AbstractNamed, org.jooq.impl.AbstractQueryPart, org.jooq.QueryPart
    public boolean equals(Object that) {
        if (!(that instanceof QOM.ToDate)) {
            return super.equals(that);
        }
        QOM.ToDate o = (QOM.ToDate) that;
