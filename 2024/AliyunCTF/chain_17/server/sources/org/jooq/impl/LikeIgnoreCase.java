...
/* loaded from: server.jar:BOOT-INF/lib/jooq-3.19.3.jar:org/jooq/impl/LikeIgnoreCase.class */
public final class LikeIgnoreCase extends AbstractCondition implements QOM.LikeIgnoreCase, LikeEscapeStep {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public LikeIgnoreCase(Field<?> value, Field<String> pattern) {
        this(value, pattern, null);
    }

    LikeIgnoreCase(Field<?> value, Field<String> pattern, Character escape) {
    ...
    public final void accept(Context<?> ctx) {
        Like.accept0(ctx, this.value, Comparator.LIKE_IGNORE_CASE, this.pattern, this.escape);
    }
    ...
    @Override // org.jooq.impl.QOM.UOperator3
    public final QOM.LikeIgnoreCase $arg1(Field<?> newValue) {
        return $constructor().apply(newValue, $arg2(), $arg3());
    }

    @Override // org.jooq.impl.QOM.UOperator3
    public final QOM.LikeIgnoreCase $arg2(Field<String> newValue) {
        return $constructor().apply($arg1(), newValue, $arg3());
    }

    @Override // org.jooq.impl.QOM.UOperator3
    public final QOM.LikeIgnoreCase $arg3(Character newValue) {
    ...
    public final Function3<? super Field<?>, ? super Field<String>, ? super Character, ? extends QOM.LikeIgnoreCase> $constructor() {
        return (a1, a2, a3) -> {
            return new LikeIgnoreCase(a1, a2, a3);
        };
    }

    @Override // org.jooq.impl.AbstractNamed, org.jooq.impl.AbstractQueryPart, org.jooq.QueryPart
    public boolean equals(Object that) {
        if (!(that instanceof QOM.LikeIgnoreCase)) {
            return super.equals(that);
        }
        QOM.LikeIgnoreCase o = (QOM.LikeIgnoreCase) that;
