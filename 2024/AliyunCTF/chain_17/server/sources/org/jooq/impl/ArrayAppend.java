...
/* loaded from: server.jar:BOOT-INF/lib/jooq-3.19.3.jar:org/jooq/impl/ArrayAppend.class */
public final class ArrayAppend<T> extends AbstractField<T[]> implements QOM.ArrayAppend<T> {
    final Field<T[]> arg1;
    final Field<T> arg2;

    /* JADX INFO: Access modifiers changed from: package-private */
    public ArrayAppend(Field<T[]> arg1, Field<T> arg2) {
        super(Names.N_ARRAY_APPEND, Tools.allNotNull(Tools.dataType(SQLDataType.OTHER.array(), arg1, false), arg1, arg2));
    ...
    public final void accept(Context<?> ctx) {
        switch (ctx.family()) {
            ...
            case HSQLDB:
            case TRINO:
                ctx.visit(DSL.arrayConcat(this.arg1, DSL.array(this.arg2)));
                return;
            default:
                ctx.visit(DSL.function(Names.N_ARRAY_APPEND, getDataType(), (Field<?>[]) new Field[]{this.arg1, this.arg2}));
                return;
        }
    }
