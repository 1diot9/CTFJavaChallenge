...
/* loaded from: server.jar:BOOT-INF/lib/jooq-3.19.3.jar:org/jooq/impl/RegrSyy.class */
public final class RegrSyy extends AbstractAggregateFunction<BigDecimal> implements QOM.RegrSyy {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public RegrSyy(Field<? extends Number> y, Field<? extends Number> x) {
        super(false, Names.N_REGR_SYY, (DataType) SQLDataType.NUMERIC, (Field<?>[]) new Field[]{Tools.nullSafeNotNull(y, SQLDataType.INTEGER), Tools.nullSafeNotNull(x, SQLDataType.INTEGER)});
    }
    ...
    private final void acceptEmulation(Context<?> ctx) {
        ...
        ctx.visit(fo(DSL.regrCount(field, field2)).times((Field<? extends Number>) fo(DSL.varPop(x(field, field2)))));
    }

    @Override // org.jooq.impl.QOM.RegrSyy
    ...
    public final Function2<? super Field<? extends Number>, ? super Field<? extends Number>, ? extends QOM.RegrSyy> $constructor() {
        return (a1, a2) -> {
            return new RegrSyy(a1, a2);
        };
    }

    @Override // org.jooq.impl.AbstractNamed, org.jooq.impl.AbstractQueryPart, org.jooq.QueryPart
    public boolean equals(Object that) {
        if (!(that instanceof QOM.RegrSyy)) {
            return super.equals(that);
        }
        QOM.RegrSyy o = (QOM.RegrSyy) that;
