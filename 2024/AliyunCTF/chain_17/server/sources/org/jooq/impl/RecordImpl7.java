...
/* loaded from: server.jar:BOOT-INF/lib/jooq-3.19.3.jar:org/jooq/impl/RecordImpl7.class */
public final class RecordImpl7<T1, T2, T3, T4, T5, T6, T7> extends AbstractRecord implements InternalRecord, Record7<T1, T2, T3, T4, T5, T6, T7> {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public RecordImpl7(AbstractRow<?> row) {
        super(row);
    }
    ...
    public <T> Record7<T1, T2, T3, T4, T5, T6, T7> with(Field<T> field, T value) {
        return (Record7) super.with((Field<Field<T>>) field, (Field<T>) value);
    }

    @Override // org.jooq.impl.AbstractRecord, org.jooq.Record
    public <T, U> Record7<T1, T2, T3, T4, T5, T6, T7> with(Field<T> field, U value, Converter<? extends T, ? super U> converter) {
        return (Record7) super.with((Field) field, (Field<T>) value, (Converter<? extends T, ? super Field<T>>) converter);
    }
