...
/* loaded from: server.jar:BOOT-INF/lib/jooq-3.19.3.jar:org/jooq/impl/RecordImpl4.class */
public final class RecordImpl4<T1, T2, T3, T4> extends AbstractRecord implements InternalRecord, Record4<T1, T2, T3, T4> {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public RecordImpl4(AbstractRow<?> row) {
        super(row);
    }
    ...
    public <T> Record4<T1, T2, T3, T4> with(Field<T> field, T value) {
        return (Record4) super.with((Field<Field<T>>) field, (Field<T>) value);
    }

    @Override // org.jooq.impl.AbstractRecord, org.jooq.Record
    public <T, U> Record4<T1, T2, T3, T4> with(Field<T> field, U value, Converter<? extends T, ? super U> converter) {
        return (Record4) super.with((Field) field, (Field<T>) value, (Converter<? extends T, ? super Field<T>>) converter);
    }
