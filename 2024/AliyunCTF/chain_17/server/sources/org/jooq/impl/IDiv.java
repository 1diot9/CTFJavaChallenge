...
/* loaded from: server.jar:BOOT-INF/lib/jooq-3.19.3.jar:org/jooq/impl/IDiv.class */
public final class IDiv<T> extends AbstractTransformable<T> implements QOM.Div<T> {
    final Field<T> arg1;
    final Field<T> arg2;

    /* JADX INFO: Access modifiers changed from: package-private */
    public IDiv(Field<T> arg1, Field<T> arg2) {
    ...
    public final void accept0(Context<?> ctx) {
        ctx.visit((Field<?>) new Div($arg1(), $arg2()));
    }

    @Override // org.jooq.impl.Transformable
    public final Field<?> transform(TransformUnneededArithmeticExpressions transform) {
        return Expression.transform(this, this.arg1, ExpressionOperator.DIVIDE, this.arg2, true, transform);
    }
