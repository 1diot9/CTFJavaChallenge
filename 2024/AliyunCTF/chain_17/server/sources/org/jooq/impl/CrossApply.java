...
/* loaded from: server.jar:BOOT-INF/lib/jooq-3.19.3.jar:org/jooq/impl/CrossApply.class */
public final class CrossApply extends JoinTable<CrossApply> implements QOM.CrossApply<Record> {
    @Override // org.jooq.impl.JoinTable
    /* bridge */ /* synthetic */ CrossApply construct(Table table, Collection collection, Collection collection2, Table table2, Condition condition, Collection collection3, QOM.JoinHint joinHint) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public CrossApply(TableLike<?> lhs, TableLike<?> rhs) {
        super(lhs, rhs, JoinType.CROSS_APPLY, null);
    }

    /* JADX WARN: Can't rename method to resolve collision */
    @Override // org.jooq.impl.JoinTable
    CrossApply construct(Table<?> table1, Collection<? extends Field<?>> partitionBy1, Collection<? extends Field<?>> partitionBy2, Table<?> table2, Condition o, Collection<? extends Field<?>> u, QOM.JoinHint h) {
