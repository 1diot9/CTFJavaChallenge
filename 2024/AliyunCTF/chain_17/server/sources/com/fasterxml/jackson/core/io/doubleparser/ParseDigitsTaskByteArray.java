...
/* loaded from: server.jar:BOOT-INF/lib/jackson-core-2.15.3.jar:com/fasterxml/jackson/core/io/doubleparser/ParseDigitsTaskByteArray.class */
public class ParseDigitsTaskByteArray {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static BigInteger parseDigitsRecursive(byte[] str, int from, int to, Map<Integer, BigInteger> powersOfTen) {
        int numDigits = to - from;
        if (numDigits <= 400) {
