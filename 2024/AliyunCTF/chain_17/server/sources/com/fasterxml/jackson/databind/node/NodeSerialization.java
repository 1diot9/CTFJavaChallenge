...
/* loaded from: server.jar:BOOT-INF/lib/jackson-databind-2.15.3.jar:com/fasterxml/jackson/databind/node/NodeSerialization.class */
    ...
    private byte[] _read(ObjectInput in, int expLen) throws IOException {
        ...
        try {
            try {
                ...
                byte[] completeAndCoalesce = bb.completeAndCoalesce(outOffset);
                if (bb != null) {
                    if (0 != 0) {
                        try {
                            bb.close();
