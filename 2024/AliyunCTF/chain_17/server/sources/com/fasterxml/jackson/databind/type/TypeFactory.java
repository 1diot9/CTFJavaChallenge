...
/* loaded from: server.jar:BOOT-INF/lib/jackson-databind-2.15.3.jar:com/fasterxml/jackson/databind/type/TypeFactory.class */
public class TypeFactory implements Serializable {
    ...
    public JavaType _fromClass(ClassStack context, Class<?> rawType, TypeBindings bindings) {
        ...
        JavaType result2 = key == null ? null : this._typeCache.get(key);
        if (result2 != null) {
            return result2;
        }
        if (context == null) {
        ...
        if (key != null && !result2.hasHandlers()) {
