...
/* loaded from: server.jar:BOOT-INF/lib/jackson-databind-2.15.3.jar:com/fasterxml/jackson/databind/introspect/DefaultAccessorNamingStrategy.class */
public class DefaultAccessorNamingStrategy extends AccessorNamingStrategy {
    ...
    /* loaded from: server.jar:BOOT-INF/lib/jackson-databind-2.15.3.jar:com/fasterxml/jackson/databind/introspect/DefaultAccessorNamingStrategy$BaseNameValidator.class */
    ...
    public String findNameForIsGetter(AnnotatedMethod am, String name) {
        if (this._isGetterPrefix != null) {
            if ((this._isGettersNonBoolean || _booleanType(am.getType())) && name.startsWith(this._isGetterPrefix)) {
                if (this._stdBeanNaming) {
                    return stdManglePropertyName(name, this._isGetterPrefix.length());
                }
                return legacyManglePropertyName(name, this._isGetterPrefix.length());
            }
            return null;
        }
        return null;
    ...
    /* loaded from: server.jar:BOOT-INF/lib/jackson-databind-2.15.3.jar:com/fasterxml/jackson/databind/introspect/DefaultAccessorNamingStrategy$Provider.class */
    ...
    /* loaded from: server.jar:BOOT-INF/lib/jackson-databind-2.15.3.jar:com/fasterxml/jackson/databind/introspect/DefaultAccessorNamingStrategy$FirstCharBasedValidator.class */
    ...
    /* loaded from: server.jar:BOOT-INF/lib/jackson-databind-2.15.3.jar:com/fasterxml/jackson/databind/introspect/DefaultAccessorNamingStrategy$RecordNaming.class */
