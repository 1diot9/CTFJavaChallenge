...
/* loaded from: server.jar:BOOT-INF/lib/jackson-databind-2.15.3.jar:com/fasterxml/jackson/databind/AnnotationIntrospector.class */
public abstract class AnnotationIntrospector implements Versioned, Serializable {

    /* loaded from: server.jar:BOOT-INF/lib/jackson-databind-2.15.3.jar:com/fasterxml/jackson/databind/AnnotationIntrospector$XmlExtensions.class */
    ...
    /* loaded from: server.jar:BOOT-INF/lib/jackson-databind-2.15.3.jar:com/fasterxml/jackson/databind/AnnotationIntrospector$ReferenceProperty.class */
    public static class ReferenceProperty {
        private final Type _type;
        private final String _name;

        /* loaded from: server.jar:BOOT-INF/lib/jackson-databind-2.15.3.jar:com/fasterxml/jackson/databind/AnnotationIntrospector$ReferenceProperty$Type.class */
        public enum Type {
            MANAGED_REFERENCE,
            BACK_REFERENCE
        }
    ...
    /* JADX INFO: Access modifiers changed from: protected */
    public boolean _hasAnnotation(Annotated ann, Class<? extends Annotation> annoClass) {
        return ann.hasAnnotation(annoClass);
    }

    /* JADX INFO: Access modifiers changed from: protected */
    public boolean _hasOneOf(Annotated ann, Class<? extends Annotation>[] annoClasses) {
