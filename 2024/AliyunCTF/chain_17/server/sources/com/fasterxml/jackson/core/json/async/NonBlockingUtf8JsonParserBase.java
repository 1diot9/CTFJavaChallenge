...
/* loaded from: server.jar:BOOT-INF/lib/jackson-core-2.15.3.jar:com/fasterxml/jackson/core/json/async/NonBlockingUtf8JsonParserBase.class */
public abstract class NonBlockingUtf8JsonParserBase extends NonBlockingJsonParserBase {
    ...
    */
    ...
    private final JsonToken _startSlashComment(int fromMinorState) throws IOException {
        ...
        _reportUnexpectedChar(ch2 & 255, "was expecting either '*' or '/' for a comment");
        return null;
    }
            ...
            if (getByteFromBuffer(ptr) == 97) {
                ...
                if (getByteFromBuffer(ptr2) == 108) {
                    ...
                    if (getByteFromBuffer(ptr3) == 115) {
                        int ptr5 = ptr4 + 1;
                        if (getByteFromBuffer(ptr4) == 101 && ((ch2 = getByteFromBuffer(ptr5) & 255) < 48 || ch2 == 93 || ch2 == 125)) {
                            this._inputPtr = ptr5;
        ...
        if (ptr + 3 < this._inputEnd) {
            ...
            if (getByteFromBuffer(ptr) == 114) {
                ...
                if (getByteFromBuffer(ptr2) == 117) {
                    int ptr4 = ptr3 + 1;
                    if (getByteFromBuffer(ptr3) == 101 && ((ch2 = getByteFromBuffer(ptr4) & 255) < 48 || ch2 == 93 || ch2 == 125)) {
                        this._inputPtr = ptr4;
    ...
    protected JsonToken _startNullToken() throws IOException {
        ...
        if (ptr + 3 < this._inputEnd) {
            ...
            if (getByteFromBuffer(ptr) == 117) {
                ...
                if (getByteFromBuffer(ptr2) == 108) {
                    int ptr4 = ptr3 + 1;
                    if (getByteFromBuffer(ptr3) == 108 && ((ch2 = getByteFromBuffer(ptr4) & 255) < 48 || ch2 == 93 || ch2 == 125)) {
                        this._inputPtr = ptr4;
    ...
    protected JsonToken _startNegativeNumber() throws IOException {
        ...
        while (true) {
            if (ch3 < 48) {
                ...
                ch3 = getByteFromBuffer(this._inputPtr) & 255;
            }
        }
        this._intLength = outPtr - 1;
        this._textBuffer.setCurrentLength(outPtr);
    ...
    private final String _parseMediumName2(int ptr, int q3, int q2) throws IOException {
        ...
        int q34 = (q33 << 8) | i3;
        int ptr5 = ptr4 + 1;
        if ((getByteFromBuffer(ptr4) & 255) == 34) {
            this._inputPtr = ptr5;
    ...
    private int _decodeSplitEscaped(int value, int bytesRead) throws IOException {
        ...
        while (true) {
            ...
            if (digit < 0) {
                _reportUnexpectedChar(c2 & 255, "expected a hex-digit for character escape sequence");
            }
            value = (value << 4) | digit;
            bytesRead++;
            if (bytesRead == 4) {
                        ...
                        if (ptr >= safeEnd) {
                            ...
                            switch (codes[c]) {
                                ...
                                case 4:
                                    ...
                                    c = 56320 | (c2 & FastDoubleMath.DOUBLE_EXPONENT_BIAS);
                                    break;
                                default:
                                    if (c < 32) {
    ...
    private final boolean _decodeSplitUTF8_4(int prev, int prevCount, int next) throws IOException {
        ...
        this._textBuffer.append((char) (56320 | (c & FastDoubleMath.DOUBLE_EXPONENT_BIAS)));
        return true;
    }
