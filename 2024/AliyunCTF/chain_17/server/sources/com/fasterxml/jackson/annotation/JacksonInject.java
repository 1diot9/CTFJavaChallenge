...
/* loaded from: server.jar:BOOT-INF/lib/jackson-annotations-2.15.3.jar:com/fasterxml/jackson/annotation/JacksonInject.class */
public @interface JacksonInject {
    String value() default "";

    OptBoolean useInput() default OptBoolean.DEFAULT;

    /* loaded from: server.jar:BOOT-INF/lib/jackson-annotations-2.15.3.jar:com/fasterxml/jackson/annotation/JacksonInject$Value.class */
