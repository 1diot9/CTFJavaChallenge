...
/* loaded from: server.jar:BOOT-INF/lib/jackson-databind-2.15.3.jar:com/fasterxml/jackson/databind/EnumNamingStrategies.class */
public class EnumNamingStrategies {
    private EnumNamingStrategies() {
    }

    /* loaded from: server.jar:BOOT-INF/lib/jackson-databind-2.15.3.jar:com/fasterxml/jackson/databind/EnumNamingStrategies$CamelCaseStrategy.class */
    public static class CamelCaseStrategy implements EnumNamingStrategy {
        ...
        private static String normalizeWord(String word) {
            ...
            return new StringBuilder(length).append(charToUpperCaseIfLower(word.charAt(0))).append(toLowerCase(word.substring(1))).toString();
        }
