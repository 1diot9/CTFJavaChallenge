...
/* loaded from: server.jar:BOOT-INF/lib/jackson-core-2.15.3.jar:com/fasterxml/jackson/core/io/doubleparser/FastIntegerMath.class */
class FastIntegerMath {
    ...
    public static UInt128 fullMultiplication(long x, long y) {
        long x0 = x & UInteger.MAX_VALUE;
        long x1 = x >>> 32;
        long y0 = y & UInteger.MAX_VALUE;
        long y1 = y >>> 32;
        long p11 = x1 * y1;
        long p01 = x0 * y1;
        long p10 = x1 * y0;
        long p00 = x0 * y0;
        long middle = p10 + (p00 >>> 32) + (p01 & UInteger.MAX_VALUE);
        return new UInt128(p11 + (middle >>> 32) + (p01 >>> 32), (middle << 32) | (p00 & UInteger.MAX_VALUE));
    }
    ...
    /* loaded from: server.jar:BOOT-INF/lib/jackson-core-2.15.3.jar:com/fasterxml/jackson/core/io/doubleparser/FastIntegerMath$UInt128.class */
