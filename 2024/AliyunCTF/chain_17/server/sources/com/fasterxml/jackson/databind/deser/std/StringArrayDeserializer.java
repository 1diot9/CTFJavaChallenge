...
@JacksonStdImpl
/* loaded from: server.jar:BOOT-INF/lib/jackson-databind-2.15.3.jar:com/fasterxml/jackson/databind/deser/std/StringArrayDeserializer.class */
                ...
                if (p.hasToken(JsonToken.VALUE_STRING)) {
                    ...
                    if (textValue.isEmpty()) {
                        ...
                        if (act2 != CoercionAction.Fail) {
                            return (String[]) _deserializeFromEmptyString(p, ctxt, act2, handledType(), "empty String (\"\")");
                        }
