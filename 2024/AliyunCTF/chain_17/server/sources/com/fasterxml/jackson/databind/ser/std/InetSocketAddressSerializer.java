...
/* loaded from: server.jar:BOOT-INF/lib/jackson-databind-2.15.3.jar:com/fasterxml/jackson/databind/ser/std/InetSocketAddressSerializer.class */
        ...
        if (ix >= 0) {
            if (ix == 0) {
                if (addr instanceof Inet6Address) {
                    substring = PropertyAccessor.PROPERTY_KEY_PREFIX + str.substring(1) + "]";
                } else {
