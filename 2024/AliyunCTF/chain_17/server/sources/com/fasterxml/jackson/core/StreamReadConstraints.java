...
/* loaded from: server.jar:BOOT-INF/lib/jackson-core-2.15.3.jar:com/fasterxml/jackson/core/StreamReadConstraints.class */
public class StreamReadConstraints implements Serializable {
    ...
    /* loaded from: server.jar:BOOT-INF/lib/jackson-core-2.15.3.jar:com/fasterxml/jackson/core/StreamReadConstraints$Builder.class */
    ...
    public void validateBigIntegerScale(int scale) throws StreamConstraintsException {
        ...
        if (absScale > MAX_BIGINT_SCALE_MAGNITUDE) {
            throw new StreamConstraintsException(String.format("BigDecimal scale (%d) magnitude exceeds maximum allowed (%d)", Integer.valueOf(scale), Integer.valueOf(MAX_BIGINT_SCALE_MAGNITUDE)));
        }
    }
}
